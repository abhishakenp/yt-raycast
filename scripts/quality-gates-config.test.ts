...
describe('quality gate configuration', () => {
  it('keeps coverage reporting wired into package scripts and CI', () => {
    ...
    expect(vitestConfig).toContain('statements: 22.01')
    expect(vitestConfig).toContain('branches: 14.74')
    expect(vitestConfig).toContain('functions: 10.51')
    expect(vitestConfig).toContain('lines: 21.61')
