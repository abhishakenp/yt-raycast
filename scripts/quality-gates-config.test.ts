...
describe('quality gate configuration', () => {
  it('keeps coverage reporting wired into package scripts and CI', () => {
    ...
    expect(vitestConfig).toContain('statements: 21.48')
    expect(vitestConfig).toContain('branches: 14.29')
    expect(vitestConfig).toContain('functions: 10.17')
    expect(vitestConfig).toContain('lines: 21.56')
