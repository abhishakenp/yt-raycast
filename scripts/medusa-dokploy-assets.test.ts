...
describe('Medusa Dokploy production assets', () => {
  it('defines a shared Medusa stack reachable through Dokploy Traefik', () => {
    ...
    expect(compose).toContain(
      'STORE_CORS:-https://ship-fast.ai,https://ship-fast.devliv.io',
    )
    ...
    expect(compose).toContain(
      'AUTH_CORS:-https://ship-fast.ai,https://ship-fast.devliv.io,https://medusa.ship-fast.ai,https://medusa.devliv.io',
    )
