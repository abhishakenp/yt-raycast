...
export const changeGroups: ChangeGroup[] = [
  {
    ...
    patterns: [
      ...
      /^convex\/sessions\.ts$/,
      /^convex\/(?:authenticated_admission|billing|brandfetch|chat_refinement|cms|customLanguages|deployment|export_entitlement|gallery|generation_budget|generation_view|github|lakebed|lakebed_deploy|medusa|usage_metrics)\.test\.ts$/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /^src\/genui\/components\/(?:LanguagePicker\.behavioral\.test|LanguagePicker|ThemePicker|localization-rail\.test)\.tsx?$/,
      /^src\/hooks\//,
      /^src\/lib\/home\//,
