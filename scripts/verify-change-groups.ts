...
export const changeGroups: ChangeGroup[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /^eslint\.config\.js$/,
      /^package\.json$/,
      /^scripts\/(?:deploy-convex|export-review-groups|git-hook-quality-gate|homepage-quality-gate|quality-gates-config|test-slack-notification|verify-build-bundles|verify-change-groups|verify-convex-openui-ssr|verify-provider-gate-lib|verify-quality-exit|verify-review-readiness)(?:\.test)?\.(?:mjs|ts)$/,
