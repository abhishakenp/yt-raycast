import {
  ...
  za as te,
  zd as O,
} from './chunk-K3TR6I3V.js'
import { j as P } from './chunk-KEAOGUGQ.js'
P()
P()
function Te(f, t) {
  if (t === et)
  ...
  return (
    ...
    s.traverse(function (n) {
      ...
      ;((r.skeleton = i.skeleton.clone()),
        ...
        (r.skeleton.bones = a.map(function (o) {
          return e.get(o)
        })),
...
function It(f, t, e) {
  ...
  for (let s = 0; s < f.children.length; s++)
    It(f.children[s], t.children[s], e)
}
var Nt = class extends Tt {
  constructor(t) {
    ;(super(t),
      ...
      this.register(function (e) {
        return new Z(e, g.EXT_MESHOPT_COMPRESSION)
      }),
      this.register(function (e) {
        return new Z(e, g.KHR_MESHOPT_COMPRESSION)
      }),
      this.register(function (e) {
        return new He(e)
      }))
  ...
  load(t, e, s, n) {
    ...
    if (this.resourcePath !== '') i = this.resourcePath
      ...
      let c = D.extractUrlBase(t)
      i = D.resolveURL(c, this.path)
    } else i = D.extractUrlBase(t)
  ...
  parse(t, e, s, n) {
    ...
    if (typeof t == 'string') r = JSON.parse(t)
      ...
      if (o.decode(new Uint8Array(t, 0, 4)) === kt) {
        try {
          i[g.KHR_BINARY_GLTF] = new De(t)
        } catch (l) {
          n && n(l)
          return
        }
        r = JSON.parse(i[g.KHR_BINARY_GLTF].content)
...
var g = {
  ...
  be = class {
    ...
    _loadLight(t) {
      ...
      let r = e.json,
        ...
        c,
        u = new O(16777215)
      o.color !== void 0 && u.setRGB(o.color[0], o.color[1], o.color[2], S)
      let l = o.range !== void 0 ? o.range : 0
      switch (o.type) {
        case 'directional':
          ;((c = new wt(u)), c.target.position.set(0, 0, -1), c.add(c.target))
          break
        case 'point':
          ;((c = new bt(u)), (c.distance = l))
          break
        case 'spot':
          ;((c = new xt(u)),
            (c.distance = l),
    ...
    extendParams(t, e, s) {
      ...
      if (r) {
        if (Array.isArray(r.baseColorFactor)) {
          ...
          ;(t.color.setRGB(i[0], i[1], i[2], S), (t.opacity = i[3]))
        }
        r.baseColorTexture !== void 0 &&
          n.push(s.assignTexture(t, 'map', r.baseColorTexture, B))
      }
  ...
  we = class {
    ...
    extendMaterialParams(t, e) {
      let s = y(this.parser, t, this.name)
      return (
        s === null ||
          (s.emissiveStrength !== void 0 &&
            (e.emissiveIntensity = s.emissiveStrength)),
        Promise.resolve()
      )
    }
  },
  Ee = class {
    ...
    getMaterialType(t) {
      return y(this.parser, t, this.name) !== null ? M : null
    }
    extendMaterialParams(t, e) {
      let s = y(this.parser, t, this.name)
      ...
      if (
        ...
        s.clearcoatTexture !== void 0 &&
          n.push(
            this.parser.assignTexture(e, 'clearcoatMap', s.clearcoatTexture),
          ),
        ...
        let r = s.clearcoatNormalTexture.scale
        e.clearcoatNormalScale = new se(r, r)
      }
      return Promise.all(n)
    }
  },
  _e = class {
    ...
    extendMaterialParams(t, e) {
      ...
      return (
        s === null ||
          (e.dispersion = s.dispersion !== void 0 ? s.dispersion : 0),
        Promise.resolve()
      )
    }
  },
  ...
  Se = class {
    ...
    extendMaterialParams(t, e) {
      ...
      let n = []
      if (
        ((e.sheenColor = new O(0, 0, 0)),
        (e.sheenRoughness = 0),
        (e.sheen = 1),
        s.sheenColorFactor !== void 0)
      ) {
        let r = s.sheenColorFactor
        e.sheenColor.setRGB(r[0], r[1], r[2], S)
      }
      return (
    ...
    extendMaterialParams(t, e) {
      ...
      ;((e.thickness = s.thicknessFactor !== void 0 ? s.thicknessFactor : 0),
        s.thicknessTexture !== void 0 &&
          n.push(
            this.parser.assignTexture(e, 'thicknessMap', s.thicknessTexture),
          ),
        (e.attenuationDistance = s.attenuationDistance || 1 / 0))
      let r = s.attenuationColor || [1, 1, 1]
      return (
        (e.attenuationColor = new O().setRGB(r[0], r[1], r[2], S)),
        Promise.all(n)
      )
    }
  },
  ...
  Oe = class {
    ...
    extendMaterialParams(t, e) {
      ...
      let r = s.specularColorFactor || [1, 1, 1]
      return (
        (e.specularColor = new O().setRGB(r[0], r[1], r[2], S)),
    ...
    extendMaterialParams(t, e) {
      ...
      return (
        ...
        s.bumpTexture !== void 0 &&
          n.push(this.parser.assignTexture(e, 'bumpMap', s.bumpTexture)),
        Promise.all(n)
      )
    }
  },
    ...
    extendMaterialParams(t, e) {
      ...
      return (
        ...
        s.anisotropyTexture !== void 0 &&
          n.push(
            this.parser.assignTexture(e, 'anisotropyMap', s.anisotropyTexture),
          ),
        Promise.all(n)
      )
    }
  ...
  Pe = class {
    ...
    loadTexture(t) {
      ...
      let i = r.extensions[e],
        a = n.images[i.source],
        o = s.textureLoader
      if (a.uri) {
        let c = s.options.manager.getHandler(a.uri)
        c !== null && (o = c)
      }
  ...
  Z = class {
    constructor(t, e) {
      ;((this.name = e), (this.parser = t))
    }
    loadBufferView(t) {
      let e = this.parser.json,
        s = e.bufferViews[t]
      if (s.extensions && s.extensions[this.name]) {
        ...
        return r.then(function (a) {
          let o = n.byteOffset || 0,
            c = n.byteLength || 0,
            u = n.count,
            l = n.byteStride,
            d = new Uint8Array(a, o, c)
          return i.decodeGltfBufferAsync
            ? i
                .decodeGltfBufferAsync(u, l, d, n.mode, n.filter)
                .then(function (h) {
                  return h.buffer
                })
            : i.ready.then(function () {
                let h = new ArrayBuffer(u * l)
                return (
                  i.decodeGltfBuffer(
                    new Uint8Array(h),
                    u,
  ...
  He = class {
    ...
    createNodeMesh(t) {
      ...
      if (!s.extensions || !s.extensions[this.name] || s.mesh === void 0)
        return null
      let n = e.meshes[s.mesh]
      for (let c of n.primitives)
        if (
          c.mode !== E.TRIANGLES &&
          c.mode !== E.TRIANGLE_STRIP &&
          c.mode !== E.TRIANGLE_FAN &&
          c.mode !== void 0
        )
          return null
      let i = s.extensions[this.name].attributes,
        a = [],
        o = {}
      for (let c in i)
        a.push(
          this.parser
            .getDependency('accessor', i[c])
            .then((u) => ((o[c] = u), o[c])),
        )
      return a.length < 1
        ? null
          ...
          Promise.all(a).then((c) => {
            ...
            for (let p of l) {
              let A = new K(),
                ...
                T = new re(),
                b = new N(1, 1, 1),
                x = new ct(p.geometry, p.material, d)
              for (let R = 0; R < d; R++)
                (o.TRANSLATION && m.fromBufferAttribute(o.TRANSLATION, R),
                  o.ROTATION && T.fromBufferAttribute(o.ROTATION, R),
                  o.SCALE && b.fromBufferAttribute(o.SCALE, R),
                  x.setMatrixAt(R, A.compose(m, T, b)))
              for (let R in o)
                if (R === '_COLOR_0') {
                  let w = o[R]
                  x.instanceColor = new fe(w.array, w.itemSize, w.normalized)
                } else
                  R !== 'TRANSLATION' &&
                    R !== 'ROTATION' &&
                    R !== 'SCALE' &&
                    p.geometry.setAttribute(R, o[R])
              ;(ae.prototype.copy.call(x, p),
  ...
  kt = 'glTF',
  V = 12,
  Lt = { JSON: 1313821514, BIN: 5130562 },
  De = class {
    constructor(t) {
      ;((this.name = g.KHR_BINARY_GLTF),
        (this.content = null),
        (this.body = null))
      let e = new DataView(t, 0, V),
        s = new TextDecoder()
      if (
        ((this.header = {
      ...
      let n = this.header.length - V,
        r = new DataView(t, V),
        i = 0
      for (; i < n; ) {
        let a = r.getUint32(i, !0)
        i += 4
        let o = r.getUint32(i, !0)
        if (((i += 4), o === Lt.JSON)) {
          let c = new Uint8Array(t, V + i, a)
  ...
  Fe = class {
    ...
    decodePrimitive(t, e) {
      let s = this.json,
        ...
        c = {}
      for (let u in i) {
        let l = ze[u] || u.toLowerCase()
        a[l] = i[u]
      }
      for (let u in t.attributes) {
        let l = ze[u] || u.toLowerCase()
        if (i[u] !== void 0) {
          let d = s.accessors[t.attributes[u]],
            h = F[d.componentType]
      ...
      return e.getDependency('bufferView', r).then(function (u) {
        return new Promise(function (l, d) {
          n.decodeDracoFile(
            u,
            function (h) {
              for (let p in h.attributes) {
                let A = h.attributes[p],
                  m = o[p]
  ...
  Ke = class extends Q {
    interpolate_(t, e, s, n) {
      let r = super.interpolate_(t, e, s, n)
      return (Bt.fromArray(r).normalize().toArray(r), r)
    }
  },
  E = {
    FLOAT: 5126,
  ...
  Ot = { 9728: ee, 9729: X, 9984: Ze, 9985: Je, 9986: Qe, 9987: te },
  Ct = { 33071: qe, 33648: Ye, 10497: j },
  Ae = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
  ze = {
    POSITION: 'position',
    NORMAL: 'normal',
    TANGENT: 'tangent',
  ...
  Ht = { CUBICSPLINE: void 0, LINEAR: ne, STEP: $e },
  Re = { OPAQUE: 'OPAQUE', MASK: 'MASK', BLEND: 'BLEND' }
function Dt(f) {
  return (
    f.DefaultMaterial === void 0 &&
      (f.DefaultMaterial = new de({
        color: 16777215,
        emissive: 0,
        metalness: 1,
        roughness: 1,
...
function Ft(f, t, e) {
  ...
  for (let c = 0, u = t.length; c < u; c++) {
    let l = t[c]
    if (
      (l.POSITION !== void 0 && (s = !0),
      l.NORMAL !== void 0 && (n = !0),
      l.COLOR_0 !== void 0 && (r = !0),
      s && n && r)
    )
      break
  }
  ...
  return Promise.all([Promise.all(i), Promise.all(a), Promise.all(o)]).then(
    function (c) {
      let u = c[0],
        l = c[1],
        d = c[2]
      return (
        s && (f.morphAttributes.position = u),
        n && (f.morphAttributes.normal = l),
        r && (f.morphAttributes.color = d),
...
function Gt(f) {
  let t,
    e = f.extensions && f.extensions[g.KHR_DRACO_MESH_COMPRESSION]
  if (
    (e
      ? (t = 'draco:' + e.bufferView + ':' + e.indices + ':' + xe(e.attributes))
      : (t = f.indices + ':' + xe(f.attributes) + ':' + f.mode),
    f.targets !== void 0)
  )
...
function Kt(f) {
  return f.search(/\.jpe?g($|\?)/i) > 0 || f.search(/^data\:image\/jpeg/) === 0
    ? 'image/jpeg'
    : f.search(/\.webp($|\?)/i) > 0 || f.search(/^data\:image\/webp/) === 0
      ? 'image/webp'
      : f.search(/\.ktx2($|\?)/i) > 0 || f.search(/^data\:image\/ktx2/) === 0
        ? 'image/ktx2'
        : 'image/png'
}
var zt = new K(),
  je = class {
    constructor(t = {}, e = {}) {
      ...
      if (typeof navigator < 'u' && typeof navigator.userAgent < 'u') {
        ...
        ;((n = s && o ? parseInt(o[1], 10) : -1),
          (r = a.indexOf('Firefox') > -1),
          (i = r ? a.match(/Firefox\/([0-9]+)\./)[1] : -1))
      }
      ;(typeof createImageBitmap > 'u' || (s && n < 17) || (r && i < 98)
        ? (this.textureLoader = new At(this.options.manager))
        : (this.textureLoader = new Et(this.options.manager)),
        this.textureLoader.setCrossOrigin(this.options.crossOrigin),
        this.textureLoader.setRequestHeader(this.options.requestHeader),
        (this.fileLoader = new ge(this.options.manager)),
          ...
          .then(function (i) {
            ...
            return (
              ...
              Promise.all(
                ...
                for (let o of a.scenes) o.updateMatrixWorld()
                t(a)
              })
            )
          })
    ...
    loadBuffer(t) {
      ...
      return new Promise(function (r, i) {
        s.load(D.resolveURL(e.uri, n.path), r, void 0, function () {
          i(
            new Error(
    ...
    loadAccessor(t) {
      ...
      if (n.bufferView === void 0 && n.sparse === void 0) {
        let i = Ae[n.type],
          ...
          o = n.normalized === !0,
          c = new a(n.count * i)
        return Promise.resolve(new z(c, i, o))
      }
      let r = []
      return (
        n.bufferView !== void 0
        ...
        Promise.all(r).then(function (i) {
          ...
          if (h && h !== l) {
            let T = Math.floor(d / h),
              ...
              x = e.cache.get(b)
            ;(x ||
              ((A = new c(a, T * h, (n.count * h) / u)),
              (x = new ue(A, h / u)),
              e.cache.add(b, x)),
              (m = new le(x, o, (d % h) / u, p)))
          } else
            (a === null
              ? (A = new c(n.count * o))
              : (A = new c(a, d, n.count * o)),
              (m = new z(A, o, p)))
          if (n.sparse !== void 0) {
            let T = Ae.SCALAR,
              b = F[n.sparse.indices.componentType],
              x = n.sparse.indices.byteOffset || 0,
              R = n.sparse.values.byteOffset || 0,
              w = new b(i[1], x, n.sparse.count * T),
              L = new c(i[2], R, n.sparse.count * o)
            ;(a !== null &&
              (m = new z(m.array.slice(), m.itemSize, m.normalized)),
              (m.normalized = !1))
            for (let _ = 0, U = w.length; _ < U; _++) {
              let k = w[_]
              if (
                (m.setX(k, L[_ * o]),
                o >= 2 && m.setY(k, L[_ * o + 1]),
                o >= 3 && m.setZ(k, L[_ * o + 2]),
                o >= 4 && m.setW(k, L[_ * o + 3]),
                o >= 5)
              )
                throw new Error(
    ...
    loadTextureImage(t, e, s) {
      let n = this,
        ...
        i = r.textures[t],
        a = r.images[e],
        o = (a.uri || a.bufferView) + ':' + i.sampler
      if (this.textureCache[o]) return this.textureCache[o]
      let c = this.loadImageSource(e, s)
        .then(function (u) {
          ;((u.flipY = !1),
            (u.name = i.name || a.name || ''),
            u.name === '' &&
              typeof a.uri == 'string' &&
              a.uri.startsWith('data:image/') === !1 &&
              (u.name = a.uri))
          let d = (r.samplers || {})[i.sampler] || {}
          return (
            (u.magFilter = Ot[d.magFilter] || X),
            (u.minFilter = Ot[d.minFilter] || te),
            (u.wrapS = Ct[d.wrapS] || j),
            (u.wrapT = Ct[d.wrapT] || j),
            (u.generateMipmaps =
    ...
    loadImageSource(t, e) {
      ...
      if (i.bufferView !== void 0)
        o = s.getDependency('bufferView', i.bufferView).then(function (l) {
          c = !0
          let d = new Blob([l], { type: i.mimeType })
        ...
        .then(function (l) {
          return new Promise(function (d, h) {
            ...
            ;(e.isImageBitmapLoader === !0 &&
              ...
              e.load(D.resolveURL(l, r.path), p, void 0, h))
          })
        })
        .then(function (l) {
          return (
            ...
            I(l, i),
            (l.userData.mimeType = i.mimeType || Kt(i.uri)),
            l
          )
        })
        .catch(function (l) {
    ...
    assignTexture(t, e, s, n) {
      ...
      return this.getDependency('texture', s.index).then(function (i) {
        ...
        if (
          (s.texCoord !== void 0 &&
            s.texCoord > 0 &&
            ((i = i.clone()), (i.channel = s.texCoord)),
          r.extensions[g.KHR_TEXTURE_TRANSFORM])
        ) {
          let a =
            s.extensions !== void 0
              ...
              : void 0
          if (a) {
            let o = r.associations.get(i)
            ;((i = r.extensions[g.KHR_TEXTURE_TRANSFORM].extendTexture(i, a)),
              r.associations.set(i, o))
          }
        }
    ...
    assignFinalMaterial(t) {
      let e = t.geometry,
        s = t.material,
        n = e.attributes.tangent === void 0,
        r = e.attributes.color !== void 0,
        i = e.attributes.normal === void 0
      if (t.isPoints) {
        let a = 'PointsMaterial:' + s.uuid,
          o = this.cache.get(a)
        ;(o ||
          ((o = new ht()),
          Y.prototype.copy.call(o, s),
        ...
        let a = 'LineBasicMaterial:' + s.uuid,
          o = this.cache.get(a)
        ;(o ||
          ((o = new ut()),
          Y.prototype.copy.call(o, s),
    ...
    loadMaterial(t) {
      ...
      if (o[g.KHR_MATERIALS_UNLIT]) {
        ...
        if (
          ...
          let d = l.baseColorFactor
          ;(a.color.setRGB(d[0], d[1], d[2], S), (a.opacity = d[3]))
        }
        ;(l.baseColorTexture !== void 0 &&
          c.push(e.assignTexture(a, 'map', l.baseColorTexture, B)),
      ...
      if (
        ...
        r.emissiveFactor !== void 0 && i !== H)
      ) {
        let l = r.emissiveFactor
        a.emissive = new O().setRGB(l[0], l[1], l[2], S)
      }
      return (
        r.emissiveTexture !== void 0 &&
          i !== H &&
          c.push(e.assignTexture(a, 'emissiveMap', r.emissiveTexture, B)),
      ...
      return (
        ...
        Promise.all(a).then(function (o) {
          ...
          for (let h = 0, p = u.length; h < p; h++) {
            ...
            if (
              m.mode === E.TRIANGLES ||
              m.mode === E.TRIANGLE_STRIP ||
              m.mode === E.TRIANGLE_FAN ||
              m.mode === void 0
            )
              ((T = r.isSkinnedMesh === !0 ? new it(A, b) : new rt(A, b)),
                T.isSkinnedMesh === !0 && T.normalizeSkinWeights(),
                m.mode === E.TRIANGLE_STRIP
                  ? (T.geometry = Te(T.geometry, W))
                  : m.mode === E.TRIANGLE_FAN &&
                    (T.geometry = Te(T.geometry, G)))
            else if (m.mode === E.LINES) T = new ft(A, b)
            else if (m.mode === E.LINE_STRIP) T = new lt(A, b)
            else if (m.mode === E.LINE_LOOP) T = new dt(A, b)
            else if (m.mode === E.POINTS) T = new pt(A, b)
            else
              throw new Error(
                'THREE.GLTFLoader: Primitive mode unsupported: ' + m.mode,
              )
            ;(Object.keys(T.geometry.morphAttributes).length > 0 && Ut(T, r),
              (T.name = e.createUniqueName(r.name || 'mesh_' + t)),
              I(T, r),
              m.extensions && v(n, T, m),
              e.assignFinalMaterial(T),
              l.push(T))
          }
          for (let h = 0, p = l.length; h < p; h++)
            e.associations.set(l[h], { meshes: t, primitives: h })
          if (l.length === 1) return (r.extensions && v(n, l[0], r), l[0])
          let d = new q()
          ;(r.extensions && v(n, d, r), e.associations.set(d, { meshes: t }))
          for (let h = 0, p = l.length; h < p; h++) d.add(l[h])
          return d
        })
      )
    }
    loadCamera(t) {
      ...
      return (
        s.type === 'perspective'
          ...
          : s.type === 'orthographic' &&
            (e = new yt(-n.xmag, n.xmag, n.ymag, -n.ymag, n.znear, n.zfar)),
    ...
    loadAnimation(t) {
      ...
      for (let l = 0, d = n.channels.length; l < d; l++) {
        let h = n.channels[l],
          ...
          A = h.target,
          m = A.node,
          T = n.parameters !== void 0 ? n.parameters[p.input] : p.input,
          b = n.parameters !== void 0 ? n.parameters[p.output] : p.output
        A.node !== void 0 &&
          (i.push(this.getDependency('node', m)),
          a.push(this.getDependency('accessor', T)),
          o.push(this.getDependency('accessor', b)),
          c.push(p),
          u.push(A))
      }
      return Promise.all([
        ...
        for (let x = 0, R = d.length; x < R; x++) {
          ...
          let J = s._createAnimationTracks(w, L, _, U, k)
          if (J) for (let $ = 0; $ < J.length; $++) T.push(J[$])
        }
        let b = new gt(r, void 0, T)
        return (I(b, n), b)
      })
    }
    createNodeMesh(t) {
      ...
      return n.mesh === void 0
        ...
        : s.getDependency('mesh', n.mesh).then(function (r) {
            let i = s._getNodeRef(s.meshCache, n.mesh, r)
            return (
              n.weights !== void 0 &&
    ...
    loadNode(t) {
      ...
      let o =
        n.skin === void 0
          ...
          : s.getDependency('skin', n.skin)
      return Promise.all([r, Promise.all(i), o]).then(function (c) {
        let u = c[0],
          l = c[1],
          d = c[2]
        d !== null &&
          u.traverse(function (h) {
            h.isSkinnedMesh && h.bind(d, zt)
          })
        for (let h = 0, p = l.length; h < p; h++) u.add(l[h])
        if (u.userData.pivot !== void 0 && l.length > 0) {
          let h = u.userData.pivot,
            p = l[0]
          ;((u.pivot = new N().fromArray(h)),
            (u.position.x -= h[0]),
            (u.position.y -= h[1]),
            (u.position.z -= h[2]),
      ...
      return (
        ...
        (this.nodeCache[t] = Promise.all(a).then(function (c) {
          ...
          if (
            ...
            for (let l = 0, d = c.length; l < d; l++) u.add(c[l])
          if (
            (r.name && ((u.userData.name = r.name), (u.name = i)),
            I(u, r),
            r.extensions && v(s, u, r),
            r.matrix !== void 0)
          ) {
            let l = new K()
          ...
          if (!n.associations.has(u)) n.associations.set(u, {})
          else if (r.mesh !== void 0 && n.meshCache.refs[r.mesh] > 1) {
            let l = n.associations.get(u)
    ...
    loadScene(t) {
      ...
      return Promise.all(a).then(function (o) {
        for (let u = 0, l = o.length; u < l; u++) {
          let d = o[u]
          d.parent !== null ? r.add(St(d)) : r.add(d)
        }
        let c = (u) => {
          let l = new Map()
          for (let [d, h] of n.associations)
            (d instanceof Y || d instanceof oe) && l.set(d, h)
          return (
            u.traverse((d) => {
    ...
    _createAnimationTracks(t, e, s, n, r) {
      let i = [],
      ...
      C[r.path] === C.weights
        ? (c(t), t.isGroup && t.children.forEach(c))
        : o.push(a)
      let u
      switch (C[r.path]) {
        case C.weights:
        ...
        case C.scale:
          ...
          break
        default:
          s.itemSize === 1 ? (u = he) : (u = me)
          break
      }
      let l = n.interpolation !== void 0 ? Ht[n.interpolation] : ne,
        d = this._getArrayFromAccessor(s)
      for (let h = 0, p = o.length; h < p; h++) {
        let A = new u(o[h] + '.' + C[r.path], e.array, d, l)
        ;(n.interpolation === 'CUBICSPLINE' &&
    ...
    _getArrayFromAccessor(t) {
      let e = t.array
      if (t.normalized) {
        let s = Ve(e.constructor),
          n = new Float32Array(e.length)
        for (let r = 0, i = e.length; r < i; r++) n[r] = e[r] * s
        e = n
      }
      return e
    }
...
function Vt(f, t, e) {
  ...
  if (s.POSITION !== void 0) {
    let a = e.json.accessors[s.POSITION],
      o = a.min,
      c = a.max
    if (o !== void 0 && c !== void 0) {
      if (
        (n.set(new N(o[0], o[1], o[2]), new N(c[0], c[1], c[2])), a.normalized)
      ) {
        let u = Ve(F[a.componentType])
  ...
  if (r !== void 0) {
    ...
    for (let c = 0, u = r.length; c < u; c++) {
      ...
      if (l.POSITION !== void 0) {
        let d = e.json.accessors[l.POSITION],
          h = d.min,
          p = d.max
...
function vt(f, t, e) {
  ...
  return (
    ie.workingColorSpace !== S &&
      'COLOR_0' in s &&
      console.warn(
        `THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${ie.workingColorSpace}" not supported.`,
      ),
    I(f, t),
    Vt(f, t, e),
