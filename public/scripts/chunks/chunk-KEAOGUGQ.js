...
var n = (a, b, c) =>
  b in a
    ? f(a, b, { enumerable: !0, configurable: !0, writable: !0, value: c })
    : (a[b] = c)
var o = (a, b) => () => (a && (b = a((a = 0))), b)
var t = (a, b) => () => (b || a((b = { exports: {} }).exports, b), b.exports),
  u = (a, b) => {
...
var w = (a, b, c) => n(a, typeof b != 'symbol' ? b + '' : b, c),
  g = (a, b, c) => b.has(a) || h('Cannot ' + c)
var q = (a, b, c) => (
    g(a, b, 'read from private field'),
    c ? c.call(a) : b.get(a)
  ),
  x = (a, b, c) =>
    b.has(a)
      ...
      : b instanceof WeakSet
        ...
        : b.set(a, c),
  r = (a, b, c, d) => (
    g(a, b, 'write to private field'),
    d ? d.call(a, c) : b.set(a, c),
    c
  ),
  y = (a, b, c) => (g(a, b, 'access private method'), c)
var z = (a, b, c, d) => ({
  set _(e) {
    r(a, b, e, c)
  },
