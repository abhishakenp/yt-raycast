...
function loadDna() {
  ...
  try {
    _dnaCache = JSON.parse(readFileSync(DNA_FILE, 'utf8'))
  } catch {
    _dnaCache = {}
  }
  return _dnaCache
...
export function synthesizeDna(palette = []) {
  ...
  return {
    ...
    avoid: ['aurora-only hero', 'generic stock testimonials', 'Lorem-style copy'],
    _synthesized: true,
  }
}
...
export const COPY_EXAMPLES = {
  ...
  Cloudflare: {
    headlines: ['The connectivity cloud', 'Make employees more productive. Make applications more performant. Make networks more secure.'],
    subs: ['Cloudflare helps build a better Internet.', 'Run your apps from one of our 320+ cities in 120+ countries.'],
  ...
  Databricks: {
    headlines: ['The Data Intelligence Platform', 'Better unified analytics for your enterprise'],
    subs: ['Databricks delivers the unified, AI-ready data platform for the modern enterprise.'],
    products: ['Lakehouse', 'Unity Catalog', 'Mosaic AI', 'Delta Lake', 'Photon'],
  },
  OpenAI: {
    headlines: ['Models built for reasoning, multimodality, and tool use', 'Pioneering research on the path to AGI'],
    subs: ['Build with the most capable, secure, and easy-to-use AI models in the world.'],
    products: ['ChatGPT', 'API', 'Codex', 'Sora', 'Realtime API', 'Embeddings'],
  },
  Anthropic: {
    headlines: ['AI research and products that put safety at the frontier', 'Models built to think'],
    subs: ['Claude is a next-generation AI assistant for your tasks, no matter the scale.'],
    products: ['Claude', 'Claude Code', 'Computer Use', 'Sonnet', 'Opus', 'Haiku'],
  },
  ElevenLabs: {
    headlines: ['The most realistic AI voices', 'Voice AI for every developer'],
    subs: ['Generate human-quality voices in 32 languages, from real-time AI agents to dubbed video.'],
    products: ['Voice Library', 'Voice Cloning', 'Conversational AI', 'Dubbing', 'Sound Effects'],
  },
  Supabase: {
    headlines: ['Build in a weekend. Scale to millions.', 'The open source Firebase alternative'],
    subs: ['Postgres database, auth, storage, edge functions, realtime — every backend feature you need.'],
    products: ['Database', 'Auth', 'Storage', 'Edge Functions', 'Realtime', 'Vector'],
  },
  Cursor: {
  ...
  GitHub: {
    headlines: ['The complete developer platform to build, scale, and deliver secure software', 'Built for the modern developer'],
    subs: ['Where the world builds software, now with AI built in.'],
    products: ['Actions', 'Codespaces', 'Copilot', 'Packages', 'Issues', 'Discussions'],
  },
  Loom: {
    headlines: ['Async video for work', 'Replace meetings with messages'],
    subs: ['Loom is the easiest way to share your screen, voice, and presence with your team — at any scale.'],
  ...
  Hopper: {
    headlines: ['Save up to 40% on flights and hotels', 'Travel with confidence'],
    subs: ['Hopper predicts when prices will rise or fall so you can book at the right time.'],
  ...
  Allbirds: {
    headlines: ['Better things in a better way', 'Made with nature, designed for everyday'],
    subs: ['Comfortable shoes and apparel made with natural and recycled materials.'],
    products: ['Wool Runners', 'Tree Dashers', 'Trail Runners', 'Apparel', 'Plant Pacer'],
  },
  Glossier: {
    headlines: ['Skin first. Makeup second. Smile always.', 'A beauty brand inspired by real life'],
    subs: ['Beauty products that celebrate and enhance what makes you uniquely you.'],
    products: ['Boy Brow', 'Cloud Paint', 'Balm Dotcom', 'Futuredew', 'You'],
  },
  Lululemon: {
    headlines: ['The future of well-being is here', 'Engineered for life in motion'],
    subs: ['Technical athletic apparel for yoga, running, training, and most other sweaty pursuits.'],
  ...
  Calm: {
    headlines: ['Sleep more. Stress less. Live better.', 'The #1 app for meditation and sleep'],
    subs: ['Guided meditations, sleep stories, breathing programs, and relaxing music.'],
  ...
  MasterClass: {
    ...
    subs: ['Online classes taught by the world\'s greatest minds in their craft.'],
    products: ['Sessions', 'Articles', 'On Call', 'Annual Membership', 'Gift'],
  },
  Substack: {
    headlines: ['The home for great culture', 'Independent voices, paid directly by readers'],
    subs: ['Subscribe to writers, podcasters, and video creators who deserve your time.'],
    products: ['Notes', 'Chat', 'Podcasts', 'Video', 'Recommendations'],
  },
  NYT: {
    headlines: ['All the news that\'s fit to print', 'The truth requires our attention'],
