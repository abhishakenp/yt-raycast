...
const THEME_DESCRIPTIONS: Record<string, string> = {
  'modern-minimal':
    'Clean white, blue accent, neutral grays — versatile SaaS/startup default.',
  'violet-bloom':
    'Soft white with a vivid purple primary, rounded and friendly — modern product/app.',
  't3-chat':
    'Warm pink-magenta on cream — playful, chatty, consumer/creator brands.',
  twitter:
    'Crisp white with sky-blue primary — social, news, communication products.',
  'mocha-mousse':
    'Earthy taupe and warm browns — cozy, organic, artisan/coffee/wellness.',
  bubblegum:
    'Bright pink + cyan candy palette, shadows pop — fun, youthful, playful brands.',
  'amethyst-haze':
    'Muted lavender and dusty rose — calm, elegant, refined feminine feel.',
  notebook:
    'Hand-drawn paper look, sketchy grays, handwriting font — quirky, personal, indie.',
  'doom-64':
    'Gritty industrial grays with blood-red — bold gaming, retro tech, edgy.',
  catppuccin:
    'Soft pastel lavender on muted base — gentle, developer-loved, cozy modern.',
  graphite:
    'Monochrome grays, understated — neutral, professional, content-forward.',
  perpetuity:
    'Teal monospace, terminal vibe — technical, cyber, data/infra products.',
  'kodama-grove':
    'Sage green on warm parchment, serif — natural, botanical, calm earthy.',
  'cosmic-night':
    'Indigo/violet on near-white, starry — futuristic, premium, space/AI.',
  tangerine:
    'Warm orange primary on cool gray-blue — energetic, optimistic, productivity.',
  'quantum-rose':
    'Hot magenta-pink, glossy — bold beauty, fashion, vibrant consumer.',
  nature:
    'Forest green on warm cream — organic, eco, outdoors, sustainability.',
  'bold-tech':
    'Electric violet on white, confident — modern tech, SaaS, developer tools.',
  'elegant-luxury':
    'Deep maroon + gold on ivory, serif — premium, fashion, fine dining, luxury.',
  'amber-minimal':
    'Clean white with amber-gold accent — warm minimal, finance, professional.',
  supabase:
    'Near-white with signature green — developer platform, infra, clean tech.',
  'neo-brutalism':
    'Stark black borders, primary red/yellow/blue, hard shadows — loud, bold, editorial.',
  'solar-dusk':
    'Sandy warm neutrals with burnt orange — desert, rustic, warm craft brands.',
  claymorphism:
    'Soft clay neutrals, big rounded radius, indigo — friendly, tactile, soft modern.',
  cyberpunk:
    'Neon magenta + cyan on dark — futuristic, gaming, nightlife, edgy tech.',
  'pastel-dreams':
  ...
  'retro-arcade':
    'Solarized teal/magenta retro — playful nostalgic, games, creative.',
  'midnight-bloom':
    'Royal purple on light, floral — elegant evening, events, boutique.',
  candyland: 'Pink + sky-blue + yellow candy — joyful, kids, sweets, party.',
  'northern-lights':
    'Emerald + blue aurora tones — fresh, vibrant, nature-tech.',
  'vintage-paper':
    'Aged parchment, sepia browns, serif — heritage, editorial, classic, books.',
  'sunset-horizon':
    'Coral-to-peach warm gradient tones — warm lifestyle, travel, hospitality.',
  'starry-night':
    'Deep blue + gold, painterly serif — artistic, museum, premium evening.',
  claude:
    'Warm off-white with terracotta — humane, editorial, calm premium product.',
  vercel:
    'Pure black & white, Geist, ultra-minimal — sharp, modern, developer/agency.',
  darkmatter:
    'Charcoal with warm orange + teal, mono font — sleek dev/infra, dark-leaning.',
  mono: 'All-monospace grayscale, zero radius — brutalist-minimal, technical, editorial.',
  'soft-pop':
    'Bright indigo/teal/amber on off-white, bold borders — energetic, modern, fun startup.',
  'sage-garden':
    'Muted sage green, refined serif, airy — calm, sophisticated, wellness, organic luxury.',
}
...
export function pickRandomTheme(rng: () => number): string {
  const i = Math.min(
    ...
    Math.floor(rng() * THEME_NAMES.length),
  )
...
// font-* values and inject one Google Fonts <link> into the target document head.
