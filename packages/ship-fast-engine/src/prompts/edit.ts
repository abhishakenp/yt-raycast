export function editPrompt(
  prompt: string,
  task: { filename: string; title?: string; description?: string },
  html: string,
  homepageRef: string,
  ...
  return {
    system:
      ...
      `- The Lucide icon system: use <i data-lucide="icon-name"></i> placeholders only, never class="lucide-name". For brand socials prefer x, instagram, and whatsapp\n` +
