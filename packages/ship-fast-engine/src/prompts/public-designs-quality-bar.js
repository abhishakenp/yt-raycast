...
1) Use Tailwind utility classes only. Do NOT load \`https://cdn.tailwindcss.com\` or any external CSS framework script; Ship Fast injects the compiled Tailwind runtime CSS and theme variables around your output.
