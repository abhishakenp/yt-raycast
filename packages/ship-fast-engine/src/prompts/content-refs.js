...
export function loadContentPlanRef(name) {
  if (!name) return null
...
export function stashContentPlanRefName(workspace, name) {
  if (!workspace || !name) return
  writeFile(workspace, WORKSPACE_FILE, name)
}

export function readContentPlanRefFromWorkspace(workspace) {
...
export function contentPlanPromptAppendix(contentPlanRef) {
...
function fencedRefAppendix(label, loaded) {
