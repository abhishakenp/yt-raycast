...
function renderReactPage(page: any, componentName: string): string {
...
function renderReactApp(siteSpec: any): string {
...
function renderReactSectionRenderer(siteSpec: any): string {
...
export function renderReactProject(siteSpec: any, session?: any) {
  const useSwiper = shouldUseSwiper(siteSpec)
  const homePage =
    (siteSpec.pages || []).find((page: any) => page.route === '/') ||
    siteSpec.pages?.[0]
