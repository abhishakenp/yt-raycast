...
export const OPENROUTER_HOST =
  process.env.OPENROUTER_HOST ?? 'https://openrouter.ai/api'
...
export const GROQ_AUX_MODEL =
  (process.env.GROQ_AUX_MODEL ?? '').trim() || 'llama-3.3-70b-versatile'
export const HOMEPAGE_MODEL =
  (process.env.HOMEPAGE_MODEL ?? '').trim() || GROQ_MODEL
...
export const SITE_SPEC_MODEL =
  (process.env.SITE_SPEC_MODEL ?? '').trim() || HOMEPAGE_MODEL
export const SITE_SPEC_ENRICH_MODEL = (
  process.env.SITE_SPEC_ENRICH_MODEL ?? ''
).trim()
export const SHIP_FAST_SITE_SPEC_ENRICH =
  process.env.SHIP_FAST_SITE_SPEC_ENRICH === '1'
...
export const LLM_CONFIG = {
  ...
  homepage: {
    ...
    maxTokens: Math.min(
      ...
      Math.max(
        8000,
        parseInt(process.env.SHIPFAST_HOMEPAGE_MAX_TOKENS || '10000', 10) ||
          10000,
      ),
    ),
  },
...
export const ECOMMERCE_ENVATO_TEMPLATES_URL =
  'https://elements.envato.com/web-templates/ecommerce'

export const ECOMMERCE_AWWWARDS_GALLERY_URL =
  'https://www.awwwards.com/websites/e-commerce/'

export const ECOMMERCE_DRIBBBLE_TAG_URL =
  'https://dribbble.com/tags/ecommerce-website'
...
export const getEcommerceGenerationGuidelines = ({
...
export const buildEcommerceSiteTypeInstructions = (
  hasUserDesignReferences = false,
) =>
