...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from '#/components/ui/8bit/accordion.tsx'
...
const defaultItems: Checkpoint[] = [
  ...
  },
  {
    ...
    answer:
      'Yes. 8bitcn wraps shadcn components. Your existing setup stays intact. Just add the retro layer on top.',
    status: 'current',
  },
  {
    question: 'Is it production ready?',
    answer:
      'Every component is accessible, responsive, and tested. The pixel borders are decorative — the engineering is serious.',
    status: 'current',
  },
  {
    question: 'What about templates?',
    answer:
      'Full landing page templates are on the roadmap. For now, combine blocks to build pages in minutes.',
    status: 'locked',
  },
  {
    question: 'When is the icon pack coming?',
    answer:
      'The native 8-bit pixel icon library is planned. Follow the roadmap for updates.',
    status: 'locked',
  },
]
