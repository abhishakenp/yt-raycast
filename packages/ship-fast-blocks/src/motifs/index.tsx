...
function TestimonialRowInner(props: Record<string, unknown>) {
 ...
 {
 quote:"The adaptive reuse of our warehouse exceeded every expectation. They preserved the building's soul while making it perfectly functional for modern living.",
...
function NumberedListInner(props: Record<string, unknown>) {
 ...
 description:"We begin with deep listening — understanding your needs, the site's constraints, and the broader context. This phase includes analysis, programming, and establishing project goals.",
 },
 {
...
function ArticlePreviewInner(props: Record<string, unknown>) {
 ...
 excerpt:"Why token-driven design systems are replacing hardcoded palettes, and what it means for your team's velocity and consistency.",
 imageAlt:
