  ...
  return (
    <div className={cn('relative', className)}>
      <div
        aria-hidden="true"
        className={cn(
          'absolute -inset-4 rounded-3xl bg-gradient-to-r from-primary/20 to-accent/20 blur-2xl',
          glowClassName,
        )}
      />
      <ImageBlock
...
export function OffsetImageTiles({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div className="absolute -bottom-8 -right-8 hidden h-40 w-32 overflow-hidden border-4 border-background shadow-xl sm:block">
        <ImageBlock
    ...
    >
      {cells.map((unit) => (
        <div key={unit.label} className="flex flex-col items-center">
          <div className="flex size-16 items-center justify-center border border-border bg-card shadow-sm sm:size-20">
