...
export function chromeBorderClass(chrome: ChromeVariant): string {
  switch (chrome) {
    case 'hairline':
      return 'd-border-lock rounded-none border-0 border-b border-r border-border bg-transparent transition-colors duration-150 hover:border-foreground/30 hover:bg-muted/30'
    case 'brutalist':
      return 'd-border-lock d-shadow-lock d-radius-lock rounded-none border-2 border-foreground bg-background shadow-[8px_8px_0_0] shadow-foreground transition-all duration-150 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[12px_12px_0_0] hover:shadow-foreground'
    case 'terminal':
      return 'd-border-lock rounded-none border-0 border-b border-r border-border bg-transparent'
    case 'editorial':
      return 'd-border-lock rounded-none border border-border bg-card'
    default:
      return ''
  }
}
