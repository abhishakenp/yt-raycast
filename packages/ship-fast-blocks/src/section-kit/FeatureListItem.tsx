...
const FeatureListItem = React.forwardRef<
 ...
 data-d-role="list"className={cn('flex items-start gap-4', className)}
 {...props}
 />
 )
})
...
const FeatureListItemIcon = React.forwardRef<
 ...
 VariantProps<typeof featureListItemIconVariants> & { asChild?: boolean }>(({ className, shape, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 ref={ref}
 data-slot="feature-list-item-icon"
 data-d-role="list"className={cn(featureListItemIconVariants({ shape }), className)}
 {...props}
 />
 )
})
...
const FeatureListItemTitle = React.forwardRef<
 HTMLHeadingElement,
 React.ComponentProps<'h4'> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'h4'
 return (
 <Comp
 ref={ref}
 data-slot="feature-list-item-title"
 data-d-role="list"className={cn('font-medium text-foreground', className)}
 {...props}
 />
 )
})
...
const FeatureListItemDescription = React.forwardRef<
 ...
 data-d-role="list"className={cn('text-sm text-muted-foreground', className)}
 {...props}
 />
 )
})
