...
const ShopGridVariants = cva('grid', {
 variants: {
 cols: {
...
const ShopGrid = React.forwardRef<
 ...
 VariantProps<typeof ShopGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="shop-grid"
 data-d-role="grid"className={cn(ShopGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
...
export { ShopGrid, ShopCard, ShopGridVariants }
