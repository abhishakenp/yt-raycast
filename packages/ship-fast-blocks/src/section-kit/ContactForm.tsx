...
const contactFormVariants = cva('', {
  variants: {
    variant: {
      default: '',
      card: 'rounded-2xl bg-card p-8 shadow-xl lg:p-12',
      'card-dark': 'rounded-xl bg-card p-8 shadow-xl lg:p-12 text-foreground',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const ContactForm = React.forwardRef<
  ...
  React.ComponentProps<'form'> &
    VariantProps<typeof contactFormVariants> & { asChild?: boolean }
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'w-full rounded-lg border border-input bg-background px-4 py-3 text-foreground placeholder-muted-foreground transition-all focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring',
        className,
      )}
      ref={ref}
      {...props}
...
const ContactFormSelect = React.forwardRef<
  HTMLSelectElement,
  React.ComponentProps<'select'> & { asChild?: boolean }
>(({ className, asChild = false, children, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'w-full appearance-none rounded-lg border border-input bg-background px-4 py-3 text-foreground transition-all focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring',
        className,
      )}
      ref={ref}
      {...props}
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'w-full resize-none rounded-lg border border-input bg-background px-4 py-3 text-foreground placeholder-muted-foreground transition-all focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring',
        className,
      )}
      ref={ref}
      {...props}
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'w-full rounded-lg bg-primary py-3.5 font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:pointer-events-none disabled:opacity-70',
        className,
      )}
      ref={ref}
      {...props}
