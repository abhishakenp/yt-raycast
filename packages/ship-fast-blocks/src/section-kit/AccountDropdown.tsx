...
const AccountDropdownTrigger = React.forwardRef<
 HTMLButtonElement,
 React.ComponentProps<'button'> & { asChild?: boolean }>(({ className, asChild = false, children, ...props }, ref) => {
...
const AccountDropdownContent = React.forwardRef<
 ...
 React.ComponentProps<typeof DropdownMenuContent>>(({ className, align = 'end', ...props }, ref) => {
 ...
 data-d-role="container"align={align}
 className={cn('w-56 rounded-none border-border ', className)}
 {...props}
 />
 )
})
...
const AccountDropdownLabel = React.forwardRef<
 ...
 React.ComponentProps<typeof DropdownMenuLabel>>(({ className, children, ...props }, ref) => {
...
const AccountDropdownSeparator = React.forwardRef<
 ...
 React.ComponentProps<typeof DropdownMenuSeparator>>(({ className, ...props }, ref) => (
 <DropdownMenuSeparator
 ref={ref}
 data-slot="account-dropdown-separator"
 data-d-role="divider"className={className}
 {...props}
 />
))
...
const AccountDropdownItem = React.forwardRef<
 ...
 React.ComponentProps<typeof DropdownMenuItem>>(({ className, ...props }, ref) => (
 <DropdownMenuItem
 ref={ref}
 data-slot="account-dropdown-item"
 data-d-role="card"className={cn('rounded-none active:translate-y-px', className)}
 {...props}
 />
))
