...
const SignInButton = React.forwardRef<
 ...
 data-d-role="btn"className={cn(signInButtonVariants({ variant }), className)}
 {...props}>
 <Button
 type="button"
 ...
 ref={ref}
 data-slot="sign-in-button"
 data-d-role="btn"className={cn('relative', signInButtonVariants({ variant }), className)}
 {...props}>
 <button
 type="button"
 ...
 <div
 role="menu"
 className="absolute right-0 z-50 mt-2 w-56 overflow-hidden border border-border bg-background p-1">
