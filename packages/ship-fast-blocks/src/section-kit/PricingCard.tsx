...
const PricingCard = React.forwardRef<
 ...
 VariantProps<typeof pricingCardVariants> & { asChild?: boolean }>(({ className, variant, highlight, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'article'
 return (
 <Comp
 data-slot="pricing-card"
 data-d-role="card"className={cn(pricingCardVariants({ variant, highlight }), className)}
 ref={ref}
 {...props}
 />
 )
...
const PricingCardPrice = React.forwardRef<
 ...
 data-d-role="card"className={cn('mt-4 flex items-baseline gap-1', className)}
 ref={ref}
 {...props}
 />
 )
...
const PricingCardFeatures = React.forwardRef<
 ...
 data-d-role="card"className={cn('mt-7 flex flex-col gap-3', className)}
 ref={ref}
 {...props}
 />
 )
...
const PricingCardCheckIcon = React.forwardRef<
 SVGSVGElement,
 React.ComponentProps<'svg'>>(({ className, ...props }, ref) => (
 <svg
...
const PricingCardCta = React.forwardRef<
 ...
 data-d-role="btn"className={cn('mt-8', className)}
 ref={ref}
 {...props}
 />
 )
