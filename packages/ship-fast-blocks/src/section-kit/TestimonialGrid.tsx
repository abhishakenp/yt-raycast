...
const TestimonialGrid = React.forwardRef<
 ...
 data-d-role="grid"className={cn('flex flex-col gap-10', className)}
 {...props}>
 {heading ? (
 <SectionHeading
 eyebrow={eyebrow}
...
const TestimonialCard = React.forwardRef<
 ...
 'flex flex-col gap-4 border border-border bg-card p-6 transition-[border-color] duration-150 hover:border-foreground/25',
 className,
 )}
 {...props}
 />
...
const TestimonialQuote = React.forwardRef<
 HTMLQuoteElement,
 React.ComponentProps<'blockquote'> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
...
const TestimonialAuthor = React.forwardRef<
 HTMLElement,
 React.ComponentProps<'figcaption'> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
...
const TestimonialName = React.forwardRef<
 ...
 data-d-role="heading"className={cn('text-sm font-semibold text-foreground', className)}
 {...props}
 />
 )
})
...
const TestimonialMeta = React.forwardRef<
 ...
 data-d-role="body"className={cn('text-xs text-muted-foreground', className)}
 {...props}
 />
 )
})
