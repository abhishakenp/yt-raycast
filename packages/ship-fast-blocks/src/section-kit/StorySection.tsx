...
const StorySection = React.forwardRef<
 ...
 VariantProps<typeof storySectionVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'section'
 return (
 <Comp
 data-slot="story-section"
 data-d-role="section"className={cn(storySectionVariants({ variant }), className)}
 ref={ref}
 {...props}
 />
 )
...
const StoryContent = React.forwardRef<
 ...
 data-d-role="container"className={cn('space-y-6', className)}
 ref={ref}
 {...props}
 />
 )
...
const StoryFooter = React.forwardRef<
 ...
 data-d-role="footer"className={cn('flex items-center gap-6 pt-4', className)}
 ref={ref}
 {...props}
 />
 )
...
const StoryImageTile = React.forwardRef<
 HTMLDivElement,
 React.ComponentProps<'div'> & { offset?: boolean; asChild?: boolean }>(({ className, offset = false, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
