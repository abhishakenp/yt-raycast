...
const PersonCard = React.forwardRef<HTMLElement, PersonCardProps>(
 ...
 data-d-role="card"className={cn(personCardVariants({ variant }), className)}
 {...props}
 />
 )
 },
...
const PersonCardAvatar = React.forwardRef<
 HTMLDivElement,
 React.HTMLAttributes<HTMLDivElement> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 ref={ref}
 data-slot="person-card-avatar"
 data-d-role="card"className={cn('aspect-square w-full overflow-hidden', className)}
 {...props}
 />
 )
})
...
const PersonCardContent = React.forwardRef<
 ...
 data-d-role="card"className={cn('p-5', className)}
 {...props}
 />
 )
})
...
const PersonCardName = React.forwardRef<
 HTMLHeadingElement,
 React.HTMLAttributes<HTMLHeadingElement> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
...
const PersonCardRole = React.forwardRef<
 ...
 React.HTMLAttributes<HTMLParagraphElement> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
