...
const HeroSection = React.forwardRef<
 ...
 VariantProps<typeof heroSectionVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'section'
 return (
 <Comp
 ref={ref}
 data-slot="hero-section"
 data-d-role="section"className={cn(heroSectionVariants({ variant }), className)}
 {...props}
 />
 )
})
...
const HeroContent = React.forwardRef<
 ...
 data-d-role="container"className={cn('relative z-10', className)}
 {...props}
 />
 )
})
...
const HeroBadge = React.forwardRef<
 ...
 VariantProps<typeof heroBadgeVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'span'
 return (
 <Comp
 ref={ref}
 data-slot="hero-badge"
 data-d-role="badge"className={cn(heroBadgeVariants({ variant }), className)}
 {...props}
 />
 )
})
...
const HeroHeading = React.forwardRef<
 ...
 VariantProps<typeof heroHeadingVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'h1'
 return (
 <Comp
 ref={ref}
 data-slot="hero-heading"
 data-d-role="display"className={cn(heroHeadingVariants({ variant }), className)}
 {...props}
 />
 )
})
...
const HeroHighlight = React.forwardRef<
 HTMLSpanElement,
 React.ComponentProps<'span'> &
 VariantProps<typeof heroHighlightVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'span'
 return (
 <Comp
 ref={ref}
 data-slot="hero-highlight"
 data-d-role="highlight"className={cn(heroHighlightVariants({ variant }), className)}
 {...props}
 />
 )
})
...
const HeroSubheading = React.forwardRef<
 ...
 VariantProps<typeof heroSubheadingVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'p'
 return (
 <Comp
 ref={ref}
 data-slot="hero-subheading"
 data-d-role="heading"className={cn(heroSubheadingVariants({ variant }), className)}
 {...props}
 />
 )
})
...
const HeroCta = React.forwardRef<
 ...
 VariantProps<typeof heroCtaVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'a'
 return (
 <Comp
 ref={ref as never}
 data-slot="hero-cta"
 data-d-role="btn" data-d-role="btn"
...
const HeroActions = React.forwardRef<
 ...
 ref={ref}
 data-slot="hero-ctas"
 data-d-role="btn"className={cn('mt-8 flex flex-wrap gap-3.5', className)}
 {...props}
 />
 )
})
...
const HeroMediaPanel = React.forwardRef<
 HTMLDivElement,
 HeroImageProps & { asChild?: boolean }>(({ className, alt, w = 1200, h = 1200, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 ref={ref}
 data-slot="hero-image"
 data-d-role="image" data-d-role="container"
...
const HeroSocialProof = React.forwardRef<
 HTMLUListElement,
 React.ComponentProps<'ul'> & { asChild?: boolean }>(({ className, asChild = false, ...props }, ref) => {
...
const HeroSocialProofItem = React.forwardRef<
 ...
 data-d-role="card"className={cn('flex items-center gap-2', className)}
 {...props}
 />
 )
})
...
const HeroStatValue = React.forwardRef<
 ...
 data-d-role="stat-value"className={cn('text-3xl font-bold text-foreground', className)}
 {...props}
 />
 )
})
...
const HeroCodeWindowBody = React.forwardRef<
 ...
 data-d-role="body"className={cn('space-y-2 p-5 font-mono text-sm', className)}
 {...props}
 />
 )
})
...
const HeroInfoStripItem = React.forwardRef<
 ...
 data-d-role="card"className={cn('flex items-center gap-x-4', className)}
 {...props}
 />
 )
})
...
const HeroStatBadge = React.forwardRef<
 ...
 data-d-role="stat-value"className={cn(
 ' border bg-card p-4 text-card-foreground ',
 className,
 )}
 {...props}
 />
...
const HeroStatBadgeIcon = React.forwardRef<
 ...
 data-d-role="stat-value"className={cn(
 'grid size-10 shrink-0 place-items-center bg-muted text-foreground',
 className,
 )}
 {...props}
 />
...
const HeroStatBadgeContent = React.forwardRef<
 ...
 data-d-role="stat-value"className={cn('min-w-0', className)}
 {...props}
 />
 )
})
...
const HeroStatBadgeTitle = React.forwardRef<
 ...
 data-d-role="stat-value"className={cn('text-sm font-medium text-card-foreground', className)}
 {...props}
 />
 )
})
...
const HeroStatBadgeSubtitle = React.forwardRef<
 ...
 data-d-role="stat-value"className={cn('text-xs text-muted-foreground', className)}
 {...props}
 />
 )
})
