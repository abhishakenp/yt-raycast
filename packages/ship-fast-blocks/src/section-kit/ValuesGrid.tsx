...
const ValuesGridVariants = cva('grid', {
 variants: {
 cols: {
...
const ValuesGrid = React.forwardRef<
 ...
 VariantProps<typeof ValuesGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="values-grid"
 data-d-role="grid"className={cn(ValuesGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
...
export { ValuesGrid, ValuesCard, ValuesGridVariants }
