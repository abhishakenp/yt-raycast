...
const WhyChooseUsGridVariants = cva('grid', {
 variants: {
 cols: {
...
const WhyChooseUsGrid = React.forwardRef<
 ...
 VariantProps<typeof WhyChooseUsGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="why-choose-us-grid"
 data-d-role="grid"className={cn(WhyChooseUsGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
...
const WhyChooseUsCard = React.forwardRef<
 ...
 return (
 <Comp
 data-slot="why-choose-us-grid-item"
...
export { WhyChooseUsGrid, WhyChooseUsCard, WhyChooseUsGridVariants }
