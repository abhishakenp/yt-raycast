...
const SplitStory = React.forwardRef<
 ...
 VariantProps<typeof storySplitVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
...
const SplitStoryMedia = React.forwardRef<
 ...
 data-d-role="image"className={cn('grid grid-cols-2 gap-4', className)}
 ref={ref}
 {...props}
 />
 )
