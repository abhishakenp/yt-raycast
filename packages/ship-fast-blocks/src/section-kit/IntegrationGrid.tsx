...
const IntegrationGrid = React.forwardRef<
 ...
 VariantProps<typeof IntegrationGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="integration-grid"
 data-d-role="grid"className={cn(IntegrationGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
