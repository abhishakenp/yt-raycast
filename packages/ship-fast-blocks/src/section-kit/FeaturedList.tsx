...
const FeaturedList = React.forwardRef<
 ...
 VariantProps<typeof FeaturedListVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="featured-list"
 data-d-role="list"className={cn(FeaturedListVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
