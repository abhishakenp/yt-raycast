...
const PracticeAreaGrid = React.forwardRef<
 ...
 VariantProps<typeof PracticeAreaGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="practice-area-grid"
 data-d-role="grid"className={cn(PracticeAreaGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
