...
function applyRuntimeLogo(root: ParentNode, logo: BrandLogoSelection | null) {
 ...
 slot.className = cn(
 'inline-grid shrink-0 place-items-center overflow-hidden bg-transparent',
...
const Logo = React.forwardRef<
 ...
 ref={ref}
 data-slot="logo"
 data-d-role="image"className={cn('inline-flex items-center gap-2', className)}
 {...props}>
 {children ?? (
 <>
 <LogoImage />
...
const LogoImage = React.forwardRef<
 ...
 data-d-role="image"aria-hidden="true"
 className={cn(
 'inline-grid size-8 shrink-0 place-items-center overflow-hidden bg-transparent',
 className,
 )}
...
const LogoLabel = React.forwardRef<
 ...
 data-d-role="image"// Wordmarks must never wrap letter-by-letter when a narrow width class
