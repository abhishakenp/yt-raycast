...
const TemplateGrid = React.forwardRef<
 ...
 VariantProps<typeof TemplateGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="template-grid"
 data-d-role="grid"className={cn(TemplateGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
