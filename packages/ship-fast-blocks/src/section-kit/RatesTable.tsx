...
const RatesTable = React.forwardRef<
 ...
 VariantProps<typeof RatesTableVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
...
const RateCard = React.forwardRef<
 ...
 <Comp
 data-slot="rate-card"
 data-d-role="card"className={cn('flex flex-col gap-1 p-4', className)}
 ref={ref}
 {...props}
 />
 )
