...
const ProcessTimeline = React.forwardRef<
 ...
 VariantProps<typeof processTimelineVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
...
const ProcessBadge = React.forwardRef<
 ...
 <Comp
 data-slot="process-badge"
 data-d-role="badge"className={cn(processBadgeVariants({ variant }), className)}
 ref={ref}
 {...props}>
 {num}
 </Comp>
