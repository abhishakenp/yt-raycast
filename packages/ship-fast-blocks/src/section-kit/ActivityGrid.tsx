...
const ActivityGrid = React.forwardRef<
 ...
 VariantProps<typeof activityGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="activity-grid"
 data-d-role="grid"className={cn(activityGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
...
const ActivityTile = React.forwardRef<
 ...
 'group flex flex-col border border-border bg-muted/40 p-6 transition-all duration-300 hover:bg-card hover:',
 className,
 )}
 ref={ref}
 {...props}
...
const ActivityTileMedia = React.forwardRef<
 ...
 data-d-role="card"className={cn(
 'relative mb-6 aspect-[4/3] overflow-hidden ',
 className,
 )}
 ref={ref}
 {...props}
...
const ActivityTileTitle = React.forwardRef<
 ...
 data-d-role="card"className={cn('mb-2 text-xl font-bold text-foreground', className)}
 ref={ref}
 {...props}
 />
 )
...
const ActivityTileDescription = React.forwardRef<
 ...
 data-d-role="card"className={cn('mb-4 text-muted-foreground', className)}
 ref={ref}
 {...props}
 />
 )
