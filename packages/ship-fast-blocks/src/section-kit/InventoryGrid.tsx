...
const InventoryGridVariants = cva('grid', {
 variants: {
 cols: {
...
const InventoryGrid = React.forwardRef<
 ...
 VariantProps<typeof InventoryGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="inventory-grid"
 data-d-role="grid"className={cn(InventoryGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
...
export { InventoryGrid, InventoryCard, InventoryGridVariants }
