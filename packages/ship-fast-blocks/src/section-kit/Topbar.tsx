...
const TopbarSection = React.forwardRef<
 ...
 data-d-role="section"className={cn('flex items-center gap-2 sm:gap-4', className)}
 {...props}
 />
 )
})
...
const TopbarDivider = React.forwardRef<
 ...
 data-d-role="divider"className={cn('hidden h-6 w-px bg-border sm:block', className)}
 {...props}
 />
 )
})
...
const TopbarIconButton = React.forwardRef<
 ...
 'relative p-2 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground',
 className,
 )}
 {...props}
 />
