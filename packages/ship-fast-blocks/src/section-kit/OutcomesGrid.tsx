...
const OutcomesGrid = React.forwardRef<
 ...
 VariantProps<typeof OutcomesGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="outcomes-grid"
 data-d-role="grid"className={cn(OutcomesGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
