...
const StatGrid = React.forwardRef<
 ...
 VariantProps<typeof statGridVariants> & { asChild?: boolean }>(({ className, columns, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 ref={ref}
 data-slot="stat-grid"
 data-d-role="grid"className={cn(statGridVariants({ columns }), className)}
 {...props}
 />
 )
})
...
const StatItem = React.forwardRef<
 HTMLDivElement,
 React.ComponentProps<'div'> &
 VariantProps<typeof statItemVariants> & { asChild?: boolean }>(({ className, align, accentBorder, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 ref={ref}
 data-slot="stat-item"
 data-d-role="card"className={cn(statItemVariants({ align, accentBorder }), className)}
 {...props}
 />
 )
})
...
const StatLabel = React.forwardRef<
 HTMLSpanElement,
 React.ComponentProps<'span'> &
 VariantProps<typeof statLabelVariants> & { asChild?: boolean }>(({ className, color, uppercase, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'span'
 return (
 <Comp
 ref={ref}
 data-slot="stat-label"
 data-d-role="eyebrow"className={cn(statLabelVariants({ color, uppercase }), className)}
 {...props}
 />
 )
})
...
const StatDelta = React.forwardRef<
 HTMLSpanElement,
 React.ComponentProps<'span'> &
 VariantProps<typeof statDeltaVariants> & { asChild?: boolean }>(({ className, trend, bare, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'span'
 return (
 <Comp
 ref={ref}
 data-slot="stat-delta"
 data-d-role="eyebrow"className={cn(statDeltaVariants({ trend, bare }), className)}
 {...props}
 />
 )
})
...
const statCardVariants = cva(' p-6', {
 variants: {
 variant: {
 plain: '',
...
const StatCard = React.forwardRef<
 HTMLDivElement,
 React.ComponentProps<'div'> &
 VariantProps<typeof statCardVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 ref={ref}
 data-slot="stat-card"
 data-d-role="card"className={cn(statCardVariants({ variant }), className)}
 {...props}
 />
 )
})
...
const StatCardHeader = React.forwardRef<
 ...
 data-d-role="card"className={cn('flex items-start justify-between', className)}
 {...props}
 />
 )
})
...
const StatCaption = React.forwardRef<
 ...
 data-d-role="eyebrow"className={cn('mt-4 text-xs text-muted-foreground', className)}
 {...props}
 />
 )
})
