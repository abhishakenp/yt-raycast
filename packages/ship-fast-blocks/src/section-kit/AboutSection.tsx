...
const AboutSection = React.forwardRef<
 ...
 VariantProps<typeof aboutSectionVariants> & { asChild?: boolean }>(({ className, variant, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'section'
 return (
 <Comp
 data-slot="about-section"
 data-d-role="section"className={cn(aboutSectionVariants({ variant }), className)}
 ref={ref}
 {...props}
 />
 )
