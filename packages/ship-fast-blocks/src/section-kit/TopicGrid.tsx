...
const TopicGrid = React.forwardRef<
 ...
 VariantProps<typeof TopicGridVariants> & { asChild?: boolean }>(({ className, cols, asChild = false, ...props }, ref) => {
 const Comp = asChild ? Slot : 'div'
 return (
 <Comp
 data-slot="topic-grid"
 data-d-role="grid"className={cn(TopicGridVariants({ cols }), className)}
 ref={ref}
 {...props}
 />
 )
