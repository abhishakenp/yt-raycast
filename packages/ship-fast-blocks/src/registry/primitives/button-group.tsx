...
export const ButtonGroup = defineComponent({
  ...
  component: ({ props, renderNode }) => (
    <UIButtonGroup orientation={props.orientation} className={props.className}>
      {props.leadingText && <ButtonGroupText>{props.leadingText}</ButtonGroupText>}
      {renderNode(props.children)}
      {props.trailingText && <ButtonGroupText>{props.trailingText}</ButtonGroupText>}
    </UIButtonGroup>
  ),
})
...
export const ButtonGroupDivider = defineComponent({
  ...
  component: ({ props }) => <ButtonGroupSeparator className={props.className} />,
})
