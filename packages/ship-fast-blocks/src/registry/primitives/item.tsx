...
export const Item = defineComponent({
  ...
  component: ({ props, renderNode }) => (
    <UIItem variant={props.variant} size={props.size} className={props.className}>
      {props.media && (
        <ItemMedia variant={props.mediaVariant}>{renderNode(props.media)}</ItemMedia>
      )}
      <ItemContent>
...
export const ItemList = defineComponent({
  name: "ItemList",
  description: "Vertical list grouping several Item rows (children). Set separated for dividers between rows.",
  props: z.object({
