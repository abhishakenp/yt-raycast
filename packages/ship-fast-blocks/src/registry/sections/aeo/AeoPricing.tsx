    ...
    return (
      <section className={cn('bg-background py-20 lg:py-28', props.className)}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <PricingGrid
            tiers={tiers}
            heading="Pricing that scales with your AI visibility"
            subheading="Start free, then upgrade as you track more prompts, brands, and answer engines. No setup fees."
            renderCta={(tier) => (
              <SaasPlanActionButton
                lakebed={lakebed}
