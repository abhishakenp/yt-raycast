...
export const AeoCta = defineComponent({
    ...
    actions: z
      .array(
        z.object({
          ...
          variant: z.union([z.literal("primary"), z.literal("outline"), z.literal("ghost")]).optional(),
        }),
      )
      .optional(),
  ...
  component: ({ props }) => {
    const actions = props.actions?.length
      ? props.actions
      : [
          { label: "Start Free", target: "Start Free", variant: "primary" as const },
          { label: "Book demo", target: "Book demo", variant: "outline" as const },
        ]
