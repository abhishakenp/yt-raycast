...
export const VacationRentalOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Vacation Rental experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Vacation Rental page family, built for prompts that need a polished first viewport without creating new HTML."
