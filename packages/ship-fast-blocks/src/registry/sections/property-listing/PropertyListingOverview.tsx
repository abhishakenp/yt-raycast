...
export const PropertyListingOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Property Listing experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Property Listing page family, built for prompts that need a polished first viewport without creating new HTML."
