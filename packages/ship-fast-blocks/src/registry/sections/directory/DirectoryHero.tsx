 ...
 * dot-separated query chips beneath. Search submit and every chip route through
 * useNavigate. Use as the opening hero for local directories, find-a-service
...
export const DirectoryHero = defineComponent({
  ...
  props: z.object({
    ...
    /** Search submit button label (also the search route target). */
