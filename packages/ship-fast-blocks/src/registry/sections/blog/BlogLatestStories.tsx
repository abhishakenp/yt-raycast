...
/**
 * BlogLatestStories — responsive article-grid for an editorial blog / publication.
 * A section header with a heading and a "view all" arrow-link above a 1/2/3-column
 * card grid. Each card has a tagged cover image that zooms on hover, a title,
 * clamped excerpt, and an author/date footer. Cards and the view-all link route
 * through useNavigate. Use as the latest-stories / article-listing section on
 * blog homepages, magazine indexes, or editorial landing pages.
 */
export const BlogLatestStories = defineComponent({
  name: "BlogLatestStories",
  description:
    "Responsive article-grid section for an editorial blog or publication: a section header with a heading and a 'view all' arrow-link above a 1/2/3-column card grid. Each card has a tagged cover image that zooms on hover, a title, clamped excerpt, and an author/date footer. Cards and the view-all link route through useNavigate. Use as the latest-stories / article-listing section on blog homepages, magazine indexes, or editorial landing pages.",
  props: z.object({
