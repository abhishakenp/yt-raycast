...
export const RealEstateOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Real Estate experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Real Estate page family, built for prompts that need a polished first viewport without creating new HTML."
