...
export const CleaningServiceServices = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading =
      props.heading ?? "Services designed around your life"
    const description =
      props.description ??
    ...
    const serviceIcons: ReactNode[] = [
      ...
      <svg key="shield-check" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
