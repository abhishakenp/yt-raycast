 ...
 * in N min" tracking card pinned to its bottom-left corner. The form-submit and
 * search CTA route through useNavigate. Use as the opening hero for food-delivery
