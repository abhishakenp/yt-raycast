...
const ICONS = {
  wellness: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" className="size-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 14c1.5-1.5 3-3.3 3-5.5A4.5 4.5 0 0 0 12 5.5 4.5 4.5 0 0 0 2 8.5c0 2.2 1.5 4 3 5.5l7 7Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 11h4l2-3 3 6 2-3h4" />
    </svg>
  ),
  dental: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" className="size-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 5.5C9.5 3 5 3.5 5 8c0 3 1 5 1.5 8 .3 1.7.8 4 2 4s1.2-2.5 1.5-4c.2-1 .5-2 2-2s1.8 1 2 2c.3 1.5.3 4 1.5 4s1.7-2.3 2-4c.5-3 1.5-5 1.5-8 0-4.5-4.5-5-7-2.5Z" />
    </svg>
  ),
  surgery: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" className="size-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 3.5 18 7 7.5 17.5 4 18l.5-3.5L14.5 3.5Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 21l4-1M16 8l4 4-2 2-4-4" />
    </svg>
  ),
  emergency: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" className="size-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="M22 12h-4l-3 7-4-14-3 7H2" />
    </svg>
  ),
} as const
...
const DEFAULT_SERVICES: { title: string; description: string; icon: IconKey }[] = [
  {
    ...
    services: z
      .array(
        z.object({
          ...
          icon: z.enum(["wellness", "dental", "surgery", "emergency"]).optional(),
        }),
      )
      .optional(),
    ...
    return (
      <section className={"bg-background py-20 sm:py-24" + (props.className ? " " + props.className : "")}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <FeatureGrid heading={heading} subheading={subheading} features={features} columns={4} />
        </div>
      </section>
    )
  },
