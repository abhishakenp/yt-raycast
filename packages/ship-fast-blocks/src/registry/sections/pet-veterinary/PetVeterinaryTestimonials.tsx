...
export const PetVeterinaryTestimonials = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const subheading =
      props.subheading ?? "Real words from the families and furry friends we're proud to care for."
    ...
    return (
      <section className={"bg-background py-20 sm:py-24" + (props.className ? " " + props.className : "")}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <TestimonialGrid heading={heading} subheading={subheading} items={items} columns={3} />
        </div>
      </section>
    )
  },
