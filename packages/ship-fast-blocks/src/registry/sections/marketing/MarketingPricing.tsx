...
/**
 * MarketingPricing — bold-kinetic collapsed-border pricing ledger for a SaaS /
 * product-marketing landing page, backed by shared Lakebed conversion state. An
 * asymmetric header (left-aligned heading with a tilted primary marker block
 * behind the key word, mono "[ PLANS ]" meta right) above a sharp-cornered,
 * collapsed-border 3-tier ledger: each cell carries a mono plan index, name,
 * blurb, a giant tabular-nums price + period, a hairline-divided feature
 * checklist, and a full-width square CTA with a hard offset shadow and press
 * feedback. The "most popular" tier inverts to bg-foreground/text-background with
 * a rotated marker badge. Plans seed command search and every CTA records the
 * selected plan or sales intent. Use as the pricing section for B2B SaaS,
 * productivity, or developer-platform pages.
 */
export const MarketingPricing = defineCapsule({
  name: 'MarketingPricing',
  description:
    'Bold-kinetic collapsed-border pricing ledger for a SaaS / product-marketing landing page backed by shared Lakebed conversion state: an asymmetric header (marker-highlighted heading left, mono plans meta right) above a sharp 3-tier collapsed-border ledger with mono plan indexes, giant tabular-nums prices + periods, hairline feature checklists, and square hard-shadow mutation CTAs; the most-popular tier inverts to a dark surface with a rotated marker badge. Plans seed command search and every CTA records the selected plan or sales intent. Use as the pricing section for B2B SaaS, productivity, or developer-platform pages.',
  props: z.object({
