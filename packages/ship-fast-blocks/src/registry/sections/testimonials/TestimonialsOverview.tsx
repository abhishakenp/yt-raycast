...
export const TestimonialsOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Testimonials experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Testimonials page family, built for prompts that need a polished first viewport without creating new HTML."
