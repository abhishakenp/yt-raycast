 ...
 * route through section-kit route links and the mockup imagery is alt-driven. Use as the final
  ...
  component: ({ props }) => {
    ...
    return (
      <DownloadBand asChild>
        ...
        >
          <CtaBandInner className="max-w-7xl gap-12 py-24">
            <CtaBandTitle className="text-background font-bold sm:text-4xl lg:text-5xl">
              {downloadHeading}
            </CtaBandTitle>
            <CtaBandSubtitle className="text-background/70 text-xl leading-relaxed">
              {downloadDesc}
            </CtaBandSubtitle>
