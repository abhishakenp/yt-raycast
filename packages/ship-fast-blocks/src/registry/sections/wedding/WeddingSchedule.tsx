...
export const WeddingSchedule = defineComponent({
  ...
  component: ({ props }) => {
    ...
    return (
      <section className={cn("bg-background py-20 text-foreground lg:py-32", props.className)}>
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            {events.map((event, i) => (
              ...
              >
                <h3 className="font-serif text-2xl font-medium text-foreground">{event.title}</h3>
                ...
                <dl className="mt-6 space-y-4">
                  <div>
                    ...
                    <dd className="mt-1 text-base text-foreground">{event.time}</dd>
                  </div>
                  <div>
                    <dt className="text-xs font-medium uppercase tracking-[0.15em] text-muted-foreground">
                      Place
                    </dt>
                    <dd className="mt-1 text-base text-foreground">{event.place}</dd>
                    <dd className="mt-1 text-sm text-muted-foreground">{event.address}</dd>
                  </div>
                  <div>
                    <dt className="text-xs font-medium uppercase tracking-[0.15em] text-muted-foreground">
                      Dress code
                    </dt>
                    <dd className="mt-1 text-base text-foreground">{event.dressCode}</dd>
                  </div>
                </dl>
