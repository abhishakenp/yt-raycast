...
export const PortfolioDevOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Portfolio Dev experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Portfolio Dev page family, built for prompts that need a polished first viewport without creating new HTML."
