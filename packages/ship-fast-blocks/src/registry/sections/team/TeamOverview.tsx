...
export const TeamOverview = defineComponent({
  name: "TeamOverview",
  description:
  ...
  component: ({ props }) => {
    ...
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Team page family, built for prompts that need a polished first viewport without creating new HTML."
