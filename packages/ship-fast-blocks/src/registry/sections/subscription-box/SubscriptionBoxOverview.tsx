...
export const SubscriptionBoxOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Subscription Box experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Subscription Box page family, built for prompts that need a polished first viewport without creating new HTML."
