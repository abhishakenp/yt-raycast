...
export const WineryBreweryOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Winery Brewery experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Winery Brewery page family, built for prompts that need a polished first viewport without creating new HTML."
