 ...
 * link route through section-kit route links. Use as the closing site footer for interior
...
export const InteriorDesignFooter = defineCapsule({
  ...
  description:
    'Rich inverted footer on the foreground surface for an upscale interior-design / architecture studio: a four-column band with a wide brand column (two-tone wordmark + about paragraph + round social initial buttons) and two link columns (services, company), above a bordered-top bar with an auto-updating copyright line and legal links. Editorial, refined and high-contrast; the brand button, socials and every link route through section-kit route links. Use as the closing site footer for interior designers, design studios, architecture firms or renovation businesses.',
  props: z.object({
