...
export const WriterAuthorOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Writer Author experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Writer Author page family, built for prompts that need a polished first viewport without creating new HTML."
