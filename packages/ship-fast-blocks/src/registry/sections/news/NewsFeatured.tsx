...
/**
 * NewsFeatured — featured-story lead block for a news / editorial homepage. On a
 * card surface: a top breaking-news banner (red uppercase badge + clickable
 * headline + timestamp), then a 12-column grid with one large lead article on
 * the left (wide photo with an overlaid tag, big headline, excerpt and
 * author/date/read-time byline) and a stacked rail of secondary headlines on the
 * right (each with a category label in a rotating accent tone, headline, excerpt,
 * timestamp and a small square thumbnail, divided by rules). Every story and the
 * breaking headline route through useNavigate. Use directly below the masthead
 * as the lead/featured band of a newspaper, magazine or publication homepage.
 * Renders fully with no props via baked-in defaults.
 */
export const NewsFeatured = defineComponent({
  name: "NewsFeatured",
  description:
    "Featured-story lead block for a news / editorial homepage on a card surface: a top breaking-news banner (red uppercase badge + clickable headline + timestamp), then a 12-column grid with one large lead article on the left (wide photo with overlaid tag, big headline, excerpt and author/date/read-time byline) and a stacked rail of secondary headlines on the right (each with a rotating-accent category label, headline, excerpt, timestamp and small square thumbnail, divided by rules). Stories and the breaking headline route through useNavigate. Use directly below the masthead as the lead/featured band of a newspaper, magazine or publication homepage.",
  props: z.object({
