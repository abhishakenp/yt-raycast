...
export const SalonBarberOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Salon Barber experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Salon Barber page family, built for prompts that need a polished first viewport without creating new HTML."
