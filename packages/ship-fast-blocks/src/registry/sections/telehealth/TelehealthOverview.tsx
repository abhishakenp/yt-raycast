...
export const TelehealthOverview = defineComponent({
  name: "TelehealthOverview",
  description:
    "Reusable overview / hero section for the Telehealth page family. Derived from the section template catalog to provide section-level coverage without new HTML generation: eyebrow, large heading, supporting copy, dual CTAs, feature pills, KPI strip, and an image panel rendered through the alt-driven Image component. Use when composing a telehealth page or adding a focused telehealth band to a larger generated site.",
  props: z.object({
  ...
  component: ({ props }) => {
    ...
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Telehealth page family, built for prompts that need a polished first viewport without creating new HTML."
