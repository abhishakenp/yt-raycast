...
export const TravelAgencyOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Travel Agency experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Travel Agency page family, built for prompts that need a polished first viewport without creating new HTML."
