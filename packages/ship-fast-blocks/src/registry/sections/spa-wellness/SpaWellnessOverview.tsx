...
export const SpaWellnessOverview = defineComponent({
  name: "SpaWellnessOverview",
  description:
    "Reusable overview / hero section for the Spa Wellness page family. Derived from the section template catalog to provide section-level coverage without new HTML generation: eyebrow, large heading, supporting copy, dual CTAs, feature pills, KPI strip, and an image panel rendered through the alt-driven Image component. Use when composing a spa wellness page or adding a focused spa wellness band to a larger generated site.",
  props: z.object({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Spa Wellness experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Spa Wellness page family, built for prompts that need a polished first viewport without creating new HTML."
