...
export const PlumbingHvacOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const heading = props.heading ?? "Plumbing Hvac experience, ready to customize"
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Plumbing Hvac page family, built for prompts that need a polished first viewport without creating new HTML."
