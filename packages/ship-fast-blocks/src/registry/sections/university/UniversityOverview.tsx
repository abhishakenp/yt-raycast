...
export const UniversityOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const subheading = props.subheading ?? "A reusable overview section derived from the existing University page family, built for prompts that need a polished first viewport without creating new HTML."
