  ...
  component: ({ props }) => {
    ...
    return (
      <CtaBand
        ...
        title={headline}
        subtitle={subheading}
        eyebrowClassName="text-xs font-semibold uppercase tracking-[0.22em] text-primary-foreground/80"
        titleClassName="text-4xl font-semibold leading-tight tracking-tight text-primary-foreground sm:text-5xl lg:text-6xl"
        subtitleClassName="max-w-2xl text-lg leading-relaxed text-primary-foreground/85"
        innerClassName="relative max-w-3xl gap-5 overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-primary via-primary to-primary/85 px-6 py-20 shadow-[0_40px_120px_-30px] shadow-primary/50 ring-1 ring-primary/40 sm:py-24"
