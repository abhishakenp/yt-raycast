 ...
 * through section-kit route links. Use directly under a hero to add social proof from press
...
export const LendingLogos = defineCapsule({
  name: 'LendingLogos',
  description:
    "'Featured in' / press-and-trust logos strip for a lending or fintech marketing page: a subtle bordered, card-tinted band with a centered caption above a wrapping row of dimmed monochrome wordmark buttons (small layered-diamond glyph + publication name). Wordmarks route through section-kit route links. Use directly under a hero for social proof from press mentions, partner brands, or trust-signal logos on loan, fintech, SaaS, or conversion landing pages.",
  props: z.object({
