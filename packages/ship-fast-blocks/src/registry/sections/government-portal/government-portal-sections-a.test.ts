...
describe("government-portal sections (batch A — spine)", () => {
  ...
  it("Services renders the four colored dept quick-link cards", () => {
    ...
    expect(src).toContain('"Power Generation"')
  })
  ...
  it("spine sections compose section-kit composites", () => {
    expect(read("GovernmentPortalNavbar.tsx")).toContain(
      'from "#/section-kit/SiteNav.tsx"',
    )
    expect(read("GovernmentPortalFooter.tsx")).toContain(
      'from "#/section-kit/SiteFooter.tsx"',
    )
    expect(read("GovernmentPortalStats.tsx")).toContain(
      'from "#/section-kit/StatGrid.tsx"',
    )
    expect(read("GovernmentPortalServices.tsx")).toContain(
      'from "#/section-kit/SectionHeading.tsx"',
    )
  })
