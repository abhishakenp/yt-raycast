...
export const GovernmentPortalEvents = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const tenders = props.tenders?.length
      ...
      : [
          {
            title: "NIT No: 07/C&I-I/W/TVNL/RAN/2026-27 — AMC of DCS workstations, Unit #1 & #2, TTPS Lalpania",
            href: "/tenders/07",
            date: "25-06-2026",
          },
          {
            title: "NIT No: 08/OP/P/TVNL/RAN/2026-27 — Supply of 110 MT Caustic Soda Lye (Rayon grade)",
            href: "/tenders/08",
            date: "20-06-2026",
          },
          {
            title: "NIT No: 06/C&I-I/W/TVNL/RAN/2026-27 — Annual rate contract for I&C spares, Units #1–#3",
            href: "/tenders/06",
            date: "16-06-2026",
          },
          {
            title: "NIT No: 05/CIVIL/W/TVNL/RAN/2026-27 — Civil maintenance works at TTPS colony",
            href: "/tenders/05",
            date: "12-06-2026",
          },
        ]
