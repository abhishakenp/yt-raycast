...
export const ShopOverview = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const subheading = props.subheading ?? "A reusable overview section derived from the existing Shop page family, built for prompts that need a polished first viewport without creating new HTML."
