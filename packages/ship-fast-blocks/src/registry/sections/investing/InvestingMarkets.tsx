...
export const InvestingMarkets = defineComponent({
  ...
  props: z.object({
    ...
    /** Index cards. */
    indices: z
      .array(z.object({ name: z.string(), value: z.string(), change: z.string(), up: z.boolean() }))
      .optional(),
  ...
  component: ({ props }) => {
    ...
    const indicesNote =
      props.indicesNote ?? "Major world markets as of January 15, 2025, 4:00 PM EST"
    ...
    return (
      <section id="markets" className={cn("bg-background py-24", props.className)}>
