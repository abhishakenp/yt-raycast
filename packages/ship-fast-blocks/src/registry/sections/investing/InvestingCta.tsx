    ...
    return (
      <section className={cn("bg-foreground py-24 text-background", props.className)}>
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="mb-6 text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">{heading}</h2>
          <p className="mx-auto mb-8 max-w-2xl text-lg text-background/60 sm:text-xl">{description}</p>
