...
export const CrowdfundingKimiPage3 = defineComponent({
  name: "CrowdfundingKimiPage3",
  description:
    "Crowdfunding third style sibling to CrowdfundingKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
