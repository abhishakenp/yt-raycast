...
export const CrowdfundingKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Story", "Features", "Gallery", "Rewards", "FAQ", "Back This Project"]
    const hero = {
      eyebrow: "Crowdfunding / Variant 2",
      title: "Cafe-Quality Espresso. Anywhere.",
      description: "FLUX Go The Pocket Espresso Machine | Crowdfunding Campaign FLUX Story Features Gallery Rewards FAQ Back This Project Live on Kickstarter Cafe-Quality Espresso. Anywhere. FLUX G...",
      primaryCta: "Watch the Film",
      secondaryCta: "500 / 500 Claimed",
      imageAlt: "Aerial view of coffee being poured into a ceramic cup on a wooden table with morning sunlight",
      ...props.hero,
    }
