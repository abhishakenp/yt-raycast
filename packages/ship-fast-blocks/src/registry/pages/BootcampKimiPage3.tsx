...
export const BootcampKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Nexus", "Curriculum", "Outcomes", "Tuition", "FAQ", "Apply Now"]
    const hero = {
      eyebrow: "Bootcamp / Variant 3",
      title: "Master full-stack engineering in 16 weeks",
      description: "StackForge Academy | Premium Full-Stack Coding Bootcamp Nexus Curriculum Outcomes Tuition FAQ Apply Now Curriculum Outcomes Tuition FAQ Apply Now Now enrolling: Cohort 42 starts...",
      primaryCta: "Nexus",
      secondaryCta: "Curriculum",
      imageAlt: "Team of software engineers collaborating around laptops in a modern office space",
      ...props.hero,
    }
