...
export const MembershipClubKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const brand = props.brand ?? "Apex Guild The Exclusive Network for Founders & Executives"
    const nav = props.nav?.length ? props.nav : ["Benefits", "Membership", "Gallery", "Stories", "FAQ", "Apex Guild"]
    const hero = {
      eyebrow: "Membership Club / Variant 3",
      title: "Where the world's most ambitious leaders gather",
      description: "Apex Guild The Exclusive Network for Founders & Executives Apex Guild Benefits Membership Gallery Stories FAQ Apply Now Benefits Membership Gallery Stories FAQ Apply Now Now acc...",
