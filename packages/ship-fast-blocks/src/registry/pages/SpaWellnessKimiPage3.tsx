...
export const SpaWellnessKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const hero = {
      ...
      description: "Elysian Springs Luxury Wellness Retreat & Spa Elysian Springs Treatments Gallery Packages Stories FAQ Book Retreat Treatments Gallery Packages Stories FAQ Book Retreat Est. 2009...",
