...
export const CafeKimiPage3 = defineComponent({
  name: "CafeKimiPage3",
  description:
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Velvet Roast", "Story", "Gallery", "Reviews", "Location", "Order Ahead"]
    const hero = {
      eyebrow: "Cafe / Variant 3",
      title: "Coffee worth slowing down for.",
      description: "Velvet Roast Cafe Artisan Coffee in Portland Velvet Roast Menu Story Gallery Reviews Location Order Ahead Est. 2018 | Pearl District, Portland Coffee worth slowing down for. Sin...",
  ...
  },
  {
    ...
    "items": [
      "Come by. The door is always open at 6:30.",
      "Espresso Bar",
      "Pastry Case"
    ]
  },
