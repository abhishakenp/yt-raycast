...
export const ComingSoonKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Pulse", "Features", "Pricing", "FAQ", "Join waitlist"]
    const hero = {
      eyebrow: "Coming Soon / Variant 2",
      title: "One workspace. Infinite momentum.",
      description: "Pulse Coming Soon Pulse Features Pricing FAQ Join waitlist Launching June 15, 2026 One workspace. Infinite momentum. Pulse unifies your projects, docs, and conversations into a...",
