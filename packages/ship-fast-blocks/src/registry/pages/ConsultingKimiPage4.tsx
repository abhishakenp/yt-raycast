...
export const ConsultingKimiPage4 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Services", "Insights", "Approach", "Contact", "Meridian", "Get in Touch"]
    const hero = {
      eyebrow: "Consulting / Variant 4",
      title: "Clarity in Complexity. Strategy that Endures.",
      description: "Meridian Consulting Partners | Strategy & Management Advisory Meridian Services Insights Approach Contact Get in Touch Services Insights Approach Contact Global Management Advis...",
      primaryCta: "Meridian",
