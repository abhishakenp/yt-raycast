...
export const DentalKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Apex Dental Arts", "Services", "Team", "Pricing", "FAQ", "(206) 555-0142"]
    const hero = {
      eyebrow: "Dental / Variant 3",
      title: "Where Art Meets Dentistry",
      description: "Apex Dental Arts Premium Dental Care in Seattle Apex Dental Arts Services Team Pricing FAQ (206) 555-0142 Book Online Services Team Pricing FAQ Book Appointment Now accepting ne...",
      primaryCta: "Apex Dental Arts",
      secondaryCta: "Services",
      imageAlt: "Bright modern dental treatment room with ergonomic chair and natural lighting",
      ...props.hero,
    }
