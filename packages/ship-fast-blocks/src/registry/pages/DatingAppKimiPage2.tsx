...
export const DatingAppKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["How it Works", "Features", "Stories", "FAQ", "ember", "Log in"]
    const hero = {
      eyebrow: "Dating App / Variant 2",
      title: "Dating that feels human.",
      description: "Ember Dating That Feels Human ember How it Works Features Stories FAQ Log in Get the app Dating that feels human. Real connections, zero games. Meet people who actually want to...",
      primaryCta: "ember",
      secondaryCta: "How it Works",
      imageAlt: "Ember app interface showing a dating profile photo of a woman hiking at sunset",
      ...props.hero,
    }
