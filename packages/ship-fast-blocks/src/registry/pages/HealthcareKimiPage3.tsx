...
export const HealthcareKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Meridian Health", "Services", "How It Works", "Pricing", "Reviews", "FAQ"]
    const hero = {
      eyebrow: "Healthcare / Variant 3",
      title: "Modern Healthcare Designed Around Your Life",
      description: "Meridian Health Group | Primary & Urgent Care in Austin, TX Meridian Health Services How It Works Pricing Reviews FAQ Book Now Services How It Works Pricing Reviews FAQ Book Now...",
      primaryCta: "Meridian Health",
      secondaryCta: "Services",
      imageAlt: "Board-certified physician reviewing a digital chart with a patient in a sunlit modern examination room",
      ...props.hero,
    }
