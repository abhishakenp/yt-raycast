...
export const DirectoryKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const brand = props.brand ?? "LocalFind Discover the Best Local Businesses Near You"
    const nav = props.nav?.length ? props.nav : ["Explore", "Categories", "For Business", "Reviews", "L LocalFind", "List Your Business"]
    const hero = {
      eyebrow: "Directory / Variant 2",
      title: "Find the Best Local Businesses",
      description: "LocalFind Discover the Best Local Businesses Near You L LocalFind Explore Categories For Business Reviews List Your Business Find the Best Local Businesses Discover top-rated re...",
      primaryCta: "Search",
