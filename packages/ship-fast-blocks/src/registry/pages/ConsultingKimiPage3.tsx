...
export const ConsultingKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["N Northridge Advisory", "Services", "Insights", "Approach", "Pricing", "FAQ"]
    const hero = {
      eyebrow: "Consulting / Variant 3",
      title: "Strategy that moves markets .",
      description: "Northridge Advisory Management Consulting N Northridge Advisory Services Insights Approach Pricing FAQ Contact us Services Insights Approach Pricing FAQ Contact us Northridge Ad...",
