...
export const ChurchKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Services", "Ministries", "Events", "Next Steps", "Give", "G Grace Community"]
    const hero = {
      eyebrow: "Church / Variant 3",
      title: "A Place to Belong . A Path to Become .",
      description: "Grace Community Church Welcome Home G Grace Community Services Ministries Events Next Steps Give Plan a Visit Services Ministries Events Next Steps Give Plan a Visit Livestream...",
      primaryCta: "Join",
