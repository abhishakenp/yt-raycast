...
export const ChurchKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const hero = {
      ...
      title: "Welcome Home",
      description: "Grace Covenant Church | Welcome Home G Grace Covenant Austin, Texas Services Events About Give Join us this Sunday Welcome Home A diverse community in the heart of Austin, wrest...",
