...
export const CoworkingKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const brand = props.brand ?? "Haven Workspace Premium Coworking in Downtown Austin"
    const nav = props.nav?.length ? props.nav : ["Nexus Workspace", "Spaces", "Amenities", "Pricing", "Community", "Book a Tour"]
    const hero = {
      eyebrow: "Coworking / Variant 3",
      title: "Work where ambition thrives",
      description: "Haven Workspace Premium Coworking in Downtown Austin Nexus Workspace Spaces Amenities Pricing Community Book a Tour Work where ambition thrives Premium coworking spaces in downt...",
      primaryCta: "Nexus Workspace",
      secondaryCta: "Spaces",
      imageAlt: "Bright modern coworking lounge with floor to ceiling windows and green plants",
      ...props.hero,
    }
