...
export const CryptoKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const brand = props.brand ?? "Nexus Protocol Decentralized Liquidity Layer for Web3"
    const nav = props.nav?.length ? props.nav : ["Nexus", "Ecosystem", "Staking", "Roadmap", "Docs", "Sign In"]
    const hero = {
      eyebrow: "Crypto / Variant 3",
      title: "Unlock the Future of Decentralized Finance",
      description: "Nexus Protocol Decentralized Liquidity Layer for Web3 Nexus Ecosystem Staking Roadmap Docs Sign In Launch App Ecosystem Staking Roadmap Docs Launch App Mainnet v2.0 Live Unlock...",
