...
export const NewsletterKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const brand = props.brand ?? "The Signal Weekly Briefing on Technology, Business & Culture"
    const nav = props.nav?.length ? props.nav : ["The Signal", "What You Get", "Recent Issues", "Readers", "FAQ", "Subscribe Free"]
    const hero = {
      eyebrow: "Newsletter / Variant 3",
      title: "Stay ahead of the curve",
      description: "The Signal Weekly Briefing on Technology, Business & Culture The Signal What You Get Recent Issues Readers FAQ Subscribe Free Join 34,000+ readers every Tuesday Stay ahead of th...",
