...
export const ConstructionKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Services", "Projects", "Process", "Pricing", "FAQ", "Get a Quote"]
    const hero = {
      eyebrow: "Construction / Variant 3",
      title: "Build with precision. Deliver with pride.",
      description: "Atlas Construction & Contracting Build with Confidence Atlas Construction Services Projects Process Pricing FAQ Get a Quote Services Projects Process Pricing FAQ Get a Quote Ser...",
      primaryCta: "Submit Quote Request",
      secondaryCta: "Atlas Construction",
      imageAlt: "Aerial view of a large commercial construction site with cranes and steel framing at golden hour",
      ...props.hero,
    }
  ...
  },
  {
    ...
    "body": "Construction page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
  ...
  },
  {
    ...
    "body": "Construction page variant 3 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Project Management",
      "Design-Build",
      "Concrete & Foundation"
  ...
  },
  {
    ...
    "body": "Construction page variant 4 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Interior Fit-Outs",
      "Discovery & Budget",
      "Design & Permitting"
