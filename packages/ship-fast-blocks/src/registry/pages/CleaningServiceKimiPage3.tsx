...
export const CleaningServiceKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Services", "How It Works", "Gallery", "Pricing", "Reviews", "FAQ"]
    const hero = {
      eyebrow: "Cleaning Service / Variant 3",
      title: "A cleaner home. A clearer mind.",
      description: "Maison Pure | Premium Home Cleaning Services Maison Pure Services How It Works Gallery Pricing Reviews FAQ (555) 987-1234 Book Now Services How It Works Gallery Pricing Reviews...",
