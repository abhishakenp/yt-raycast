...
export const ScheduleKimiPage4 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Schedule", "Workshops", "Artists", "Gallery"]
    const hero = {
      eyebrow: "Schedule / Variant 4",
      title: "Workshop Schedule",
      description: "Class Schedule Art Studio Schedule Workshops Artists Gallery Workshop Schedule Unleash your creativity with our art classes All Workshops Painting Drawing Ceramics Photography P...",
