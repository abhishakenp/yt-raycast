...
export const CommunityForumKimiPage2 = defineComponent({
  name: "CommunityForumKimiPage2",
  description:
    "Community Forum second style sibling to CommunityForumKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
