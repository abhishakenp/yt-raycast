 ...
 */
export const MobileAppKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const communitySubtitle = props.hero?.communitySubtitle ?? "Join the community"
    ...
    const CheckIcon = ({ className }: { className?: string }) => (
      <svg viewBox="0 0 20 20" fill="currentColor" className={cn("size-5 shrink-0", className)} aria-hidden="true">
        <path
          fillRule="evenodd"
    ...
    const featureIcons = [
      ...
      // sync
      <svg key="sync" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-7" aria-hidden="true">
    ...
    return (
      ...
      >
        ...
        <main>
          {/* Hero */}
          <section className="relative overflow-hidden pb-16 pt-32 lg:pb-24 lg:pt-40" aria-labelledby="hero-heading">
            <div className="absolute inset-0 -z-10 bg-gradient-to-br from-primary/10 via-background to-accent/20" />
            <div aria-hidden="true" className="absolute right-0 top-20 -z-10 size-96 rounded-full bg-primary/20 blur-3xl" />
            <div aria-hidden="true" className="absolute bottom-0 left-0 -z-10 size-72 rounded-full bg-accent/30 blur-3xl" />
              ...
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                <div className="text-center lg:text-left">
                  ...
                  >
                    {heroTop}
                    <br />
                    <span className="text-primary">{heroHighlight}</span> {heroRest}
                  </h1>
                  ...
                  <div className="mb-8 flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                    ...
                    >
                      ...
                      <span className="text-left">
                        <span className="block text-xs text-background/70">Download on the</span>
                        <span className="block text-sm font-bold">{heroAppStore}</span>
                      </span>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <span className="text-left">
                        <span className="block text-xs text-background/70">Get it on</span>
                        <span className="block text-sm font-bold">{heroPlayStore}</span>
                      </span>
                    </button>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground lg:justify-start">
                    <span className="flex items-center gap-2">
                      ...
                      <span className="font-semibold text-foreground">{heroAppRating}</span> App Store
                    </span>
                    <span className="flex items-center gap-2">
                      <StarIcon className="text-primary" />
                      <span className="font-semibold text-foreground">{heroPlayRating}</span> Google Play
                    </span>
                ...
                <div className="relative flex justify-center lg:justify-end">
                  <div className="relative">
                    <div aria-hidden="true" className="absolute -inset-4 rounded-[3rem] bg-gradient-to-r from-primary to-accent opacity-30 blur-2xl" />
                    <div className="relative">
                      <Image
                        alt={heroImageAlt}
                        w={400}
                      ...
                      <div className="absolute -bottom-4 -left-8 flex items-center gap-3 rounded-2xl bg-card p-4 shadow-xl">
                        <div className="grid size-12 place-items-center rounded-full bg-primary/15">
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-6 text-primary" aria-hidden="true">
                            <path d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <div>
                          <div className="text-sm font-bold text-card-foreground">{chipTitle}</div>
                      ...
                      <div className="absolute -right-8 -top-4 rounded-2xl bg-card p-4 shadow-xl">
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <span className="text-xs font-semibold text-card-foreground">{communityLabel}</span>
                        </div>
                        <div className="text-xs text-muted-foreground">{communitySubtitle}</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {/* Featured-in logos */}
          <section className="border-y border-border bg-background py-12 lg:py-16" aria-label="Featured in">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              ...
              <div className="flex flex-wrap items-center justify-center gap-8 opacity-60 lg:gap-16">
                {logoItems.map((logo) => (
                  <div key={logo} className="flex items-center gap-2 text-xl font-bold text-foreground">
          ...
          {/* Features */}
          <section id="features" className="bg-background py-20 lg:py-28" aria-labelledby="features-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <span className="mb-4 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
                  {featuresEyebrow}
                </span>
                <h2 id="features-heading" className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                  {featuresHeading}
                </h2>
          ...
          {/* How it works */}
          <section id="how-it-works" className="bg-muted/40 py-20 lg:py-28" aria-labelledby="steps-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <span className="mb-4 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
                  {stepsEyebrow}
                </span>
                <h2 id="steps-heading" className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                  {stepsHeading}
                </h2>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {stepBadges.map((badge) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium text-card-foreground">{badge}</span>
                    </span>
                  ))}
                </div>
              </div>
          ...
          {/* Gallery */}
          <section className="overflow-hidden bg-background py-20 lg:py-28" aria-labelledby="gallery-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="mx-auto mb-12 max-w-3xl text-center lg:mb-16">
                <span className="mb-4 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
                  {galleryEyebrow}
                </span>
                <h2 id="gallery-heading" className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                  {galleryHeading}
                </h2>
              ...
              <div className="relative">
                ...
                <div className="mt-4 flex justify-center gap-2">
                  {galleryItems.map((item, i) => (
                    <span
                      key={item.label}
                      className={cn("size-2 rounded-full", i === 0 ? "bg-primary" : "bg-border")}
                    />
                  ))}
                </div>
              </div>
          ...
          {/* Stats band */}
          <section className="bg-primary py-16 text-primary-foreground lg:py-20" aria-label="Statistics">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="grid grid-cols-2 gap-8 text-center lg:grid-cols-4 lg:gap-12">
                {statsItems.map((s) => (
                  <div key={s.label}>
                    ...
                    <div className="font-medium text-primary-foreground/70">{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* Pricing */}
          <section id="pricing" className="bg-muted/40 py-20 lg:py-28" aria-labelledby="pricing-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <span className="mb-4 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
                  {pricingEyebrow}
                </span>
                <h2 id="pricing-heading" className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                  {pricingHeading}
                </h2>
              ...
              <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3 lg:gap-8">
                {pricingTiers.map((tier) => (
                  ...
                  >
                    ...
                    <div className="mb-6">
                      <h3 className="mb-2 text-xl font-bold text-card-foreground">{tier.name}</h3>
                    ...
                    {tier.billingNote && (
                      <p className="mb-6 text-sm text-muted-foreground">{tier.billingNote}</p>
                    )}
              ...
              <p className="mt-8 text-center text-sm text-muted-foreground">{pricingNote}</p>
            </div>
          </section>

          {/* Testimonials */}
          <section id="testimonials" className="bg-background py-20 lg:py-28" aria-labelledby="testimonials-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <span className="mb-4 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
                  {testimonialsEyebrow}
                </span>
                <h2 id="testimonials-heading" className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                  {testimonialsHeading}
                </h2>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                {testimonialItems.map((t) => (
                  <div key={t.name} className="rounded-2xl bg-muted/60 p-6 lg:p-8">
          ...
          {/* FAQ */}
          <section id="faq" className="bg-muted/40 py-20 lg:py-28" aria-labelledby="faq-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="mx-auto max-w-3xl">
                <div className="mb-16 text-center lg:mb-20">
                  ...
                  <h2 id="faq-heading" className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
                    {faqHeading}
                  </h2>
                ...
                <div className="mt-12 text-center">
                  <p className="mb-4 text-muted-foreground">{faqContactPrompt}</p>
                  <button
                    type="button"
          ...
          {/* Download CTA */}
          <section id="download" className="bg-background py-20 lg:py-28" aria-labelledby="cta-heading">
            <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-accent">
                <div aria-hidden="true" className="absolute right-0 top-0 size-96 -translate-y-1/2 translate-x-1/2 rounded-full bg-primary-foreground/10 blur-3xl" />
                <div aria-hidden="true" className="absolute bottom-0 left-0 size-72 -translate-x-1/2 translate-y-1/2 rounded-full bg-primary-foreground/10 blur-3xl" />

                <div className="relative px-8 py-16 text-center lg:px-16 lg:py-20">
                  <h2 id="cta-heading" className="mb-6 text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl lg:text-5xl">
                    {ctaHeading}
                  </h2>
        ...
        {/* Footer */}
        <footer className="bg-foreground py-12 text-background/70 lg:py-16" aria-label="Footer">
          <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12">
