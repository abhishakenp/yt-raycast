...
export const ScheduleKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Schedule", "Classes", "Instructors", "Membership"]
    const hero = {
      eyebrow: "Schedule / Variant 2",
      title: "Class Schedule",
      description: "Class Schedule FitLife Studio Schedule Classes Instructors Membership Class Schedule Book your next workout session All Classes Yoga Pilates HIIT Spin Strength MONDAY Morning Fl...",
