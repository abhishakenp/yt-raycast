 ...
 */
export const MobileAppKimiPage10 = defineComponent({
  ...
  component: ({ props }) => {
      ...
      : [
          {
            ...
            imageAlt:
              "Person holding smartphone showing app onboarding screen",
          },
          {
    ...
    const galleryHeading =
      props.gallery?.heading ?? "Beautiful by design"
    const galleryDesc =
    ...
    const pricingTiers = props.pricing?.tiers?.length
      ...
      : [
          ...
          },
          {
            name: "Pro",
            tagline:
              "For serious habit builders who want maximum results.",
            price: "$4.99",
            period: "/month",
    ...
    const testimonialItems = props.testimonials?.items?.length
      ...
      : [
          ...
          },
          {
            ...
            avatarAlt:
              "Professional headshot of Priya Patel, a UX designer",
          },
          {
            quote:
    ...
    const footerColumns = props.footer?.columns?.length
      ...
      : [
          {
            title: "Product",
            links: ["Features", "Pricing", "Download", "Integrations", "Changelog"],
          },
          {
            title: "Company",
    ...
    return (
      ...
      >
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex items-center justify-center gap-4 lg:justify-start">
                  ...
                  <div className="text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">{heroRating}</span>{" "}
                    from{" "}
                    <span className="font-semibold text-foreground">{heroRatingCount}</span>{" "}
                    reviews
                  </div>
                </div>
              </div>
                ...
                <div className="relative mx-auto w-72 sm:w-80">
                  ...
                  <div className="relative rounded-[3rem] bg-foreground p-3 shadow-2xl shadow-foreground/30">
                    ...
                    <div className="aspect-[9/19] overflow-hidden rounded-[2.5rem] bg-background">
                      ...
                      <div className="flex h-full flex-col bg-gradient-to-b from-muted to-background p-4">
                        ...
                        <div className="mb-1 text-2xl font-bold text-foreground">Tuesday, Jan 14</div>
                        <div className="mb-4 text-sm text-muted-foreground">3 of 5 habits completed</div>

                        {/* Habit Items */}
                        <div className="flex-1 space-y-3">
                          <div className="flex items-center gap-3 rounded-xl border border-border bg-background p-3 shadow-sm">
                            <div className="flex size-10 items-center justify-center rounded-lg bg-primary/10">
                              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-5 text-primary" aria-hidden="true">
                                <path d="M13 10V3L4 14h7v7l9-11h-7z" />
                              </svg>
                            </div>
                            <div className="flex-1">
                              <div className="font-semibold text-foreground">Morning Workout</div>
                              <div className="text-xs text-muted-foreground">7:00 AM \u2022 24 day streak</div>
                            </div>
                          ...
                          <div className="flex items-center gap-3 rounded-xl border border-border bg-background p-3 shadow-sm">
                            <div className="flex size-10 items-center justify-center rounded-lg bg-accent/20">
                              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-5 text-accent" aria-hidden="true">
                                <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                              </svg>
                            </div>
                            <div className="flex-1">
                              <div className="font-semibold text-foreground">Read 20 Pages</div>
                              <div className="text-xs text-muted-foreground">8:00 AM \u2022 156 day streak</div>
                            </div>
                            <div className="flex size-6 items-center justify-center rounded-full bg-primary">
                              <CheckMarkIcon className="size-4 text-background" />
                            </div>
                          ...
                          <div className="flex items-center gap-3 rounded-xl border border-border bg-background p-3 shadow-sm">
                            <div className="flex size-10 items-center justify-center rounded-lg bg-chart-4/20">
                              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-5 text-chart-4" aria-hidden="true">
                                <path d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                              </svg>
                            </div>
                            <div className="flex-1">
                              <div className="font-semibold text-foreground">Drink 8 Glasses</div>
                              <div className="text-xs text-muted-foreground">All day \u2022 42 day streak</div>
                            </div>
                        ...
                        <div className="mt-4 rounded-xl bg-gradient-to-r from-primary to-accent p-4 text-background">
                          ...
                          <div className="flex gap-1">
                            {[100, 100, 100, 100, 80, 0, 0].map((w, i) => (
                              <div key={i} className="h-2 flex-1 rounded-full bg-background/30 overflow-hidden">
                                <div
                  ...
                  <div className="absolute -left-16 top-20 hidden rounded-2xl border border-border bg-card p-4 shadow-xl shadow-foreground/10 sm:block">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-bold text-card-foreground">{streakValue} Days</div>
                        <div className="text-sm text-muted-foreground">{streakLabel}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute -right-12 bottom-32 hidden rounded-2xl border border-border bg-card p-4 shadow-xl shadow-foreground/10 sm:block">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <span className="font-bold text-card-foreground">{chipTitle}</span>
                    </div>
                    <div className="text-sm text-muted-foreground">{chipSubtitle}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* ========== LOGOS ========== */}
        <section className="border-y border-border bg-muted/50 py-12" aria-label="Featured in">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <div className="mb-6 flex size-14 items-center justify-center rounded-2xl bg-background/20 backdrop-blur-sm">
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-7 text-background" aria-hidden="true">
                            <path d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                          </svg>
                        </div>
                        <h3 className="mb-3 text-2xl font-bold">{item.title}</h3>
                        <p className="mb-6 max-w-md text-background/90">{item.description}</p>
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-sm text-background/80">3 personalized times today</span>
                        </div>
                      </div>
                    </div>
                  )
                    ...
                    {i === 1 && (
                      <div className="mt-4 flex items-center gap-2">
                        <div className="flex -space-x-1">
                          {["1", "4", "2"].map((n, idx) => (
                            <div key={idx} className="flex size-6 items-center justify-center rounded-sm bg-gradient-to-t from-primary to-accent text-xs font-bold text-background">
                              {n}
                            </div>
                          ))}
                        </div>
                    ...
                    {i === 2 && (
                      <div className="mt-4 flex h-8 items-end gap-1">
                        {[40, 60, 45, 80, 100, 70, 90].map((h, idx) => (
                          <div key={idx} className="w-3 rounded-t" style={{ height: `${h}%`, background: `hsl(var(--primary))`, opacity: 0.2 + idx * 0.1 }} />
                        ))}
                      </div>
                    )}
                    {i === 3 && (
        ...
        {/* ========== STEPS ========== */}
        <section className="bg-gradient-to-b from-muted to-background py-24" aria-labelledby="steps-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto mb-16 max-w-3xl text-center">
              <h2
                id="steps-heading"
              ...
              {stepItems.map((step, i) => (
                <div key={step.title} className="relative">
                  ...
                  <div className="rounded-2xl border border-border bg-card p-6 shadow-lg shadow-foreground/5">
                    ...
                    <h3 className="mb-3 text-xl font-bold text-card-foreground">{step.title}</h3>
                  ...
                  {item.captionTitle && (
                    <div className="absolute inset-0 flex items-end bg-gradient-to-t from-foreground/60 to-transparent p-6">
                      <div className="text-background">
                        ...
                        <p className="text-sm text-background/80">{item.captionDesc}</p>
                      </div>
                    </div>
                  )}
                </div>
        ...
        {/* ========== STATS ========== */}
        <section className="bg-gradient-to-r from-primary to-accent py-24" aria-label="Statistics">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* ========== PRICING ========== */}
        <section className="bg-muted/50 py-24" aria-labelledby="pricing-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto mb-16 max-w-3xl text-center">
              <h2
                id="pricing-heading"
        ...
        {/* ========== FOOTER ========== */}
        <footer className="bg-foreground py-16 text-background/80" aria-label="Footer">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
