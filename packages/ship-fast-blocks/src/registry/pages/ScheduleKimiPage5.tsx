...
export const ScheduleKimiPage5 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Schedule", "Languages", "Teachers", "Pricing"]
    const hero = {
      eyebrow: "Schedule / Variant 5",
      title: "Class Schedule",
      description: "Class Schedule Language School Schedule Languages Teachers Pricing Class Schedule Learn a new language with expert instructors All Languages Spanish French German Japanese Manda...",
