...
export const ComingSoonKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const brand = props.brand ?? "Nexus The Intelligence Layer for Modern Teams. Coming January 2027."
    const nav = props.nav?.length ? props.nav : ["Nexus", "Features", "How It Works", "Preview", "Stories", "FAQ"]
    const hero = {
      eyebrow: "Coming Soon / Variant 3",
      title: "The Intelligence Layer for Modern Teams",
      description: "Nexus The Intelligence Layer for Modern Teams. Coming January 2027. Nexus Features How It Works Preview Stories FAQ Join Waitlist Launching January 15, 2027 The Intelligence Lay...",
      primaryCta: "Get Early Access",
      secondaryCta: "Join Waitlist",
      imageAlt: "professional headshot of a smiling product manager with dark hair",
      ...props.hero,
    }
