...
export const CleaningServiceKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Sparkle Clean", "Services", "How It Works", "Pricing", "Reviews", "FAQ"]
    const hero = {
      eyebrow: "Cleaning Service / Variant 2",
      title: "A Spotless Home, Zero Effort.",
      description: "SparkleClean Professional Home Cleaning Services Sparkle Clean Services How It Works Pricing Reviews FAQ (800) 555-1234 Book Cleaning Same-Day Appointments Available A Spotless...",
      primaryCta: "Sparkle Clean",
      secondaryCta: "Services",
      imageAlt: "professional cleaner in blue uniform vacuuming a modern living room with natural light",
      ...props.hero,
    }
