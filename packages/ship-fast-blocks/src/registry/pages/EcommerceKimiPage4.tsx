...
export const EcommerceKimiPage4 = defineComponent({
  name: "EcommerceKimiPage4",
  description:
    "Ecommerce fourth style sibling to EcommerceKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
