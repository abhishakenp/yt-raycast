...
export const CloudInfraKimiPage3 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Products", "Pricing", "Solutions", "Docs", "N Nebula Cloud", "Log in"]
    const hero = {
      eyebrow: "Cloud Infra / Variant 3",
      title: "Infrastructure that scales with your traffic",
      description: "Nebula Cloud Usage-Based Cloud Infrastructure N Nebula Cloud Products Pricing Solutions Docs Log in Get Started New: Edge Functions now available in 12 regions Infrastructure th...",
      primaryCta: "N Nebula Cloud",
      secondaryCta: "Products",
      imageAlt: "High-density server racks in a modern data center illuminated by blue LED lighting",
      ...props.hero,
    }
