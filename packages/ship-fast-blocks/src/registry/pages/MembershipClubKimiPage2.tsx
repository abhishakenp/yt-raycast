...
export const MembershipClubKimiPage2 = defineComponent({
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Benefits", "Tiers", "Stories", "FAQ", "Join now", "VOLT Collective"]
    const hero = {
      eyebrow: "Membership Club / Variant 2",
      title: "Where creators build , connect , and thrive .",
      description: "VOLT Collective Join the Creative Membership Club VOLT Collective Benefits Tiers Stories FAQ Join now Benefits Tiers Stories FAQ Join now Where creators build , connect , and th...",
      primaryCta: "VOLT Collective",
      secondaryCta: "Benefits",
      imageAlt: "Modern coworking loft with warm lighting and long wooden tables",
      ...props.hero,
    }
