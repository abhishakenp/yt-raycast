...
export const NewsKimiPage3 = defineComponent({
  name: "NewsKimiPage3",
  description:
    "News third style sibling to NewsKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
