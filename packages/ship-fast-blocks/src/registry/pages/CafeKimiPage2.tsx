...
export const CafeKimiPage2 = defineComponent({
  name: "CafeKimiPage2",
  description:
  ...
  component: ({ props }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Copper Mug", "Our Story", "Gallery", "Visit", "Order Now", "Find Us"]
    const hero = {
      eyebrow: "Cafe / Variant 2",
      title: "Fuel Your Day With Fire Roasted Flavor",
      description: "Copper Mug Coffee Co. Craft Coffee & Vibrant Vibes in Portland Copper Mug Menu Our Story Gallery Visit Order Now Menu Fuel Your Day With Fire Roasted Flavor Single-origin espres...",
      primaryCta: "Copper Mug",
      secondaryCta: "Menu",
      imageAlt: "Overhead view of a ceramic coffee cup surrounded by roasted coffee beans on a dark slate table",
      ...props.hero,
    }
