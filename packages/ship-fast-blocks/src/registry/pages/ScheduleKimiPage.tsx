...
export const ScheduleKimiPage = defineComponent({
  name: "ScheduleKimiPage",
  description:
    "Schedule 1th style sibling to ScheduleKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props }) => {
    ...
    const hero = {
      ...
      description: "Weekly Class Schedule The Movement Room The Movement Room Schedule Instructors Pricing FAQ Book a Class June 1 June 7, 2026 Weekly Class Schedule Reserve your mat, reformer, or...",
      primaryCta: "All Classes",
      secondaryCta: "Yoga",
      imageAlt: "Professional headshot of a smiling woman with dark hair, Maya Chen yoga instructor",
      ...props.hero,
    }
    ...
    const sections = props.sections?.length ? props.sections : [
  {
    ...
    "body": "Weekly Class Schedule The Movement Room The Movement Room Schedule Instructors Pricing FAQ Book a Class June 1 June 7, 2026 Weekly Class Schedule Reserve your mat, reformer, or...",
    "items": [
      "What Members Say",
