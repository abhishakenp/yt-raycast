...
export const AgencyKimiPage2 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const handleInquirySubmit = (e: React.FormEvent) => {
      e.preventDefault()
      void submitInquiry(inquiryForm.name, inquiryForm.email, inquiryForm.company, inquiryForm.message)
              ...
              <Sheet open={inquiryOpen} onOpenChange={setInquiryOpen}>
                ...
                >
                  <SheetHeader className="border-b border-border p-6">
                    <SheetTitle className="text-xl">Start Your Project</SheetTitle>
                    <SheetDescription>
