...
export const AgencyKimiPage2 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const logosCaption = props.logos?.caption ?? 'Trusted by industry leaders'
      ...
      : [
          {
            ...
            description:
              'Complete rebrand and digital platform for next-gen banking',
            tag: 'Fintech',
          },
          {
            title: 'Aurora Fashion',
            description:
              'Sustainable fashion marketplace with AR try-on features',
            tag: 'E-Commerce',
          },
          {
            title: 'Mindspace App',
            description:
              'Mental wellness platform with AI-powered therapy tools',
            tag: 'Health Tech',
          },
          {
          ...
          },
          {
            ...
            description:
              'Decentralized trading platform with institutional-grade security',
            tag: 'Crypto',
          },
        ]
      ...
      >
        ...
        <main>
          ...
          >
            ...
            <div
              aria-hidden="true"
              className="absolute right-0 top-20 size-96 rounded-full bg-primary/30 blur-3xl"
            />
            <div
              aria-hidden="true"
              className="absolute bottom-0 left-0 size-72 rounded-full bg-accent/30 blur-3xl"
            />
          ...
          {/* Logo marquee */}
          <section
            className="overflow-hidden border-y border-border py-16"
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-24">
                ...
                <h2 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  {servicesHeading}{' '}
                  <span className="text-primary">{servicesHighlight}</span>
                </h2>
              ...
              <div className="mb-16 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  ...
                  <h2 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                    {workHeading}{' '}
                    <span className="text-primary">{workHighlight}</span>
                  </h2>
                </div>
                <button
                  type="button"
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-6 lg:p-8">
                      ...
                      <h3
                        className={cn(
                          'mb-2 font-bold',
                          i === 3 ? 'text-2xl lg:text-3xl' : 'text-2xl',
                        )}
                      >
                        {proj.title}
                      </h3>
              ...
              <div className="grid items-center gap-16 lg:grid-cols-2">
                <div>
                  ...
                  <h2 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl">
                    {aboutHeading}{' '}
                    <span className="text-primary">{aboutHighlight}</span> For
                    Themselves
                  </h2>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-6 pt-12">
                    {aboutItems.slice(2, 4).map((s) => (
                      ...
                      >
                        <div className="mb-2 text-5xl font-black text-foreground">
                          {s.value}
                        </div>
          ...
          >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-24">
                ...
                <h2 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  {processHeading}{' '}
                  <span className="text-primary">{processHighlight}</span>
                </h2>
          ...
          <section className="py-24 lg:py-32" aria-label="Client testimonials">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-24">
                ...
                <h2 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  {testimonialsHeading}{' '}
                  <span className="text-primary">{testimonialsHighlight}</span>
                </h2>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                {testimonialItems.map((t) => (
                  ...
                  >
                    ...
                    <p className="mb-8 text-lg leading-relaxed text-card-foreground">
                      &ldquo;{t.quote}&rdquo;
                    </p>
                    <div className="flex items-center gap-4">
                      <Image
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              <div className="mb-16 text-center">
                ...
                <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">
                  {faqHeading}{' '}
                  <span className="text-primary">{faqHighlight}</span>
                </h2>
              </div>
          ...
          >
            ...
            <div
              aria-hidden="true"
              className="absolute right-0 top-0 size-96 rounded-full bg-primary/30 blur-3xl"
            />
            <div
              aria-hidden="true"
              className="absolute bottom-0 left-0 size-72 rounded-full bg-accent/30 blur-3xl"
            ...
            <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
              <h2 className="mb-6 text-4xl font-black tracking-tight sm:text-5xl lg:text-6xl">
                {ctaLead} <span className="text-primary">{ctaHighlight}</span>
                {ctaTrail}
              </h2>
