...
export const FilmDirectorKimiPage3 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length
      ? props.nav
      : ['Work', 'Services', 'Process', 'Pricing', 'About', 'MARCUS CHEN']
    const hero = {
      eyebrow: 'Film Director / Variant 3',
      title: 'Stories That Move People',
      description:
        'Marcus Chen Director & Cinematographer MARCUS CHEN Work Services Process Pricing About Book a Call Director / Cinematographer Stories That Move People Award-winning director and...',
      primaryCta: 'Send Inquiry',
      secondaryCta: 'MARCUS CHEN',
      imageAlt:
        'cinematic behind the scenes on a film set with camera equipment and lighting',
      ...props.hero,
    }
    ...
    const sections = props.sections?.length
      ...
      : [
          ...
          },
          {
            ...
            items: ['Documentary', 'Post-Production', 'Color Grading'],
          },
          {
            eyebrow: 'Next steps',
            ...
            items: ['Drone & Aerial', 'Discover', 'Pre-Production'],
          },
        ]
