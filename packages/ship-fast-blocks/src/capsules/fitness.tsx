...
export const FitnessKimiPage = defineCapsule({
  ...
  lakebed: {
    ...
    queries: {
      ...
      favoriteClassTitles: ({ db }) =>
        new Set(db.favorites.all().map((favorite) => favorite.classTitle)),
    },
    mutations: {
      bookClass: ({ db }, classTitle: string, day: string, time: string) => {
        db.bookings.insert({ classTitle, day, time })
      ...
      toggleFavorite: ({ db }, classTitle: string) => {
        ...
        db.favorites.insert({ classTitle })
        return true
      },
    },
  },
              ...
              {pricingTiers.map((tier) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      void bookClass(tier.name, 'Membership', 'Monthly')
                      setBookingsOpen(true)
                    }}
                    className={cn(
          ...
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                void bookClass('Trial Signup', 'Email', email)
                go(ctaSubmit)
              }}
            >
              <input
