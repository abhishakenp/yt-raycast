...
export const SalonBarberKimiPage2 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      addBooking: ({ db }, serviceName: string, date: string, time: string) => {
        db.bookings.insert({ serviceName, date, time })
                  ...
                  <SheetFooter className="border-t border-border p-6">
                    <div className="grid grid-cols-2 gap-2">
                      <Button
                        ...
                        onClick={() => void removeBooking('all')}
                ...
                >
                  <div className="p-5">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        void addBooking(service.name, 'Today', '10:00 AM')
                        setBookingOpen(true)
                      }}
                    >
                      Book Now
