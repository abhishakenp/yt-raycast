  ...
  lakebed: {
    ...
    mutations: {
      recordLogin: ({ db }, email: string) => {
        const existingSession = db.sessions.where('email', email).all()[0]
        if (existingSession) {
      ...
      recordActivity: ({ db }, action: string) => {
      ...
      clearActivities: ({ db }) => {
        for (const item of db.activities.all()) {
          db.activities.delete(item.id)
        }
        return []
      },
    },
            ...
            <nav className="hidden items-center gap-1 md:flex">
              {nav.map((item) => (
                <button
                  ...
                  onClick={() => {
                    go(item)
                    handleActivity(`Navigate to ${item}`)
                  }}
                ...
                >
                  ...
                  <div className="p-2">
                    <button
                      ...
                      onClick={() => {
                        setAccountOpen(true)
                        handleActivity('Open account drawer')
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        go('Settings')
                        handleActivity('Navigate to settings')
                      }}
                      className="flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm font-medium text-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    >
                      Settings
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <button
                    ...
                    onClick={() => {
                      go(hero.primaryCta)
                      handleActivity(`Click ${hero.primaryCta}`)
                    }}
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      handleActivity(`Click ${hero.secondaryCta}`)
                    }}
            ...
            <div className="rounded-lg border border-border bg-primary p-8 text-primary-foreground md:p-10">
              <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
                ...
                <button
                  ...
                  onClick={() => {
                    go(hero.primaryCta)
                    handleActivity(`Click CTA ${hero.primaryCta}`)
                  }}
              ...
              {isSignedIn ? (
                ...
                <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Sign in with Google to view your account and activity.
                  </p>
                </div>
              )}
            </div>
