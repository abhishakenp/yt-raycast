...
export const AuthKimiPage4 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      recordSession: ({ db }, email: string) => {
        ...
        if (existing) {
          db.sessions.update(existing.id, {
  ...
  component: ({ props, lakebed }) => {
    ...
    const hero = {
      ...
      description:
        'Sign In Welcome to Our Platform Sign in to access your dashboard and manage your projects efficiently. 10K+ Active Users 99.9% Uptime 24/7 Support Sign In Enter your email and p...',
      primaryCta: 'Sign In',
      secondaryCta: 'Google',
