        ...
        <Sheet open={inquiryOpen} onOpenChange={setInquiryOpen}>
          <SheetContent side="right" className="w-full gap-0 p-0 sm:max-w-md">
            <SheetHeader className="border-b border-border p-6">
              ...
              <SheetDescription>
                Tell us about your project and we'll get back to you within 48
                hours.
              </SheetDescription>
            </SheetHeader>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full border border-input bg-card px-4 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none"
                ...
                <div>
                  ...
                  <select
                    ...
                    name="projectType"
                    required
                    className="w-full border border-input bg-card px-4 py-2 text-sm text-foreground focus:border-primary focus:outline-none"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full border border-input bg-card px-4 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none resize-none"
