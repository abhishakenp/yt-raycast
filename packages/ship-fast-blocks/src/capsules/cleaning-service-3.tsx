...
const defaultHero = {
  ...
  imageAlt:
    'Professional cleaner vacuuming a modern living room with natural light',
}
...
const defaultCleaningServices = [
  ...
  },
  {
    ...
    description:
      'Top-to-bottom deep clean of corners, baseboards, and hard-to-reach spaces.',
    price: '$189',
    alt: 'Sparkling clean modern kitchen countertop with green plants in natural light',
  },
  {
    ...
    description:
      'Detailed turnover cleaning for transitions before and after occupancy.',
    price: '$249',
    alt: 'Wide angle of a spotless white and wood modern interior living space',
  },
  {
  ...
  },
  {
    ...
    description:
      'Quick-refresh service before your guest visits and gatherings.',
    price: '$139',
    alt: 'Wide angle of a spotless white and wood modern interior living space',
  },
]
...
export const CleaningServiceKimiPage3 = defineCapsule({
  ...
  lakebed: {
    ...
    queries: {
      cleaningServices: ({ db }) =>
        db.cleaningServices.orderBy('createdAt').all(),
      bookingLines: ({ db }) =>
    ...
    mutations: {
      addBooking: (
        ...
        const service = db.cleaningServices
          .where('name', normalizedName)
          .all()[0]
  ...
  component: ({ props, lakebed }) => {
    ...
    const availableServices =
      storedServices && storedServices.length
        ? storedServices
