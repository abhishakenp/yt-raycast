 ...
 */
export const BeautyStoreKimiPage2 = defineCapsule({
              ...
              <div className="flex items-center gap-4">
                ...
                {isSignedIn ? (
                  ...
                  <button
                    ...
                    className="hidden h-10 items-center gap-2 rounded-full bg-primary px-4 text-sm font-semibold text-primary-foreground shadow-sm transition hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 sm:inline-flex"
                  >
                    <span className="grid size-5 place-items-center rounded-full bg-background text-xs font-black text-primary">
                      G
                    </span>
                    <span>{authLabel}</span>
                  </button>
                ...
                <Sheet open={cartOpen} onOpenChange={setCartOpen}>
                  <SheetTrigger asChild>
                    <button
                      ...
                      className="relative flex items-center gap-2 text-muted-foreground transition-colors hover:text-primary"
                    >
                      <svg
                        className="size-5"
                        fill="none"
                    ...
                    >
                      <div className="relative aspect-square overflow-hidden">
                        ...
                        <button
                          ...
                          className={cn(
                            'absolute bottom-4 right-4 grid size-11 place-items-center rounded-full shadow-md transition-all hover:scale-105 group-hover:opacity-100',
                            isFavorite
                              ? 'bg-primary text-primary-foreground opacity-100'
                              : 'bg-card text-card-foreground opacity-0 hover:bg-primary hover:text-primary-foreground',
                          )}
                        >
                        ...
                        <button
                          ...
                          className="absolute bottom-4 left-4 flex size-11 items-center justify-center rounded-full bg-card text-card-foreground opacity-0 shadow-lg transition-opacity hover:bg-primary hover:text-primary-foreground group-hover:opacity-100"
                        >
                          <svg
                            className="size-5"
                            fill="none"
