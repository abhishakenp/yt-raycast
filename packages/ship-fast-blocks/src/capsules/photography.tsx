 ...
 */
export const PhotographyKimiPage = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
      ...
      : [
          {
            ...
            imageAlt:
              'Bride and groom first dance in barn venue with string lights',
          },
          {
            title: 'Sarah & David',
    ...
    const contactAddress =
      ...
      '1425 NW Lovejoy St, Suite 300, Portland, OR 97209'
                      ...
                      {safeInquiries.length ? (
                        ...
                        <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                          ...
                          <p className="mt-2 text-sm text-muted-foreground">
                            Submit an inquiry from the Contact section to get
                            started.
                          </p>
                        </div>
                      )}
