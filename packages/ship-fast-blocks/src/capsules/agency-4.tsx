...
export const AgencyKimiPage4 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const services = {
      heading:
        props.services?.heading ?? 'Full-funnel creative for modern brands',
    ...
    const stats = {
      items: props.stats?.items?.length
        ...
        : [
            ...
            {
              value: '$2.4M',
              label: 'Revenue generated for clients last year',
            },
    ...
    return (
      ...
      >
        ...
        <main>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 md:py-32 lg:py-40">
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                <div className="max-w-xl">
                  ...
                  <h1
                    id="hero-heading"
                    className="mb-8 text-5xl font-semibold leading-[1.05] tracking-tight text-foreground md:text-6xl lg:text-7xl"
                  >
                    {hero.heading}{' '}
                    <em className="italic text-primary">{hero.highlight}</em>
                  </h1>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="grid items-start gap-16 lg:grid-cols-2">
                <div className="lg:sticky lg:top-28">
                  ...
                  <h2
                    id="process-heading"
                    className="mb-6 text-4xl font-semibold leading-tight tracking-tight text-foreground md:text-5xl"
                  >
                    {process.heading}
                  </h2>
                  ...
                  {process.steps.map((step, i) => (
                    <div key={step.title} className="flex gap-6">
                      <div className="flex flex-col items-center">
                        <div
                          className={cn(
                            'flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-bold text-primary-foreground',
                            i === 3 ? 'bg-primary' : 'bg-foreground',
                          )}
                        >
                          {i + 1}
                        </div>
          ...
          >
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-2xl text-center">
                ...
                <h2
                  id="pricing-heading"
                  className="mb-5 text-4xl font-semibold leading-tight tracking-tight text-foreground md:text-5xl"
                >
                  {pricing.heading}
                </h2>
                <p className="text-lg leading-relaxed text-muted-foreground">
                ...
                {pricing.plans.map((plan) => (
                  <article
                    ...
                    className={cn(
                      ...
                      plan.highlighted
                        ? 'border-2 border-foreground bg-background shadow-lg shadow-foreground/5'
          ...
          {/* Stats */}
          <section
            className="py-20 md:py-24 bg-foreground text-background"
          ...
          >
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="grid grid-cols-2 gap-10 lg:grid-cols-4 lg:gap-8">
                {stats.items.map((s) => (
                  <div key={s.label}>
                    <p className="mb-2 text-4xl font-bold text-background md:text-5xl">
                      {s.value}
                    </p>
            ...
            <div className="mx-auto max-w-3xl px-6 lg:px-8">
              ...
              <dl className="space-y-6">
                {faq.items.map((item) => (
                  <div
                    key={item.question}
                    className="rounded-xl border border-border bg-background p-6 md:p-8 shadow-sm"
                  >
          ...
          >
            <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
              <h2
                id="cta-heading"
                className="mb-6 text-4xl font-semibold leading-tight tracking-tight md:text-6xl"
              >
                {cta.heading}{' '}
                <em className="italic text-primary/80">{cta.highlight}</em>
              </h2>
              <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-background/70 md:text-xl">
                {cta.description}
              </p>
              ...
              <div className="mt-12 border-t border-background/20 pt-8">
                <p className="mb-4 text-sm font-semibold text-background">
        ...
        {/* Footer */}
        <footer
          className="bg-foreground/90 py-16 text-muted-foreground"
        ...
        >
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mb-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
              <div className="lg:col-span-1">
                <button
                  type="button"
                  onClick={() => go(nav[0])}
                  className="mb-5 flex items-center gap-3 text-foreground"
                >
              ...
              <div>
                <h4 className="mb-5 text-xs font-semibold uppercase tracking-wider text-background">
                  Services
                </h4>
            ...
            <div className="flex flex-col items-center justify-between gap-4 border-t border-border/30 pt-8 text-xs text-muted-foreground md:flex-row">
              <p>
                &copy; {new Date().getFullYear()} {brand}, Inc. All rights
                reserved.
              </p>
