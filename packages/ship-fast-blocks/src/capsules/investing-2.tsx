...
export const InvestingKimiPage2 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
      ...
      : [
          {
            ...
            description:
              'Professional technical analysis with 100+ indicators, drawing tools, and real-time data. Customize your view with multiple timeframes.',
          },
          {
            title: 'Zero Commission',
            description:
              'Trade stocks, ETFs, and options with $0 commission. Keep more of your profits with our transparent, low-cost pricing.',
          },
          {
            title: 'AI Insights',
            description:
              'Smart portfolio recommendations powered by machine learning. Get personalized alerts and market opportunities tailored to you.',
          },
          {
            title: 'Bank-Grade Security',
            description:
              '256-bit encryption, two-factor authentication, and SIPC insurance up to $500,000. Your assets are protected around the clock.',
          },
          {
            title: 'Global Markets',
            description:
              'Access 25+ stock exchanges worldwide. Trade US, European, Asian, and emerging markets all from one account.',
          },
          {
            title: 'Mobile First',
            description:
              'Trade on the go with our award-winning iOS and Android apps. Sync seamlessly across all your devices in real-time.',
          },
        ]
      ...
      : [
          {
            ...
            description:
              'Sign up with your email or phone. Verify your identity in seconds with our secure KYC process.',
          },
          {
            title: 'Fund Instantly',
            description:
              'Connect your bank, wire transfer, or use a debit card. Funds available for trading immediately.',
          },
          {
            title: 'Start Trading',
            description:
              'Buy stocks, ETFs, options, or crypto. Set up recurring investments and watch your wealth grow.',
          },
        ]
      ...
      : [
          {
            ...
            avatarAlt:
              'professional headshot of a confident male executive in a suit',
          },
          {
            quote:
            ...
            avatarAlt:
              'professional headshot of a businesswoman in professional attire',
          },
          {
            quote:
            ...
            avatarAlt:
              'professional headshot of a businessman in formal attire with glasses',
          },
          {
            quote:
            ...
            avatarAlt:
              'professional headshot of a smiling woman with curly hair',
          },
          {
            quote:
            ...
            avatarAlt:
              'professional headshot of a middle-aged man with a friendly smile',
          },
          {
            quote:
            ...
            avatarAlt:
              'professional headshot of a young woman with long dark hair',
          },
        ]
    ...
    const ctaNote =
      props.cta?.note ??
      'Protected by SIPC up to $500,000 • Regulated by SEC & FINRA'
    ...
    const LogoMark = ({ className }: { className?: string }) => (
      <span
        className={cn(
          'grid place-items-center rounded-xl bg-chart-1 text-background',
          className,
        )}
        aria-hidden="true"
      >
      ...
      >
                      ...
                      {safeWatchlist.length ? (
                        ...
                        <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                          ...
                          <p className="mt-2 text-sm text-muted-foreground">
                            Click the + button next to any trending stock to add
                            it here.
                          </p>
                        </div>
                      )}
                    ...
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        >
                          ...
                          <AvatarFallback className="bg-chart-1 text-[0.65rem] font-bold text-background">
                            {authInitials}
                          </AvatarFallback>
                        </Avatar>
                      ...
                      <div className="bg-muted/40 px-4 py-4">
                        <div className="flex items-center gap-3">
                          <Avatar size="lg" className="ring-2 ring-background">
                            ...
                            <AvatarFallback className="bg-chart-1 text-sm font-bold text-background">
                              {authInitials}
                            </AvatarFallback>
                          </Avatar>
        ...
        <main>
          ...
          <section className="relative overflow-hidden pb-20 pt-16 lg:pb-32 lg:pt-24">
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-gradient-to-br from-chart-1/10 via-transparent to-transparent"
            />
            <div
              aria-hidden="true"
              className="absolute right-0 top-20 size-96 rounded-full bg-chart-1/20 blur-3xl"
            />
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                <div className="space-y-8">
                  ...
                  <p className="max-w-xl text-xl leading-relaxed text-background/60">
                    {heroSub}
                  </p>
                ...
                <div className="relative lg:pl-8">
                  <div className="relative rounded-3xl border border-background/10 bg-card p-6 text-card-foreground shadow-2xl">
                    ...
                    <div className="relative mb-6 h-48 overflow-hidden rounded-xl bg-gradient-to-t from-chart-1/20 to-transparent">
                      <svg
                        className="absolute bottom-0 h-full w-full text-chart-1"
                        viewBox="0 0 400 150"
                    ...
                    <div className="space-y-3">
                      {holdings.map((h) => {
                        const inWatchlist =
                          watchlistSymbols?.has(h.symbol) ?? false
                        return (
                          <div
                            key={h.symbol}
                            ...
                            <div className="flex items-center gap-2">
                              <div className="text-right">
                                ...
                                <p
                                  className={cn(
                                    'text-xs',
                                    h.up ? 'text-chart-1' : 'text-destructive',
                                  )}
                                >
                                  {h.change}
                                </p>
          ...
          {/* Logos ticker */}
          <section
            className="border-y border-background/10 bg-background/5 py-12"
            aria-label="Featured in"
          >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <p className="mb-8 text-center text-sm font-medium uppercase tracking-wider text-background/50">
                {logosLabel}
              </p>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
                  {featuresHeading}{' '}
                  <span className="text-chart-1">{featuresAccent}</span>
                </h2>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
                <div>
                  <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
                    {marketsHeading}{' '}
                    <span className="text-chart-1">{marketsAccent}</span>
                  </h2>
                  <p className="mb-8 text-xl text-background/60">
                    {marketsDesc}
                  </p>
                ...
                <div className="overflow-hidden rounded-3xl border border-background/10 bg-card p-6 text-card-foreground">
                  ...
                  <div className="space-y-3">
                    {quotes.map((q) => {
                      const inWatchlist =
                        watchlistSymbols?.has(q.symbol) ?? false
                      return (
                        <div
                          key={q.symbol}
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              aria-label={
                                inWatchlist
                                  ? `Remove ${q.symbol} from watchlist`
                                  : `Add ${q.symbol} to watchlist`
                              }
                              onClick={() => {
                                if (inWatchlist) {
          ...
          <section className="relative overflow-hidden bg-chart-1 py-20">
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-gradient-to-r from-background/20 to-transparent"
            />
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-2 gap-8 lg:grid-cols-4 lg:gap-12">
                {statItems.map((s) => (
                  <div key={s.label} className="text-center">
                    <p className="mb-2 text-5xl font-black text-background lg:text-6xl">
                      {s.value}
                    </p>
                    <p className="font-semibold text-background/70">
                      {s.label}
                    </p>
                  </div>
                ))}
          ...
          <section className="py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
                  {stepsHeading}{' '}
                  <span className="text-chart-1">{stepsAccent}</span>
                </h2>
                ...
                {stepItems.map((step, i) => (
                  <div key={step.title} className="relative text-center">
                    <div className="relative z-10 mx-auto mb-6 grid size-20 place-items-center rounded-2xl border-4 border-chart-1 bg-background/5">
                      <span className="text-3xl font-black text-chart-1">
                        {i + 1}
                      </span>
                    </div>
          ...
          <section id="pricing" className="bg-background/5 py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
                  {pricingHeading}{' '}
                  <span className="text-chart-1">{pricingAccent}</span>
                </h2>
          ...
          <section id="reviews" className="py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
                  {testimonialsHeading}{' '}
                  <span className="text-chart-1">{testimonialsAccent}</span>{' '}
                  Worldwide
                </h2>
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-4">
                {faqItems.map((item) => (
                  <details
                    key={item.question}
                    className="group rounded-2xl border border-background/10 bg-background/5 p-6"
                  >
                    ...
                    <p className="mt-3 leading-relaxed text-background/60">
                      {item.answer}
                    </p>
                  </details>
                ))}
          ...
          <section className="relative overflow-hidden py-24 lg:py-32">
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-gradient-to-br from-chart-1/20 via-transparent to-chart-1/10"
            />
            <div
              aria-hidden="true"
              className="absolute left-0 top-0 h-px w-full bg-gradient-to-r from-transparent via-chart-1 to-transparent"
            />
            <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
              ...
              {subscribed ? (
                <p className="mt-8 rounded-2xl border border-chart-1/30 bg-chart-1/10 px-6 py-4 text-sm font-semibold text-chart-1">
                  ✓ You're on the list! We'll notify you when your account is
                  ready.
                </p>
              ) : (
                <form
