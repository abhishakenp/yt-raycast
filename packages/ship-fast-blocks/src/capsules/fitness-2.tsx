...
export const FitnessKimiPage2 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      ...
      removeClassBooking: ({ db }, id: string) => {
  ...
  component: ({ props, lakebed }) => {
    ...
    const safeClassBookings = classBookings ?? []
                    ...
                    {safeClassBookings.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Browse the schedule below to book your first class.
                        </p>
                      </div>
                    )}
                  </div>
              ...
              {isSignedIn ? (
                ...
                >
                  <input
                    ...
                    required
                    className="rounded-full border border-background/20 bg-background/10 px-6 py-4 text-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-background/30"
                  />
                  <input
                    type="tel"
                    name="phone"
