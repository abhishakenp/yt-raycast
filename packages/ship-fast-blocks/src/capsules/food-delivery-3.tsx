...
export const FoodDeliveryKimiPage3 = defineCapsule({
  name: "FoodDeliveryKimiPage3",
  description:
    "Food Delivery third style sibling to FoodDeliveryKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "Nosh Premium Food Delivery"
    const nav = props.nav?.length ? props.nav : ["Nosh", "Restaurants", "How It Works", "Pricing", "FAQ", "Log in"]
    ...
    const defaultMenuItems = [
      {
        ...
        alt: 'Professional headshot of a happy female customer with brown hair and a black top',
        image: '',
      },
      {
        name: 'Nosh Pass Special',
        restaurant: 'Nosh Premium',
        price: '$15.99',
        description: 'Exclusive dish for Nosh Pass members',
        alt: 'Professional headshot of a happy male customer with dark skin and a white tee',
        image: '',
      },
      {
        name: 'Lightning Delivery Bowl',
        restaurant: 'Fast Bites',
        price: '$10.99',
        description: 'Ready in 30 minutes or less',
        alt: 'Professional headshot of a happy male customer with glasses and short dark hair',
        image: '',
      },
    ]
    ...
    const deliveryFee = orderSubtotal > 0 && orderSubtotal < 25 ? 4.99 : 0
    ...
    const hero = {
      eyebrow: "Food Delivery / Variant 3",
      title: "Restaurant-quality meals, delivered fast .",
      description: "Nosh Premium Food Delivery Nosh Restaurants How It Works Pricing FAQ Log in Order Now Now delivering in 18 cities Restaurant-quality meals, delivered fast . Choose from over 2,4...",
      primaryCta: "Find Food",
      secondaryCta: "Order from Burger Joint",
      imageAlt: "Professional headshot of a happy female customer with brown hair and a black top",
      ...props.hero,
    }
  ...
  {
    "eyebrow": "Overview",
    "title": "Why thousands choose Nosh",
    "body": "Nosh Premium Food Delivery Nosh Restaurants How It Works Pricing FAQ Log in Order Now Now delivering in 18 cities Restaurant-quality meals, delivered fast . Choose from over 2,4...",
    "items": [
  ...
  },
  {
    "eyebrow": "Experience",
    "title": "How it works",
    "body": "Food Delivery page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Questions & Answers",
  ...
  },
  {
    ...
    "body": "Food Delivery page variant 3 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Verified Freshness",
      "Real-Time Tracking",
      "Set your location"
  ...
  },
  {
    ...
    "body": "Food Delivery page variant 4 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Pick your food",
      "Track and enjoy",
      "Burger Joint"
    ...
    const gallery = props.gallery?.length ? props.gallery : [
  {
    "title": "How it works",
    "alt": "Professional headshot of a happy female customer with brown hair and a black top",
    "caption": "Food Delivery generated page detail"
  },
  {
    "title": "Top restaurants near you",
    "alt": "Professional headshot of a happy male customer with dark skin and a white tee",
              ...
              <Sheet open={orderOpen} onOpenChange={setOrderOpen}>
                ...
                >
                  <SheetHeader className="border-b border-border p-6">
                    ...
                    <SheetDescription>
                      {orderItemCount > 0
                        ? `${orderItemCount} item${orderItemCount === 1 ? '' : 's'} in your order.`
                        : 'Your order is empty.'}
                    </SheetDescription>
                  </SheetHeader>
                              ...
                              <div className="flex items-start justify-between gap-3">
                                <div>
                                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">
                                    {item.menuItem.restaurant || brand}
                                  </p>
          ...
          <section className="mx-auto max-w-7xl px-5 py-16">
            <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-semibold tracking-tight">Popular dishes</h2>
              </div>
            </div>
