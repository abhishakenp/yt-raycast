              ...
              <Sheet open={bookmarksOpen} onOpenChange={setBookmarksOpen}>
                ...
                >
                  <SheetHeader className="border-b border-border p-6">
                    ...
                    <SheetDescription>
                      {bookmarkCount > 0
                        ? `${bookmarkCount} section${bookmarkCount === 1 ? '' : 's'} saved for quick access.`
                  ...
                  <article key={section.title} className="rounded-lg border border-border bg-card p-6">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className="grid size-8 place-items-center rounded-md border border-border bg-background text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
                      >
