 ...
 */
export const MembershipClubKimiPage = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const pricingHeading =
      props.pricing?.heading ?? 'Choose your level of access'
    const pricingDesc =
    ...
    const testimonialsEyebrow = props.testimonials?.eyebrow ?? 'Member Stories'
