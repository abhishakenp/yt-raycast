...
export const BakeryKimiPage3 = defineCapsule({
  name: "BakeryKimiPage3",
  description:
    "Bakery third style sibling to BakeryKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "Lumiere Artisan Bakery Handcrafted Baked Goods Since 1998"
    const nav = props.nav?.length ? props.nav : ["Lumiere", "Gallery", "Our Story", "Reviews", "FAQ", "(718) 555-1234"]
    ...
    const hero = {
      eyebrow: "Bakery / Variant 3",
      title: "Baked at 4:00 AM for you today.",
      description: "Lumiere Artisan Bakery Handcrafted Baked Goods Since 1998 Lumiere Menu Gallery Our Story Reviews FAQ (718) 555-1234 Order Online Brooklyn's Best Artisan Bakery 2024 Neighborhood...",
      primaryCta: "Lumiere",
      secondaryCta: "Menu",
      imageAlt: "warm bakery interior with loaves of bread cooling on wooden shelves and golden afternoon light",
      ...props.hero,
    }
  ...
  {
    "eyebrow": "Overview",
    "title": "Why Lumiere tastes different",
    "body": "Lumiere Artisan Bakery Handcrafted Baked Goods Since 1998 Lumiere Menu Gallery Our Story Reviews FAQ (718) 555-1234 Order Online Brooklyn's Best Artisan Bakery 2024 Neighborhood...",
    "items": [
      "This week's menu",
      "What neighbors say",
      "Questions & answers"
  ...
  {
    "eyebrow": "Experience",
    "title": "How to get Lumiere",
    "body": "Bakery page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Ready to place your order?",
      "48-Hour Fermentation",
      "Single-Origin Stone Milling"
    ]
  },
  {
    "eyebrow": "Proof",
    "title": "The showcase",
    "body": "Bakery page variant 3 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "AOP French Butter",
      "Browse & Customize",
      "We Bake to Order"
  ...
  },
  {
    ...
    "body": "Bakery page variant 4 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Pickup or Delivery",
      "Country Levain",
      "AOP Butter Croissant"
    ]
  }
]
  ...
  {
    "title": "How to get Lumiere",
    "alt": "warm bakery interior with loaves of bread cooling on wooden shelves and golden afternoon light",
    "caption": "Bakery generated page detail"
  },
  {
    "title": "The showcase",
    "alt": "rustic sourdough bread boule with deep golden crust on marble counter",
    "caption": "Bakery generated page detail"
  },
  {
    "title": "This week's menu",
    "alt": "flaky golden butter croissants arranged in a basket with warm morning light",
    "caption": "Bakery generated page detail"
  }
]
    ...
    const menuItemsDefaults = [
      {
        name: "Country Levain",
        description: "48-hour fermented sourdough with crackling crust",
        alt: "rustic sourdough bread boule with deep golden crust on marble counter",
        price: "$8.50",
      },
      {
        name: "AOP Butter Croissant",
        description: "Flaky golden layers with French butter",
        alt: "flaky golden butter croissants arranged in a basket with warm morning light",
        price: "$4.25",
        oldPrice: "$5.00",
      },
      {
        ...
        description: "Dark chocolate batons in buttery laminated dough",
        alt: "chocolate croissant with visible dark chocolate filling on wooden board",
        price: "$4.75",
      },
      {
        name: "Baguette Tradition",
        description: "Classic French baguette with airy crumb",
        alt: "golden baguette with diagonal slashes on linen cloth",
        price: "$3.50",
      },
    ]

    const normalizedMenuItems = menuItemsDefaults.map((item) => ({
      alt: item.alt,
    ...
    const orderItemCount = safeOrderLines.reduce(
      (total: number, item: OrderLine) => total + item.quantity,
      0,
    )
    const orderSubtotal = safeOrderLines.reduce(
      (total: number, item: OrderLine) => total + priceAmount(item.menuItem.price) * item.quantity,
      0,
    )
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-5">
                    {safeOrderLines.length ? (
                      <div className="space-y-5">
                        {safeOrderLines.map((item: OrderLine) => (
                          <div
                            key={item.id}
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Add items from our menu to start an order for this
                          session.
                        </p>
                      </div>
                    )}
          ...
          <section className="mx-auto max-w-7xl px-5 py-16">
            <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-semibold tracking-tight">Fresh from the oven</h2>
              </div>
            </div>
