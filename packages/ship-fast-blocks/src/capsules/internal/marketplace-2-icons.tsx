...
export const BagMark = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const socials: { label: string; path: string }[] = [
  {
    label: 'Instagram',
...
export const badgeTint = (badge: string) => {
  const b = badge.toLowerCase()
  if (b.includes('eco')) return 'bg-secondary text-secondary-foreground'
  if (b.includes('new') || b.includes('just'))
    return 'bg-foreground text-background'
  return 'bg-primary text-primary-foreground'
}

export const heroAspect = [
  'aspect-square',
  'aspect-[4/5]',
  'aspect-[4/5]',
  'aspect-square',
