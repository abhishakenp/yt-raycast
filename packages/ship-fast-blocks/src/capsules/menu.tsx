...
export const MenuKimiPage = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const hero = {
      ...
      description:
        'The Stone Table Seasonal Restaurant & Bar The Stone Table Menu Our Story Gallery Visit Book a Table Menu Our Story Gallery Visit Book a Table Portland, Oregon Est. 2012 Seasonal...',
      primaryCta: 'The Stone Table',
      secondaryCta: 'Menu',
      imageAlt:
        'Elegant plated dish at a fine dining restaurant with delicate herbs and sauce on a white ceramic plate',
      ...props.hero,
    }
