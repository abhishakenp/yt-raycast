...
export const MenuKimiPage = defineCapsule({
  name: "MenuKimiPage",
  description:
    "Menu 1th style sibling to MenuKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  lakebed: {
    ...
    mutations: {
      addToOrder: ({ db }, dishName: string) => {
        const menuItem = db.menuItems.where('name', dishName).all()[0]
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "The Stone Table Seasonal Restaurant & Bar"
    const nav = props.nav?.length ? props.nav : ["The Stone Table", "Our Story", "Gallery", "Visit", "Book a Table", "Reserve a Table"]
    const hero = {
      eyebrow: "Menu / Variant 1",
      title: "Seasonal plates, timeless flavors.",
      description: "The Stone Table Seasonal Restaurant & Bar The Stone Table Menu Our Story Gallery Visit Book a Table Menu Our Story Gallery Visit Book a Table Portland, Oregon Est. 2012 Seasonal...",
      primaryCta: "The Stone Table",
      secondaryCta: "Menu",
      imageAlt: "Elegant plated dish at a fine dining restaurant with delicate herbs and sauce on a white ceramic plate",
      ...props.hero,
    }
  ...
  {
    "eyebrow": "Overview",
    "title": "Thoughtful from soil to plate",
    "body": "The Stone Table Seasonal Restaurant & Bar The Stone Table Menu Our Story Gallery Visit Book a Table Menu Our Story Gallery Visit Book a Table Portland, Oregon Est. 2012 Seasonal...",
    "items": [
      "Autumn 2024",
  ...
  {
    "title": "An evening with us",
    "alt": "Elegant plated dish at a fine dining restaurant with delicate herbs and sauce on a white ceramic plate",
    "caption": "Menu generated page detail"
  },
  {
    "title": "A look inside",
    "alt": "Close-up of a perfectly seared ribeye steak with herb butter and rosemary on a cast iron plate",
    "caption": "Menu generated page detail"
  },
  {
    "title": "Autumn 2024",
    "alt": "Artisan sourdough bread topped with heirloom tomatoes and fresh basil on a rustic wooden board",
    "caption": "Menu generated page detail"
  }
]
