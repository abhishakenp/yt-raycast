...
export const MenuKimiPage4 = defineCapsule({
  name: 'MenuKimiPage4',
  description:
    'Menu fourth style sibling to MenuKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.',
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length
      ? props.nav
      : ['BURGERS', 'SIDES', 'SHAKES', 'LOCATIONS']
    const hero = {
      eyebrow: 'Menu / Variant 4',
      title: 'THE MENU',
      description:
        'Restaurant Menu BURGER LAB BURGERS SIDES SHAKES LOCATIONS THE MENU Craft Burgers. Serious Flavor. SIGNATURE BURGERS THE ORIGINAL $14 Double patty, American cheese, pickles, onio...',
      primaryCta: 'BURGERS',
      secondaryCta: 'SIDES',
      ...
      : [
          {
            ...
            body: 'Restaurant Menu BURGER LAB BURGERS SIDES SHAKES LOCATIONS THE MENU Craft Burgers. Serious Flavor. SIGNATURE BURGERS THE ORIGINAL $14 Double patty, American cheese, pickles, onio...',
            items: ['THE ORIGINAL', 'BACON BBQ', 'MUSHROOM SWISS'],
          },
          {
            eyebrow: 'Experience',
            title: 'SIDES & EXTRAS',
            body: "Menu page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
            items: ['SPICY JALAPENO', 'GARDEN VEGGIE', 'THE LAB SPECIAL'],
          },
          {
            eyebrow: 'Proof',
