...
export const EducationKimiPage3 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length
      ? props.nav
      : ['Meridian', 'Programs', 'Instructors', 'Outcomes', 'Tuition', 'FAQ']
    const hero = {
      eyebrow: 'Education / Variant 3',
      title: 'Master the skills that shape the future',
      description:
        'Meridian Academy | Master In-Demand Skills with Industry Experts Skip to main content Meridian Programs Instructors Outcomes Tuition FAQ Apply Now Programs Instructors Outcomes...',
      primaryCta: 'Subscribe',
      secondaryCta: 'Skip to main content',
      imageAlt:
        'diverse group of students collaborating around laptops in a bright modern campus workspace with floor to ceiling windows',
      ...props.hero,
    }
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-5">
                    {safeSavedLines.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Bookmark programs from the gallery to save them for
                          later.
                        </p>
                      </div>
                    )}
