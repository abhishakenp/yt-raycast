...
export const PhotographyKimiPage2 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      submitInquiry: ({ db }, data: { name: string; email: string; projectType: string; eventDate: string; budget: string; message: string }) => {
  ...
  component: ({ props, lakebed }) => {
    ...
    const heroKicker = props.hero?.kicker ?? "San Francisco • Available Worldwide"
    ...
    const footerColumns = props.footer?.columns?.length
      ...
      : [
          {
            title: "Services",
            links: ["Weddings", "Brand Campaigns", "Portraits", "Events", "Editorial"],
          },
          {
            title: "Company",
    ...
    const serviceIcons = [
      // heart (wedding)
      <svg key="heart" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      // person (portrait)
      <svg key="person" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
      </svg>,
      // camera (event)
      <svg key="camera" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
        <path d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
      </svg>,
      // sparkles (editorial)
      <svg key="sparkles" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    return (
      ...
      >
        ...
        <main>
          ...
          <section className="relative flex min-h-screen items-center overflow-hidden" aria-label="Hero">
            <div className="absolute inset-0 z-0">
              <Image alt={heroImageAlt} w={1920} h={1280} className="size-full object-cover" />
            ...
            <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pt-20 sm:px-6 lg:px-8">
              <div className="max-w-3xl">
                ...
                <h1 className="mb-6 text-5xl font-black leading-[0.9] tracking-tight sm:text-6xl lg:text-7xl xl:text-8xl">
                  {heroHeading}
                  <span className="block text-primary">{heroHeadingAccent}</span>
                </h1>
                ...
                <div className="mt-12 flex items-center gap-8 text-sm text-muted-foreground">
                  {heroStats.map((s, i) => (
                    <div key={s.label} className="flex items-center gap-8">
                      {i > 0 ? (
                        <div className={cn("h-10 w-px bg-border", i === 2 && "hidden sm:block")} />
                      ) : null}
          ...
          {/* Logos */}
          <section className="border-y border-border bg-card py-12" aria-label="Trusted by">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mb-12 flex flex-col gap-4 lg:mb-16 lg:flex-row lg:items-end lg:justify-between">
                <div>
                  ...
                  <h2 className="text-3xl font-bold sm:text-4xl lg:text-5xl">{galleryHeading}</h2>
                </div>
              ...
              <div className="columns-1 gap-4 space-y-4 sm:columns-2 lg:columns-3 lg:gap-6 lg:space-y-6">
                {galleryItems.map((item) => {
                  const isFavorite = favoriteProjectTitles?.has(item.title) ?? false
          ...
          <section className="bg-card py-20 lg:py-32" aria-label="Services">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
                ...
                <h2 className="mb-4 text-3xl font-bold sm:text-4xl lg:text-5xl">{servicesHeading}</h2>
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p
                        className={cn(
                          "mb-6",
                          svc.featured ? "text-primary-foreground/80" : "text-muted-foreground",
                        )}
                      >
                        {svc.description}
                      </p>
                      <p
                        className={cn(
                          ...
                          svc.featured ? "text-primary-foreground" : "text-primary",
                        )}
                      >
                        {svc.price}
                      </p>
                      <p
                        className={cn(
                          "text-sm",
                          svc.featured ? "text-primary-foreground/60" : "text-muted-foreground/70",
                        )}
                      >
                        {svc.note}
                      </p>
          ...
          {/* About */}
          <section className="py-20 lg:py-32" aria-label="About the photographer">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
                <div className="relative">
                  <div className="aspect-[4/5] overflow-hidden rounded-2xl">
                    <Image alt={aboutImageAlt} w={800} h={1000} loading="lazy" className="size-full object-cover" />
                  </div>
                ...
                <div>
                  ...
                  <h2 className="mb-6 text-3xl font-bold sm:text-4xl lg:text-5xl">{aboutHeading}</h2>
          ...
          {/* Stats band */}
          <section className="bg-primary py-16 text-primary-foreground" aria-label="Statistics">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Testimonials */}
          <section className="bg-card py-20 lg:py-32" aria-label="Client testimonials">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center">
                <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-primary">
                  {testimonialsKicker}
                </p>
                <h2 className="text-3xl font-bold sm:text-4xl lg:text-5xl">{testimonialsHeading}</h2>
              </div>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
                <div>
                  ...
                  <h2 className="mb-6 text-3xl font-bold sm:text-4xl lg:text-5xl">{contactHeading}</h2>
                  <p className="mb-8 text-lg leading-relaxed text-muted-foreground">{contactDesc}</p>
                  ...
                  <div className="mb-12 space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="mb-1 font-semibold text-foreground">Studio</p>
                ...
                >
                  <div className="mb-6 grid gap-6 sm:grid-cols-2">
                    <div>
                      <label htmlFor="photo2-name" className="mb-2 block text-sm font-medium text-muted-foreground">
                        Name
                      </label>
                      <input id="photo2-name" name="name" type="text" required placeholder="Your full name" className={inputCls} />
                    </div>
                    <div>
                      <label htmlFor="photo2-email" className="mb-2 block text-sm font-medium text-muted-foreground">
                        Email
                      </label>
                      <input id="photo2-email" name="email" type="email" required placeholder="you@example.com" className={inputCls} />
                    </div>
                  </div>
                  <div className="mb-6">
                    <label htmlFor="photo2-type" className="mb-2 block text-sm font-medium text-muted-foreground">
                      Project Type
                    </label>
                    <select id="photo2-type" name="projectType" className={cn(inputCls, "appearance-none")}>
                  ...
                  <div className="mb-6 grid gap-6 sm:grid-cols-2">
                    <div>
                      <label htmlFor="photo2-date" className="mb-2 block text-sm font-medium text-muted-foreground">
                        Event Date
                      </label>
                      <input id="photo2-date" name="eventDate" type="date" className={inputCls} />
                    </div>
                    <div>
                      <label htmlFor="photo2-budget" className="mb-2 block text-sm font-medium text-muted-foreground">
                        Budget Range
                      </label>
                      <select id="photo2-budget" name="budget" className={cn(inputCls, "appearance-none")}>
                        {budgets.map((opt) => (
                          <option key={opt} className="bg-background">
                            {opt}
                          </option>
                  ...
                  <div className="mb-6">
                    <label htmlFor="photo2-message" className="mb-2 block text-sm font-medium text-muted-foreground">
                  ...
                  <p className="mt-4 text-center text-sm text-muted-foreground">{contactResponse}</p>
                </form>
              </div>
            </div>
          </section>
          ...
          {/* CTA */}
          <section className="relative overflow-hidden py-20 lg:py-32" aria-label="Call to action">
            <div className="absolute inset-0 z-0">
              <Image alt={ctaImageAlt} w={1920} h={1080} loading="lazy" className="size-full object-cover" />
              <div className="absolute inset-0 bg-background/80" />
            </div>
            <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
              <h2 className="mb-6 text-3xl font-bold sm:text-4xl lg:text-5xl">{ctaHeading}</h2>
              <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">{ctaDesc}</p>
              ...
              {inquiries && inquiries.length ? (
                ...
                <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Submit the contact form to track your project inquiries in this session.
                  </p>
                </div>
              )}
            </div>
        ...
        {/* Footer */}
        <footer className="border-t border-border bg-background py-12" aria-label="Footer">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div className="lg:col-span-2">
                ...
                <p className="mb-6 max-w-sm text-muted-foreground">{footerTagline}</p>
