...
export const MenuKimiPage2 = defineCapsule({
  name: 'MenuKimiPage2',
  description:
    'Menu second style sibling to MenuKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions. Full-stack with Lakebed: persistent order management, favorites, and Google auth.',
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length ? props.nav : ['Reservations', 'About']
    const hero = {
      eyebrow: 'Menu / Variant 2',
      title: 'Our Menu',
      description:
        'Restaurant Menu The Rustic Kitchen Menu Reservations About Our Menu Crafted with passion, served with love Appetizers Crispy Calamari $14 Lightly fried squid rings served with m...',
      primaryCta: 'Menu',
      ...
      : [
          {
            eyebrow: 'Overview',
            title: 'Appetizers',
            body: 'Restaurant Menu The Rustic Kitchen Menu Reservations About Our Menu Crafted with passion, served with love Appetizers Crispy Calamari $14 Lightly fried squid rings served with m...',
            items: [
              'Crispy Calamari',
              'Bruschetta Trio',
          ...
          },
          {
            ...
            items: ['Chicken Parmesan', 'Mushroom Risotto', 'Tiramisu'],
          },
          {
            eyebrow: 'Next steps',
            ...
            items: ['Chocolate Lava Cake', 'Creme Brulee'],
          },
        ]
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <button
                    type="button"
                    onClick={() => {
                      void addToOrder(hero.primaryCta)
                      setOrderOpen(true)
                    }}
                  ...
                  {section.items?.length ? (
                    <div className="mt-5 grid gap-2">
                      {section.items.map((item) => {
                        const isFavorite =
                          favoriteMenuItemNames?.has(item) ?? false
                        return (
                          <div
                            key={item}
