...
export const MenuKimiPage2 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const hero = {
      ...
      title: "Our Menu",
      description: "Restaurant Menu The Rustic Kitchen Menu Reservations About Our Menu Crafted with passion, served with love Appetizers Crispy Calamari $14 Lightly fried squid rings served with m...",
      primaryCta: "Menu",
