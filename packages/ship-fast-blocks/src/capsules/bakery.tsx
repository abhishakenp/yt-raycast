...
export const BakeryKimiPage = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    // Normalize menu items for Lakebed
    const allMenuItems = [
      ...breads.map((item) => ({ ...item, category: 'breads' })),
      ...pastries.map((item) => ({ ...item, category: 'pastries' })),
      ...cakes.map((item) => ({ ...item, category: 'cakes' })),
    ]
    ...
    // Use stored menu items when available, otherwise use static defaults
