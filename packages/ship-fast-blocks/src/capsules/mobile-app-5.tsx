...
export const MobileAppKimiPage5 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      completeHabit: ({ db }, habitId: string, date: string) => {
        const existing = db.habitCompletions
  ...
  component: ({ props, lakebed }) => {
    ...
    const completedHabitIds = new Set(
      todayCompletions?.map((c) => c.habitId) || [],
    )
    ...
    const ctaHeading = props.cta?.heading ?? 'Ready to build habits that last?'
    const ctaDesc =
    ...
    return (
      ...
      >
                      ...
                      {displayHabits.length ? (
                        ...
                        <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                          ...
                          <p className="mt-2 text-sm text-muted-foreground">
                            Sign in and add your first habit to start tracking
                            your progress.
                          </p>
                        </div>
                      )}
        ...
        <main>
          {/* Hero */}
          <section
            className="overflow-hidden bg-gradient-to-b from-primary/10 to-background pb-16 pt-24 lg:pb-24 lg:pt-32"
                ...
                <div className="relative flex justify-center lg:justify-end">
                  ...
                  >
                          ...
                          <div className="mb-4 flex items-center justify-between">
                            <div>
                              <h2 className="text-lg font-bold text-foreground">
                                {isSignedIn
                                  ? `Hello, ${authDisplayName.split(' ')[0]}! 👋`
                                  : 'Hello, Sarah! 👋'}
                              </h2>
                              <p className="text-xs text-muted-foreground">
                                {totalHabits > 0
                                  ? `You have ${totalHabits} habit${totalHabits === 1 ? '' : 's'} today`
                                  : 'You have 3 habits today'}
                              </p>
                            </div>
                            <div className="size-10 overflow-hidden rounded-full bg-secondary/20">
                              {isSignedIn && authPicture ? (
                                ...
                                <Image
                                  alt="Smiling young woman with brown hair"
                                  w={100}
                                  h={100}
                                  className="size-full object-cover"
                                />
                          ...
                          <div className="space-y-2">
                            {displayHabits.length > 0 ? (
                              displayHabits.slice(0, 3).map((habit, i) => {
                                const isCompleted = completedHabitIds.has(
                                  habit.id,
                                )
                                const colorClasses = [
                                  {
                                    ...
                                    incomplete: 'border-2 border-primary/30',
                                  },
                                  {
                                    ...
                                    incomplete: 'border-2 border-secondary/30',
                                  },
                                  {
                                    ...
                                    iconBg: 'bg-accent/20',
                                    completed: 'bg-accent',
                                    incomplete: 'border-2 border-accent/30',
                                  },
                                ]
                              ...
                              <>
                                <div className="flex items-center gap-3 rounded-xl border-2 border-primary/20 bg-primary/10 p-3">
                                  <div className="grid size-10 place-items-center rounded-full bg-primary/20 text-xl">
                                    💧
                                  </div>
                                  <div className="flex-1">
                                    <div className="text-sm font-semibold text-foreground">
                                ...
                                <div className="flex items-center gap-3 rounded-xl border-2 border-secondary/20 bg-secondary/10 p-3">
                                  <div className="grid size-10 place-items-center rounded-full bg-secondary/20 text-xl">
                                    📚
                                  </div>
                                  <div className="flex-1">
                                    <div className="text-sm font-semibold text-foreground">
                                ...
                                <div className="flex items-center gap-3 rounded-xl border-2 border-accent/20 bg-accent/10 p-3">
                                  <div className="grid size-10 place-items-center rounded-full bg-accent/20 text-xl">
                                    🏃
                                  </div>
                                  <div className="flex-1">
                                    <div className="text-sm font-semibold text-foreground">
                    ...
                    <div className="absolute -right-4 top-20 rounded-2xl bg-background p-4 shadow-xl animate-pulse">
                      <div className="flex items-center gap-3">
                        <div className="grid size-10 place-items-center rounded-full bg-primary/10 text-lg">
                          🎉
                        </div>
                        <div>
                          <div className="text-sm font-semibold text-foreground">
                  ...
                  <div className="w-[200px] rounded-[2rem] bg-foreground p-2 shadow-xl">
                    ...
                    <div className="aspect-[9/16] rounded-b-[1.5rem] bg-background p-3">
                      <div className="mb-4 flex justify-center">
                        <div className="grid size-20 place-items-center rounded-full bg-secondary/20 text-3xl">
                          🔥
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-7 gap-1">
                        {[0, 1, 2, 3, 4].map((k) => (
                          <div
                            key={k}
                            className="aspect-square rounded bg-primary"
                          />
                        ))}
                        {[0, 1].map((k) => (
                          <div
          ...
          {/* Pricing */}
          <section
            className="bg-gradient-to-b from-primary/5 to-background py-20 lg:py-28"
          ...
          >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <p className="mt-8 text-center text-sm text-muted-foreground">
                Save 33% with annual billing — Pro $39.99/year, Family
                $79.99/year
              </p>
            </div>
          </section>
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    {statsItems.map((s) => (
                      <div
                        key={s.label}
                        className="rounded-2xl bg-background/10 p-6 text-center backdrop-blur-sm"
                      >
                        <div className="mb-2 text-4xl font-bold text-background lg:text-5xl">
                          {s.value}
                        </div>
          ...
          {/* Testimonials */}
          <section
            className="bg-gradient-to-b from-background to-primary/5 py-20 lg:py-28"
          ...
          {/* Download CTA */}
          <section
            className="bg-gradient-to-br from-primary via-accent to-secondary py-20 lg:py-28"
