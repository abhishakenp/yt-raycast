...
export const TestimonialsKimiPage2 = defineCapsule({
  ...
  lakebed: {
    ...
    queries: {
      savedTestimonials: ({ db }) =>
        db.savedTestimonials.orderBy('createdAt').all(),
    ...
    mutations: {
      ...
      removeTestimonial: ({ db }, id: string) => {
        db.savedTestimonials.delete(id)
        return db.savedTestimonials.all()
      },
  ...
  },
  {
    ...
    const saveTestimonial = lakebed.useMutation('saveTestimonial')
    const removeTestimonial = lakebed.useMutation('removeTestimonial')
    ...
    const safeSavedTestimonials = savedTestimonials ?? []
    const savedCount = safeSavedTestimonials.length
              ...
              <Sheet open={savedOpen} onOpenChange={setSavedOpen}>
                ...
                >
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-5">
                    {safeSavedTestimonials.length ? (
                      <div className="space-y-5">
                        {safeSavedTestimonials.map((item) => (
                          <div
                            key={item.id}
