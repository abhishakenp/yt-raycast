...
export const ConsultingKimiPage3 = defineCapsule({
  name: "ConsultingKimiPage3",
  description:
    "Consulting third style sibling to ConsultingKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "Northridge Advisory Management Consulting"
    const nav = props.nav?.length
      ? props.nav
      : [
          "N Northridge Advisory",
          "Services",
          "Insights",
          "Approach",
          "Pricing",
    ...
    const hero = {
      eyebrow: "Consulting / Variant 3",
      title: "Strategy that moves markets .",
      description:
        "Northridge Advisory Management Consulting N Northridge Advisory Services Insights Approach Pricing FAQ Contact us Services Insights Approach Pricing FAQ Contact us Northridge Ad...",
      primaryCta: "N Northridge Advisory",
      secondaryCta: "Services",
      imageAlt: "modern glass office towers reflecting sunset sky",
      ...props.hero,
    }
    ...
    const inquiryTouchCount = inquiryRows.reduce(
      (total, inquiry) => total + inquiry.touches,
      0,
    )

    const openInquiryDrawer = (service?: string) => {
    ...
    const handleInquirySubmit = (event: FormEvent<HTMLFormElement>) => {
      ...
      const touches = Math.max(
        1,
        Math.min(5, Math.ceil(inquiryMessage.length / 120)),
      )
      setInquiryFormError(null)
      void submitInquiry(
        nextName,
            ...
            <div className="space-y-6 px-6 py-5">
              <div className="rounded-lg border border-border bg-muted/40 p-4">
                {auth.isLoading ? (
                  ...
                  <div className="space-y-2">
                    <p className="text-sm font-semibold text-foreground">{authDisplayName}</p>
              ...
              <form className="space-y-4" onSubmit={handleInquirySubmit}>
                <div className="grid gap-2">
                  <label className="text-sm font-medium text-foreground" htmlFor="consult-name">
                    Name
                  </label>
                  <input
                    id="consult-name"
                ...
                <div className="grid gap-2">
                  <label className="text-sm font-medium text-foreground" htmlFor="consult-email">
                    Email
                  </label>
                  <input
                    id="consult-email"
                ...
                <div className="grid gap-2">
                  <label className="text-sm font-medium text-foreground" htmlFor="consult-company">
                    Company
                  </label>
                  <input
                    id="consult-company"
                ...
                <div className="grid gap-2">
                  <label className="text-sm font-medium text-foreground" htmlFor="consult-service">
                    Service of interest
                  </label>
                  <input
                    id="consult-service"
                ...
                <div className="grid gap-2">
                  <label className="text-sm font-medium text-foreground" htmlFor="consult-message">
                    Message
                  </label>
                  <textarea
                    id="consult-message"
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      openInquiryDrawer(hero.secondaryCta)
