 ...
 */
export const MobileAppKimiPage = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const handleJoinWaitlist = async (e: React.FormEvent) => {
      ...
      const result = (await joinWaitlist(waitlistEmail, waitlistPlan)) as {
        success: boolean
        message: string
      }
    ...
    const galleryHeading = props.gallery?.heading ?? 'See DailyFlow in action'
    const galleryDesc =
    ...
    return (
      ...
      >
        ...
        <main>
          {/* Hero */}
          <section
            className="bg-muted/50 pb-20 pt-32 lg:pb-32 lg:pt-40"
          ...
          {/* Stats (inverted band) */}
          <section
            className="bg-primary py-20 text-primary-foreground lg:py-32"
