...
export const SaasKimiPage9 = defineCapsule({
  name: 'SaasKimiPage9',
  description:
  ...
  lakebed: {
    ...
    mutations: {
      signupForTrial: ({ db }, email: string, plan: string) => {
        db.trialSignups.insert({ email, plan, status: 'pending' })
        return db.trialSignups.all()
      },
      addNotification: (
        { db },
        title: string,
        ...
        db.notifications.insert({ title, message, type })
  ...
  component: ({ props, lakebed }) => {
    ...
    const notifSub =
      props.hero?.notificationSub ?? 'AI found better slots for focus time'
    const heroImageAlt =
      props.hero?.imageAlt ??
    ...
    const heroAvatars = props.hero?.avatars?.length
      ...
      : [
          {
            alt: 'Professional headshot of Sarah Chen, product manager',
            name: 'Sarah Chen',
          },
          {
            alt: 'Professional headshot of James Mitchell, startup founder',
            name: 'James Mitchell',
          },
          {
            alt: 'Professional headshot of Elena Rodriguez, design director',
            name: 'Elena Rodriguez',
          },
          {
            alt: 'Professional headshot of David Park, engineering lead',
            name: 'David Park',
          },
        ]
    ...
    const featuresHeading =
      props.features?.heading ?? 'Intelligence that understands'
      ...
      : [
          {
            ...
            imageAlt:
              'Close-up of hands typing on laptop keyboard connecting calendar accounts',
          },
          {
            ...
            imageAlt:
              'Mobile app settings screen showing calendar preference toggles and time selection',
          },
          {
            ...
            imageAlt:
              'Person relaxing at modern workspace with organized calendar on screen showing scheduled day',
          },
        ]
      ...
      : [
          {
            ...
            imageAlt:
              'Dashboard showing weekly calendar view with AI-generated focus blocks and meeting clusters',
            aspect: '3/4',
          },
          {
            ...
            imageAlt:
              'Mobile app interface showing daily schedule with smart suggestions and quick actions',
            rowSpan: true,
          },
          {
            ...
            imageAlt:
              'Analytics dashboard showing meeting time distribution and productivity insights',
            aspect: '3/4',
          },
          {
            ...
            imageAlt:
              'Smart scheduling assistant interface suggesting optimal meeting times based on AI analysis',
            aspect: '3/2',
          },
          {
            ...
            imageAlt:
              'Team collaboration view showing shared availability and group scheduling interface',
            aspect: '3/2',
          },
        ]
    ...
    const testimonialsHeading =
      props.testimonials?.heading ?? 'Loved by leaders'
    const testimonialsHighlight =
      props.testimonials?.highlight ?? 'who value their time'
      ...
      : [
          {
            ...
            avatarAlt:
              'Professional headshot of Marcus Chen, VP of Engineering at Notion',
          },
          {
            quote:
            ...
            avatarAlt:
              'Professional headshot of Sarah Kim, CEO and founder at Linear',
          },
          {
            quote:
            ...
            avatarAlt:
              'Professional headshot of James Wilson, Chief of Staff at Webflow',
          },
          {
            quote:
            ...
            avatarAlt:
              'Professional headshot of Elena Rodriguez, Creative Director at Figma',
          },
          {
            quote:
            ...
            avatarAlt:
              'Professional headshot of Michael Torres, VP Product at Stripe',
          },
          {
            quote:
            ...
            avatarAlt:
              'Professional headshot of Aisha Patel, Engineering Manager at Vercel',
          },
        ]
    ...
    const signupForTrial = lakebed.useMutation('signupForTrial')
    ...
    const handleTrialSignup = (email: string, plan: string) => {
      void signupForTrial(email, plan)
      void addNotification(
        'Trial Started',
        `Welcome to ${brand}! Your ${plan} trial is active.`,
        'success',
      )
      setTrialOpen(false)
    }
    ...
    const LogoMark = ({ className }: { className?: string }) => (
      <span
        className={cn(
          'grid size-10 place-items-center rounded-lg bg-primary text-primary-foreground',
          className,
        )}
        aria-hidden="true"
      >
      ...
      >
        ...
        <header className="sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur-md supports-[backdrop-filter]:bg-background/70">
          <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <Sheet open={trialOpen} onOpenChange={setTrialOpen}>
                <SheetTrigger asChild>
                  <button
                    type="button"
                    onClick={() => go(heroPrimary)}
                    className="inline-flex items-center rounded-lg bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-colors hover:bg-foreground/90"
                  >
                    Start free trial
                  </button>
                </SheetTrigger>
                ...
                >
                  <SheetHeader className="border-b border-border p-6">
                    ...
                    <SheetDescription>
                      Choose a plan to get started. No credit card required for
                      14-day trial.
                    </SheetDescription>
                  </SheetHeader>
                  <div className="flex-1 overflow-y-auto px-6 py-5">
                    ...
                    <form
                      ...
                      onSubmit={(e) => {
                        ...
                        if (email) {
                          handleTrialSignup(email, selectedPlan)
                        }
                      }}
                    >
                      <div>
        ...
        <main className="flex flex-1 flex-col">
          ...
          <section className="relative overflow-hidden">
            <div
              className="absolute inset-0 bg-gradient-to-br from-muted via-background to-accent"
              aria-hidden="true"
            />
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row">
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-xl bg-foreground px-8 py-4 font-medium text-background shadow-lg transition-all hover:bg-foreground/90"
                    >
                      {heroPrimary}
                    </button>
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-card px-8 py-4 font-medium text-foreground transition-colors hover:bg-muted"
                    >
                      <svg
                        width="20"
                        height="20"
                    ...
                    <div className="flex -space-x-3" aria-hidden="true">
                      {heroAvatars.map((avatar, i) => (
                        <Image
                          ...
                          h={100}
                          className={cn(
                            'size-10 rounded-full border-2 border-card object-cover',
                            i > 0 && '-ml-3',
                          )}
                        />
                      ))}
          ...
          <section id="features" className="py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-20 max-w-3xl text-center">
                <span className="mb-4 inline-block rounded-full bg-accent px-3 py-1 text-xs font-medium text-accent-foreground">
                  {featuresTag}
                </span>
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {featureItems.map((item, i) => (
                  <article
                    key={item.title}
                    className="group rounded-2xl border border-border bg-card p-8 transition-all hover:-translate-y-0.5 hover:shadow-xl"
                  >
                    <div
                      className={cn(
          ...
          <section className="bg-muted py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-20 max-w-3xl text-center">
                <span className="mb-4 inline-block rounded-full bg-muted-foreground/10 px-3 py-1 text-xs font-medium text-muted-foreground">
                  {stepsTag}
                </span>
                <h2 className="font-display text-3xl font-medium text-foreground sm:text-4xl lg:text-5xl">
                  {stepsHeading}
          ...
          <section className="bg-foreground py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-8 text-center md:grid-cols-2 lg:grid-cols-4">
                {statsItems.map((s) => (
                  <div key={s.label}>
                    <div className="font-display text-4xl font-medium text-background lg:text-5xl">
                      {s.value}
                    </div>
          ...
          >
            <div
              className="absolute inset-0 bg-gradient-to-br from-foreground to-background"
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 size-[800px] rounded-full bg-primary/10 blur-3xl"
              aria-hidden="true"
            />
            <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
              ...
              <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-xl bg-primary px-8 py-4 font-medium text-primary-foreground shadow-lg transition-colors hover:bg-primary/90"
                >
                  {ctaPrimary}
                </button>
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-xl border border-border bg-secondary px-8 py-4 font-medium text-secondary-foreground transition-colors hover:bg-secondary/90"
                >
                  {ctaSecondary}
                </button>
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    onClick={() => go('Twitter')}
                    aria-label="Twitter"
                    className="grid size-10 place-items-center rounded-lg bg-muted text-muted-foreground transition-colors hover:bg-accent hover:text-background"
                  >
                    <svg
                      width="20"
                      height="20"
            ...
            <div className="flex flex-col items-center justify-between gap-4 border-t border-border pt-8 text-sm sm:flex-row">
              ...
              <div className="flex items-center gap-6">
                <button
                  ...
                  className="text-muted-foreground transition-colors hover:text-background/80"
                >
                  Privacy Policy
                </button>
                <button
