 ...
 */
export const MobileAppKimiPage6 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      submitDemoRequest: (
        ...
        db.demoRequests.insert({ email, company, teamSize, message })
  ...
  component: ({ props, lakebed }) => {
    ...
    const heroBadge = props.hero?.badge ?? 'Trusted by 2,000+ Enterprise Teams'
    const heroTop = props.hero?.headingTop ?? 'Build Better Habits.'
    const heroBottom = props.hero?.headingBottom ?? 'Transform Your Team.'
    const heroSub =
    ...
    const heroSocialProof = props.hero?.socialProof ?? '4.9'
    ...
    const ctaHeading = props.cta?.heading ?? 'Ready to Transform Your Team?'
    const ctaDesc =
    ...
    const footerColumns = props.footer?.columns?.length
      ...
      : [
          ...
          {
            title: 'Support',
            links: ['Help Center', 'Contact', 'FAQ', 'Status', 'Security'],
          },
        ]
    ...
    return (
      ...
      >
                ...
                <Sheet open={demoOpen} onOpenChange={setDemoOpen}>
                  ...
                  >
                    <SheetHeader className="border-b border-border p-6">
                      ...
                      <SheetDescription>
                        Schedule a personalized demo for your team. We'll show
                        you how HabitTrack Pro can transform your workplace
                        wellness.
                      </SheetDescription>
                    </SheetHeader>
                          ...
                          <div className="p-5">
                            ...
                            <div className="space-y-3">
                              {[
                                ...
                                <div
                                  key={h}
                                  className="flex items-center gap-3 rounded-xl border border-border/50 bg-accent/40 p-3"
                                >
                              ...
                              {['Evening Walk', 'Read 20 Pages'].map((h) => (
                                <div
                                  key={h}
                                  className="flex items-center gap-3 rounded-xl border border-border/50 bg-muted/50 p-3"
                                >
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {featureItems.map((item, i) => (
                  <div
                    key={item.title}
                    className="group rounded-2xl border border-border bg-card p-6 transition-all hover:border-primary/30 hover:shadow-lg lg:p-8"
                  >
              ...
              <div className="grid gap-8 md:grid-cols-3 lg:gap-12">
                {stepItems.map((step, i) => (
                  <div key={step.title} className="relative">
                    ...
                    <p className="mb-4 leading-relaxed text-primary-foreground/70">
                      {step.description}
                    </p>
          ...
          <section className="py-20 lg:py-28" aria-labelledby="pricing-heading">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <p className="mt-8 text-center text-sm text-muted-foreground">
                All prices in USD. Billed annually. Monthly billing available at
                +20%.
              </p>
            </div>
          </section>
        ...
        {/* ── Footer ── */}
        <footer
          className="border-t border-border bg-foreground py-16 text-primary-foreground"
          aria-label="Footer"
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
