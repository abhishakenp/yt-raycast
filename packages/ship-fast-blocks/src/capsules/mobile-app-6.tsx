...
export const MobileAppKimiPage6 = defineCapsule({
  ...
  lakebed: {
    ...
    mutations: {
      submitDemoRequest: ({ db }, email: string, company: string, teamSize: string, message: string) => {
  ...
  component: ({ props, lakebed }) => {
    ...
    const demoRequests = lakebed.useQuery('demoRequests')
                ...
                <Sheet open={demoOpen} onOpenChange={setDemoOpen}>
                  ...
                  >
                    <SheetHeader className="border-b border-border p-6">
                      ...
                      <SheetDescription>
                        Schedule a personalized demo for your team. We'll show you how HabitTrack Pro can transform your workplace wellness.
                      </SheetDescription>
                    </SheetHeader>
                    <div className="flex-1 overflow-y-auto px-6 py-5">
                      <form
                        ...
                        onSubmit={(e) => {
                          ...
                          void submitDemoRequest(email, company, teamSize, message)
                          setDemoOpen(false)
                        }}
                      >
                        <div>
