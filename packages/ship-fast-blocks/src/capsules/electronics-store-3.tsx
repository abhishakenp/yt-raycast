...
export const ElectronicsStoreKimiPage3 = defineCapsule({
  name: "ElectronicsStoreKimiPage3",
  description:
    "Electronics Store third style sibling to ElectronicsStoreKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "TechVault Premium Electronics & Gadgets"
    const nav = props.nav?.length ? props.nav : ["Deals", "New Arrivals", "Laptops", "Audio", "Gaming", "Accessories"]
    const hero = {
      eyebrow: "Electronics Store / Variant 3",
      title: "Upgrade Your Everyday Tech",
      description: "TechVault Premium Electronics & Gadgets TV TechVault Deals New Arrivals Laptops Audio Gaming Accessories Support 3 Menu Summer Tech Drop Live Now Upgrade Your Everyday Tech Disc...",
      primaryCta: "Menu",
      secondaryCta: "Add to Cart",
      imageAlt: "professional headshot of a smiling young man in a casual tee",
      ...props.hero,
    }
    ...
    const sections = props.sections?.length ? props.sections : [
  {
    ...
    "body": "TechVault Premium Electronics & Gadgets TV TechVault Deals New Arrivals Laptops Audio Gaming Accessories Support 3 Menu Summer Tech Drop Live Now Upgrade Your Everyday Tech Disc...",
    "items": [
      "New Arrivals",
  ...
  },
  {
    ...
    "body": "Electronics Store page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
  ...
  },
  {
    "eyebrow": "Proof",
    "title": "Trending Now",
    "body": "Electronics Store page variant 3 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Cameras & Drones",
  ...
  },
  {
    "eyebrow": "Next steps",
    "title": "New Arrivals",
    "body": "Electronics Store page variant 4 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "DJI Mini 4 Pro",
      "MacBook Air 13\" M3",
      "Galaxy S24 Ultra"
  ...
  {
    "title": "Featured Deals",
    "alt": "professional headshot of a smiling young man in a casual tee",
    "caption": "Electronics Store generated page detail"
  },
  {
    "title": "Trending Now",
    "alt": "professional headshot of a woman with warm smile and dark hair",
    "caption": "Electronics Store generated page detail"
  },
  {
    "title": "New Arrivals",
    "alt": "professional headshot of a bearded man in a hoodie",
    "caption": "Electronics Store generated page detail"
  }
]

    const productItems = props.products?.length ? props.products : [
      {
        brand: 'TechVault',
                    ...
                    {safeCartLines.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Add an item from our products to start a cart for this
                          session.
                        </p>
                      </div>
                    )}
        ...
        <main>
          ...
          <section className="mx-auto max-w-7xl px-5 py-16">
            <div className="mb-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-sm font-medium text-primary">Shop Products</p>
                <h2 className="mb-2 text-3xl font-bold text-foreground lg:text-4xl">
                  Featured Electronics
                </h2>
                <p className="text-muted-foreground">Discover our latest premium electronics and gadgets</p>
              </div>
            </div>
