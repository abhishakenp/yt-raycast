...
export const InsuranceKimiPage3 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length
      ? props.nav
      : ['Sentinel Shield', 'Coverage', 'Why Us', 'Bundles', 'Claims', 'About']
    const hero = {
      eyebrow: 'Insurance / Variant 3',
      title: 'Insurance That Actually Protects What Matters',
      description:
        "Sentinel Shield Insurance | Premium Coverage for Life's Journey Sentinel Shield Coverage Why Us Bundles Claims About 1-800-SHIELD-1 Get a Quote Coverage Why Us Bundles Claims Ab...",
      primaryCta: 'Get My Quote',
      secondaryCta: 'Sentinel Shield',
      imageAlt:
        'Happy family relaxing in their bright modern living room feeling secure at home',
      ...props.hero,
    }
                    ...
                    {safeSavedCoverages.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Browse coverage options and save your favorites to
                          compare later.
                        </p>
                      </div>
                    )}
