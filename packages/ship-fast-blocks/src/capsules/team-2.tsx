...
export const TeamKimiPage2 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length
      ? props.nav
      : ['Brightwave', 'Leadership', 'Culture', 'Gallery', 'Stories', 'FAQ']
    const hero = {
      eyebrow: 'Team / Variant 2',
      title: 'Built by humans. Powered by purpose.',
      description:
        'Team Brightwave Brightwave Leadership Culture Gallery Stories FAQ Join the team People-first since 2016 Built by humans. Powered by purpose. We are 240 people across 14 countrie...',
      primaryCta: 'Brightwave',
      secondaryCta: 'Leadership',
      imageAlt:
        'Team of engineers collaborating at a long desk in a sunlit office',
      ...props.hero,
    }
    ...
    const sections = props.sections?.length
      ...
      : [
          ...
          },
          {
            ...
            items: ['Amara Osei', 'Radical ownership', 'Care in the craft'],
          },
        ]
              ...
              <Sheet open={inquiryOpen} onOpenChange={setInquiryOpen}>
                ...
                >
                  <SheetHeader className="border-b border-border p-6">
                    ...
                    <SheetDescription>
                      Submit your inquiry and we'll get back to you within 24
                      hours.
                    </SheetDescription>
                  </SheetHeader>
