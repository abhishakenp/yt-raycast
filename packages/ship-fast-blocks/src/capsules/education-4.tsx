...
export const EducationKimiPage4 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const nav = props.nav?.length ? props.nav : ["Programs", "Admissions", "Campus Life", "Contact"]
    const hero = {
      eyebrow: "Education / Variant 4",
      title: "Excellence in Education",
      description: "Education Academy LearnHub Academy Programs Admissions Campus Life Contact Excellence in Education Preparing students for success in a rapidly changing world through innovative...",
              ...
              <Sheet open={savedOpen} onOpenChange={setSavedOpen}>
                ...
                >
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-5">
                    {displayPrograms.filter((p) => savedProgramNames?.has(p.name)).length ? (
                              ...
                              <div className="min-w-0">
                                ...
                                <div className="mt-3 flex gap-2">
                                  ...
                                  <Button
                                    ...
                                    onClick={() => void saveProgram(program.name)}
                                  >
                                    Remove
                                  </Button>
                                </div>
