 ...
 * props at all.
 */
export const DevToolKimiPage10 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const formatProjectLine = (project: string) =>
      project ? ` · ${project}` : ''
    ...
    return (
      ...
      >
        ...
        <Sheet open={requestDrawerOpen} onOpenChange={setRequestDrawerOpen}>
          <SheetContent side="right" className="w-full gap-0 p-0 sm:max-w-md">
            <SheetHeader className="border-b border-border p-6">
              ...
              <SheetDescription>
                {requestSummaryText}. Add a request to get updates and
                onboarding support from the product team.
              </SheetDescription>
            </SheetHeader>
        ...
        <main>
          {/* Hero */}
          <section
            className="relative overflow-hidden bg-gradient-to-br from-muted via-background to-accent/10"
                ...
                <div className="max-w-2xl">
                  ...
                  <div className="mb-10 flex flex-col gap-4 sm:flex-row">
                    <button
                      ...
                      onClick={() =>
                        openRequestDrawer(
                          pricingTiers[0]?.name ?? defaultRequestPlan,
                        )
                      }
          ...
          <section
            className="bg-background py-24"
            id="dashboard"
            aria-label="Dashboard gallery section"
          >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center">
                <span className="mb-4 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="mx-auto mb-16 max-w-3xl text-center">
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="rounded-full bg-chart-2/15 px-2 py-0.5 text-xs font-semibold text-chart-2">
                    Save 20%
                  </span>
                </div>
              </div>
                    ...
                    <ul className="mb-8 space-y-4">
                      {tier.features.map((feat) => (
                        <li key={feat} className="flex items-start gap-3">
                          <CheckMark
                            className={
                              tier.featured ? 'text-primary' : 'text-chart-2'
                            }
                          />
                          <span
                            className={cn(
        ...
        {/* Footer */}
        <footer
          className="border-t border-border bg-muted/40 py-16"
          aria-label="Footer"
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
