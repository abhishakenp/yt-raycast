...
export const LinkInBioKimiPage2 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand =
      props.brand ?? 'Maya Chen Creative Director & Brand Strategist'
    ...
    const nav = props.nav?.length
      ? props.nav
      : ['Maya Chen', 'Pricing', 'Book a Call']
    const hero = {
      eyebrow: 'Link In Bio / Variant 2',
      title: 'Maya Chen',
      description:
        'Maya Chen Creative Director & Brand Strategist Maya Chen Pricing Book a Call Maya Chen Creative Director & Brand Strategist I help early-stage founders and culture-forward brand...',
      primaryCta: 'Maya Chen',
      secondaryCta: 'Pricing',
      imageAlt:
        'professional headshot of a smiling asian woman with dark hair wearing a black turtleneck',
      ...props.hero,
    }
      ...
      : [
          {
            ...
            items: ['Client words', 'Common questions', 'Ready to stand out?'],
          },
          {
            eyebrow: 'Experience',
            title: 'How we work',
            ...
            items: ['Brand Identity', 'Web Design', 'Creative Direction'],
          },
          {
            eyebrow: 'Proof',
            title: 'Selected work',
            ...
            items: ['No-Code Builds', 'Strategy Call', 'Concept & Design'],
          },
          {
            eyebrow: 'Next steps',
            title: 'Client words',
        ...
        <Sheet open={inquiryOpen} onOpenChange={setInquiryOpen}>
          <SheetContent side="right" className="w-full gap-0 p-0 sm:max-w-md">
            <SheetHeader className="border-b border-border p-6">
              ...
              <SheetDescription>
                Send a message to {brand}. We'll get back to you within 24
                hours.
              </SheetDescription>
            </SheetHeader>
              ...
              <form onSubmit={handleSubmitInquiry} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setInquiryForm({ ...inquiryForm, topic: e.target.value })
                    }
