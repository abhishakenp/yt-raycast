...
export const JewelryStoreKimiPage3 = defineCapsule({
  name: "JewelryStoreKimiPage3",
  description:
    "Jewelry Store third style sibling to JewelryStoreKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "Maison Lumiere"
    const nav = props.nav?.length ? props.nav : ["Collections", "Bespoke", "Maison", "Journal", "Contact", "Maison Lumiere"]
    const hero = {
      eyebrow: "Jewelry Store / Variant 3",
      title: "The Etoile Imperiale",
      description: "Maison Lumiere | Haute Joaillerie Since 1847 Maison Lumiere Collections Bespoke Maison Journal Contact 0 The 2024 Signature Suite The Etoile Imperiale Thirty-four carats of VVS1...",
      primaryCta: "Maison Lumiere",
      secondaryCta: "Collections",
      imageAlt: "Platinum diamond collar necklace displayed on black silk under dramatic studio lighting",
      ...props.hero,
    }
  ...
  {
    "eyebrow": "Overview",
    "title": "The Maison Difference",
    "body": "Maison Lumiere | Haute Joaillerie Since 1847 Maison Lumiere Collections Bespoke Maison Journal Contact 0 The 2024 Signature Suite The Etoile Imperiale Thirty-four carats of VVS1...",
    "items": [
      "Commission Tiers",
  ...
  {
    "eyebrow": "Experience",
    "title": "Commission Your Heirloom",
    "body": "Jewelry Store page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Begin Your Legacy",
  ...
  },
  {
    ...
    "body": "Jewelry Store page variant 3 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Lifetime Promise",
      "Consultation",
      "Creation"
  ...
  },
  {
    ...
    "body": "Jewelry Store page variant 4 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Delivery",
  ...
  {
    "title": "Commission Your Heirloom",
    "alt": "Platinum diamond collar necklace displayed on black silk under dramatic studio lighting",
    "caption": "Jewelry Store generated page detail"
  },
  {
    "title": "Pieces of Distinction",
    "alt": "Pair of emerald and diamond chandelier earrings resting on a white marble surface",
    "caption": "Jewelry Store generated page detail"
  },
  {
    "title": "Commission Tiers",
    "alt": "Solitaire diamond engagement ring with a platinum band photographed on dark velvet",
    "caption": "Jewelry Store generated page detail"
  }
]
    ...
    const defaultProducts = [
      {
        ...
        name: 'Etoile Imperiale Necklace',
        alt: 'Platinum diamond collar necklace displayed on black silk under dramatic studio lighting',
        price: '$45,000',
        oldPrice: '$52,000',
        badge: 'Signature',
      ...
      },
      {
        ...
        alt: 'Diamond tennis bracelet with platinum clasp on velvet display',
        price: '$22,000',
      },
      {
        brand: 'Maison Lumiere',
        name: 'Lumiere Pendant',
        alt: 'Diamond pendant on gold chain displayed in velvet box',
        price: '$8,500',
        oldPrice: '$10,000',
        badge: 'Sale',
      },
      {
        brand: 'Maison Lumiere',
        name: 'Royal Tiara',
        alt: 'Diamond tiara with platinum frame on mannequin',
        price: '$75,000',
        badge: 'Exclusive',
      },
      {
        brand: 'Maison Lumiere',
        name: 'Classic Studs',
        alt: 'Diamond stud earrings in platinum setting',
        price: '$4,200',
      },
      {
        brand: 'Maison Lumiere',
        name: 'Elegance Watch',
        alt: 'Diamond-encrusted watch with leather band',
        price: '$35,000',
        oldPrice: '$40,000',
        badge: '-12%',
      },
    ]
    const normalizedDefaultProducts = defaultProducts.map((product) => ({
      alt: product.alt,
      badge: product.badge ?? '',
      brand: product.brand ?? '',
      image: product.image ?? '',
    ...
    const shipping = cartSubtotal > 0 && cartSubtotal < 5000 ? 150 : 0
                    ...
                    {safeCartLines.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Add an item from our collection to start a cart for this
                          session.
                        </p>
                      </div>
                    )}
        ...
        <main>
          ...
          <section className="mx-auto max-w-7xl px-5 py-16">
            <div className="mb-12 flex flex-col gap-4 sm:flex-row sm:items-end">
              <div>
                <p className="text-sm font-medium text-primary">Our Collection</p>
                <h2 className="mt-2 text-3xl font-semibold tracking-tight">Signature Pieces</h2>
                <p className="mt-2 text-muted-foreground">Handcrafted jewelry for the discerning collector</p>
              </div>
            </div>
