...
export const JewelryStoreKimiPage3 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const hero = {
      ...
      description:
        'Maison Lumiere | Haute Joaillerie Since 1847 Maison Lumiere Collections Bespoke Maison Journal Contact 0 The 2024 Signature Suite The Etoile Imperiale Thirty-four carats of VVS1...',
      primaryCta: 'Maison Lumiere',
      secondaryCta: 'Collections',
      imageAlt:
        'Platinum diamond collar necklace displayed on black silk under dramatic studio lighting',
      ...props.hero,
    }
    ...
    const sections = props.sections?.length
      ...
      : [
          ...
          },
          {
            ...
            items: ['Lifetime Promise', 'Consultation', 'Creation'],
          },
          {
            eyebrow: 'Next steps',
            ...
            items: ['Delivery', 'Celestial Drop Earrings', 'Eternelle Ring'],
          },
        ]
    ...
    const normalizedDefaultProducts = defaultProducts.map(
      (product: {
        alt: string
        name: string
        price: string
                    ...
                    {safeCartLines.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Add an item from our collection to start a cart for
                          this session.
                        </p>
                      </div>
                    )}
                      ...
                      {product.badge ? (
                        <span
                          className={cn(
                            ...
                            product.badge === 'Sale' || product.badge === '-12%'
                              ? 'bg-destructive'
                              : 'bg-foreground',
                          )}
                        >
