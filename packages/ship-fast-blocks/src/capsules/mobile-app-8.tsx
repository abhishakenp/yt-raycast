...
export const MobileAppKimiPage8 = defineCapsule({
  ...
  component: ({ props, lakebed }) => {
    ...
    const footerNote =
      props.footer?.note ??
      `© ${new Date().getFullYear()} DailyStreak. All rights reserved.`
    ...
    return (
      ...
      >
                      ...
                      {habits && habits.length > 0 ? (
                        ...
                        <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                          ...
                          <p className="mt-2 text-sm text-muted-foreground">
                            Add your first habit above to start building your
                            streak.
                          </p>
                        </div>
                      )}
        ...
        <main className="pt-16">
              ...
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
                ...
                <div className="relative flex justify-center lg:justify-end">
                  <div className="relative">
                    <div
                      className="absolute -inset-4 bg-primary/20"
                      aria-hidden="true"
                    />
          ...
          {/* Logos */}
          <section
            className="border-y-4 border-foreground bg-muted py-8"
