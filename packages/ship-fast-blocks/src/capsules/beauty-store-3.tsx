...
export const BeautyStoreKimiPage3 = defineCapsule({
  name: "BeautyStoreKimiPage3",
  description:
    "Beauty Store third style sibling to BeautyStoreKimiPage, converted from generated Kimi HTML into a responsive token-compliant page block with hero storytelling, metrics, content sections, image-led cards, and conversion actions.",
  props: z.object({
  ...
  component: ({ props, lakebed }) => {
    ...
    const brand = props.brand ?? "Lumina Beauty Premium Cosmetics & Skincare"
    const nav = props.nav?.length ? props.nav : ["Lumina", "Bestsellers", "Why Us", "Membership", "FAQ", "Shop Bestsellers"]
    const hero = {
      eyebrow: "Beauty Store / Variant 3",
      title: "Elevate Your Natural Glow",
      description: "Lumina Beauty Premium Cosmetics & Skincare Lumina Bestsellers Why Us Membership FAQ New Summer Collection 2026 Elevate Your Natural Glow Clean, cruelty-free formulas crafted by...",
      primaryCta: "Join Starter",
      secondaryCta: "Join Glow",
    ...
    const sections = props.sections?.length ? props.sections : [
  {
    "eyebrow": "Overview",
    "title": "Why Lumina?",
    "body": "Lumina Beauty Premium Cosmetics & Skincare Lumina Bestsellers Why Us Membership FAQ New Summer Collection 2026 Elevate Your Natural Glow Clean, cruelty-free formulas crafted by...",
    "items": [
      "Trending Looks",
      "The Glow Club",
      "Community Voices"
  ...
  },
  {
    "eyebrow": "Experience",
    "title": "How It Works",
    "body": "Beauty Store page variant 2 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Frequently Asked",
  ...
  },
  {
    "eyebrow": "Proof",
    "title": "Bestsellers",
    "body": "Beauty Store page variant 3 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
  ...
  },
  {
    ...
    "body": "Beauty Store page variant 4 highlights the generated design's core message, section pacing, and conversion-focused content.",
    "items": [
      "Take the Quiz",
      "Meet Your Routine",
      "Glow & Save"
    ...
    const gallery = props.gallery?.length ? props.gallery : [
  {
    ...
    "caption": "Beauty Store generated page detail"
  },
  {
    "title": "Bestsellers",
    "alt": "Luxury cosmetics flat lay with rose gold serum bottles and fresh eucalyptus on dark marble",
    "caption": "Beauty Store generated page detail"
  },
  {
    "title": "Trending Looks",
    "alt": "Close-up of hands holding a luxury skincare serum bottle with warm golden light",
    "caption": "Beauty Store generated page detail"
  }
]
    ...
    const sampleProducts = [
      {
        brand: 'Lumina',
        name: 'Glow Serum',
        alt: 'Luxury skincare serum bottle with golden light',
        price: '$89',
        oldPrice: '$120',
        badge: 'Bestseller',
      },
      {
        ...
        alt: 'White cream jar on marble surface',
        price: '$65',
      },
      {
        brand: 'Lumina',
        name: 'Night Repair',
        alt: 'Dark blue night cream bottle',
        price: '$95',
        oldPrice: '$110',
        badge: 'Sale',
      },
    ]
    const normalizedSampleProducts = sampleProducts.map((product) => ({
      alt: product.alt,
      badge: product.badge ?? '',
      brand: product.brand ?? '',
      image: '',
    ...
    const shipping = cartSubtotal > 0 && cartSubtotal < 50 ? 8 : 0
      ...
      <div className={cn("min-h-screen bg-background text-foreground", props.className)}>
                    ...
                    {safeCartLines.length ? (
                      ...
                      <div className="flex min-h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/40 px-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                          Add an item from Bestsellers to start a cart for this
                          session.
                        </p>
                      </div>
                    )}
        ...
        <main>
          ...
          <section className="mx-auto max-w-7xl px-5 py-16">
            <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div>
                <p className="text-sm font-medium text-primary">Bestsellers</p>
                <h2 className="mt-2 text-3xl font-semibold tracking-tight">Shop Our Favorites</h2>
              </div>
              <button
                type="button"
                onClick={() => go('Shop All')}
