...
export function Card({
 ...
 {index && (
 <span data-d-role="eyebrow" className="font-mono text-[11px] uppercase tracking-[0.2em] text-muted-foreground">
 {index}
...
export function CtaBand({
 ...
 <h2
 data-d-role="heading"
 className={cn('text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl max-w-2xl')}>
 {heading}
 </h2>
 {subheading && (
...
export function Accordion({
 ...
 data-d-role="card"
 className={cn(
 ' p-6 border-b border-r border-border bg-card',
 )}>
 <summary
 data-d-role="heading"
