...
This project is indexed by GitNexus as **ship-fast** (33084 symbols, 56984 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
