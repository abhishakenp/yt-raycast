...
This project is indexed by GitNexus as **ship-fast** (46847 symbols, 85821 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
