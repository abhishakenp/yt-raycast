...
This project is indexed by GitNexus as **ship-fast** (39602 symbols, 61696 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
