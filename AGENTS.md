...
This project is indexed by GitNexus as **ship-fast** (38078 symbols, 59299 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
