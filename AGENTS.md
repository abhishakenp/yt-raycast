...
This project is indexed by GitNexus as **ship-fast** (72299 symbols, 125604 relationships, 280 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
