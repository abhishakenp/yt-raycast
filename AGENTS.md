...
This project is indexed by GitNexus as **ship-fast** (49512 symbols, 83593 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
