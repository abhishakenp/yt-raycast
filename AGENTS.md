...
This project is indexed by GitNexus as **ship-fast** (41503 symbols, 67505 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
