// Auto-derived from https://github.com/jnsahaj/tweakcn/blob/9fb9c4c77f75449bba391c844a9d554f51adaafa/utils/theme-presets.ts
export type PresetVars = Record<string, string>
export type ThemePreset = { id: string; label: string; dark: PresetVars; light: PresetVars }
