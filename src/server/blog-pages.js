...
<head>
  ...
  <style>
    ...
    .blog-card { margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 1px solid #1a1a1c; }
    .blog-card h2 { font-size: 1.25rem; margin-bottom: 0.5rem; }
    .blog-card a { color: #EDEDEF; text-decoration: none; }
    .blog-card a:hover { color: #ffffff; text-decoration: underline; }
    .blog-excerpt { color: #8A8F98; font-size: 0.95rem; margin-top: 0.5rem; }
    time { font-size: 0.8rem; color: #8A8F98; }
    .blog-nav { margin-bottom: 2rem; }
    .blog-nav a { color: #EDEDEF; }
  </style>
</head>
...
<head>
  ...
  <style>
    ...
    .post-nav a { color: #EDEDEF; }
    .post-meta { color: #8A8F98; font-size: 0.9rem; margin-bottom: 1rem; }
  </style>
</head>
