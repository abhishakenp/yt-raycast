  ...
  return (
    <MarketingShell footer>
      ...
      <section aria-labelledby="h-summary">
        ...
        <p>
          {SITE_NAME} is an AI-assisted product for generating website projects from text prompts. We process account
      ...
      <section aria-labelledby="h-collect">
        ...
        <h3>3.4 Analytics</h3>
        <p>
          We use <strong>Plausible Analytics</strong> configured for first-party collection via this
      ...
      <section aria-labelledby="h-use">
        ...
        <ul>
          <li>To provide {SITE_NAME}, including creating and displaying your projects and processing exports.</li>
      ...
      <section aria-labelledby="h-sharing">
        ...
        <ul>
          ...
          <li>Infrastructure and deployment providers that host ship-fast.devliv.io and related services</li>
      ...
      <section aria-labelledby="h-rights">
        ...
        <p>
          To exercise these rights, contact <a href={mailtoHref}>{PRIVACY_CONTACT_EMAIL}</a>. We may need to verify your identity
      ...
      <section aria-labelledby="h-children">
        ...
        <p>
          {SITE_NAME} is not directed at children under the age where parental consent is required in their jurisdiction.
      ...
      <section aria-labelledby="h-contact">
        ...
        <p>Public site: <a href={`${SITE_URL}/`}>{SITE_URL}/</a></p>
      </section>
    </main>
    </MarketingShell>
  )
