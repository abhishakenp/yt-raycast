    ...
    <MarketingShell footer>
      <main className="legal-page relative z-[1] mx-auto w-[min(760px,calc(100%-48px))] px-0 pt-[88px] pb-24 font-sans text-base leading-[1.65] text-[#f0f0f5] [&_a]:text-[#26e7ff] [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:text-[#69f8ff] [&_h2]:mb-3.5 [&_h2]:font-sans [&_h2]:text-[1.15rem] [&_h2]:tracking-[-0.02em] [&_h2]:text-[#f0f0f5] [&_h3]:mt-5 [&_h3]:mb-2.5 [&_h3]:font-sans [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-[#c4c9d4] [&_header_h1]:mb-3.5 [&_header_h1]:font-['Fraunces',Georgia,serif] [&_header_h1]:text-[clamp(1.75rem,4vw,2.25rem)] [&_header_h1]:tracking-[-0.03em] [&_header_h1]:text-white [&_li]:mb-2 [&_p]:mb-3 [&_section]:mb-6 [&_section]:rounded-[16px] [&_section]:border [&_section]:border-white/6 [&_section]:px-6 [&_section]:py-[22px] [&_section]:shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_24px_80px_rgba(0,0,0,0.2)] [&_ul]:my-2.5 [&_ul]:ml-5">
        ...
        <section aria-labelledby="h-service">
          ...
          <p>
            {SITE_NAME} is an AI-assisted website generation product. You
            provide prompts, optional layout references, account details, and
            payment details where applicable. We generate previews, downloadable
            exports, and optional GitHub pushes based on those instructions.
          </p>
        </section>
        ...
        <section aria-labelledby="h-use">
          ...
          <p>
            You must not use {SITE_NAME} to generate illegal, harmful, abusive,
            discriminatory, sexually explicit, phishing, malware, counterfeit,
            or rights-infringing content. We may block prompts, refuse
            generation, limit access, or suspend accounts to protect the service
            and other users.
          </p>
        </section>
        ...
        <section aria-labelledby="h-rights">
          ...
          <p>
            You are responsible for prompts, layout references, brand names,
            assets, and instructions you submit. You must have the rights needed
            to use any referenced material. Generated output may require your
            own review before production use, especially for legal, medical,
            financial, regulated, or brand-sensitive content.
          </p>
        </section>
        ...
        <section aria-labelledby="h-billing">
          ...
          <p>
            Payments may be processed by Stripe or Razorpay depending on
            checkout route, region, and payment method. Partner coupons apply
            only when accepted by the relevant payment provider.
          </p>
          <p>
            {LEGAL_REFUND_POLICY ||
        ...
        <section aria-labelledby="h-availability">
          ...
          <p>
            The service is provided with reasonable care, but generation
            quality, latency, model availability, export compatibility, and
            third-party integrations can vary. We may change, pause, or
            discontinue features where needed for reliability, security, legal
