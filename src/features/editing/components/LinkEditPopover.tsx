...
export function LinkEditPopover({
  ...
  return (
    <div className="rounded-lg border border-white/10 bg-[#0b0d14]/95 shadow-2xl backdrop-blur-xl p-2 flex flex-col gap-2 w-[280px]">
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          placeholder="https://..."
          className="rounded bg-white/5 px-2 py-1.5 text-xs text-white outline-none focus-visible:ring-1 focus-visible:ring-cyan-300/50"
        />
      </div>
