...
home_navbar = Navbar({"brand":"स्वीट क्रम्ब बेकरी","links":["होम","मेनू"],"cta":"अभी ऑर्डर करें"})
home_menu = ProductGrid({"heading":"दैनिक मेनू","products":[{"name":"खट्टी रोटी","imageAlt":"धीमी आंच पर पकी कारीगर रोटी","price":"₹250"}]})
...
home_hero = SplitHero({"heading":"Fresh artisan bread, pastries, and cakes","subheading":"Fresh artisan bread, pastries, and cakes baked every morning."})
