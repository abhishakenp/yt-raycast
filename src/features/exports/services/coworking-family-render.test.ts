...
describe('generic coworking composition renders through the OpenUI runtime', () => {
  const sections = [
    {
      name: 'Navbar',
      source: 'root = Navbar({"brand":"Northside","links":["Spaces","Membership"]})',
      mustContain: ['Northside', 'Spaces'],
    },
    {
      name: 'SplitHero',
      source: 'root = SplitHero("Northside", "Make room for your best work", "your team", "Schedule a tour")',
      mustContain: ['Make room for your best work', 'Schedule a tour'],
    },
    {
      name: 'FeatureList',
      source: 'root = FeatureList({"features":[{"heading":"Reliable WiFi","description":"Work without interruption."}]})',
      mustContain: ['Reliable WiFi'],
    },
    {
      name: 'PricingTable',
      source: 'root = PricingTable({"tiers":[{"name":"Hot Desk","price":"$199","features":["24/7 access"]},{"name":"Private Office","price":"$899","features":["Dedicated space"]}]})',
      mustContain: ['Hot Desk', 'Private Office'],
    },
    {
      name: 'TestimonialRow',
      source: 'root = TestimonialRow({"testimonials":[{"quote":"Northside makes every day better.","author":"Maya Chen"}]})',
      mustContain: ['Maya Chen'],
    },
    {
      name: 'CtaBand',
      source: 'root = CtaBand({"heading":"Find your desk","cta":"Book a tour"})',
