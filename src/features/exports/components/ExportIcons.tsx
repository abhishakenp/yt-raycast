...
export const HtmlIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M1.5 0H22.5L20.5 21.5L12 24L3.5 21.5L1.5 0Z"
      fill="#E34F26"
    />
    <path
      d="M12 2.5V21.5L18.5 19.5L20 2.5H12Z"
      fill="#EF652A"
    />
    <path
...
export const NextIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g mask="url(#nextjs-mask)">
      ...
      <path d="M149.508 157.52L69.142 54H54V125.97H66.1136V69.3836L139.999 164.845C143.333 162.614 146.509 160.165 149.508 157.52Z" fill="url(#nextjs-gradient1)"></path>
      <rect fill="url(#nextjs-gradient2)" height="72" width="12" x="115" y="54"></rect>
    </g>
    <defs>
