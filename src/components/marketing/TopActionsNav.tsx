...
export const TopActionsNav = ({ showBrand = false }: { showBrand?: boolean }) => (
  <nav className="top-actions" aria-label="Primary">
    ...
    <div className="top-actions-right">
      ...
      <div className="top-actions-auth-slot">
        <SfGlassPillButton id="signin-btn" type="button" className="pill--top-actions">
          Sign in
        </SfGlassPillButton>
        <SfGlassPillButton id="signout-btn" type="button" className="pill--top-actions">
          <svg
            width="13"
            height="13"
            viewBox="0 0 24 24"
