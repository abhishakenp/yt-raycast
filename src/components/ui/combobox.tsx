...
function staticClassName(
  base: string,
  className: string | ((state: never) => string | undefined) | undefined,
) {
  return cn(base, typeof className === "string" ? className : undefined)
}
...
function ComboboxTrigger({
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={staticClassName("[&_svg:not([class*='size-'])]:size-4", className)}
      {...props}
    >
      {children}
      <ChevronDownIcon
...
function ComboboxInput({
  ...
  return (
    <InputGroup className={typeof className === "string" ? cn("w-auto", className) : "w-auto"}>
...
function ComboboxSeparator({
  ...
  return (
    <ComboboxPrimitive.Separator
      ...
      className={staticClassName("-mx-1 my-1 h-px bg-border", className)}
      {...props}
    />
  )
}
...
function ComboboxChipsInput({
  ...
  return (
    <ComboboxPrimitive.Input
      ...
      className={staticClassName("min-w-16 flex-1 outline-none", className)}
      {...props}
    />
  )
}
