...
const appEnvSchema = z.object({
  ...
  LINKFORTY_ENABLED: z.string().optional(),
  LINKFORTY_API_URL: z.string().url().optional(),
  LINKFORTY_SERVICE_USER_ID: z.string().optional(),
  LINKFORTY_WEBHOOK_SECRET: z.string().optional(),
  LINKFORTY_WEBHOOK_MUTATION_SECRET: z.string().optional(),
  VITE_LINKFORTY_ENABLED: z.string().optional(),
  VITE_LINKFORTY_BASE_URL: z.string().url().optional(),
...
export function parseAppEnv(rawEnv: RawAppEnv): AppEnv {
  return appEnvSchema.parse({
    ...
    LINKFORTY_ENABLED: rawEnv.LINKFORTY_ENABLED,
    LINKFORTY_API_URL: rawEnv.LINKFORTY_API_URL,
    LINKFORTY_SERVICE_USER_ID: rawEnv.LINKFORTY_SERVICE_USER_ID,
    LINKFORTY_WEBHOOK_SECRET: rawEnv.LINKFORTY_WEBHOOK_SECRET,
    LINKFORTY_WEBHOOK_MUTATION_SECRET: rawEnv.LINKFORTY_WEBHOOK_MUTATION_SECRET,
    VITE_LINKFORTY_ENABLED: rawEnv.VITE_LINKFORTY_ENABLED,
    VITE_LINKFORTY_BASE_URL: rawEnv.VITE_LINKFORTY_BASE_URL,
