...
import { sanitizeFragment } from './postprocess.js'
...
export function parseIslandJson(content) {
  ...
  return {
    identity: sanitizeFragment(parsed.identity || ''),
    primary: sanitizeFragment(parsed.primary || ''),
    secondary: sanitizeFragment(parsed.secondary || ''),
    tertiary: sanitizeFragment(parsed.tertiary || ''),
  }
}
