...
- Coverage is now enforced through Vitest/V8 thresholds, but the current measured baseline is still low: 23.38% statements, 15.67% branches, 11.26% functions, and 22.95% lines in the latest full coverage gate.
...
- The latest full coverage gate passed with measured V8 coverage of 23.38% statements, 15.67% branches, 11.26% functions, and 22.95% lines.
