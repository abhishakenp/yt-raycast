...
export const DESIGN_REF_ENTRIES = [
  {
    ...
    siteTypes: ['ecommerce'],
    keywordPatterns: [/\bfashion\b/i, /\bapparel\b/i, /\bclothing\b/i, /\bjewelry\b/i, /\bluxury\b/i],
    priority: 80,
  ...
  },
  {
    ...
    siteTypes: ['docs'],
    keywordPatterns: [/\b(rest|graphql|openapi|swagger)\b/i, /\bapi docs\b/i, /\bendpoint\b/i],
    priority: 70,
    defaultPreset: 'docsDev',
    injectAuroraLiquid: false,
  },
  ...
  },
  {
    ...
    siteTypes: ['portfolio'],
    keywordPatterns: [/\b(photographer|designer|creative director|illustrator)\b/i],
    priority: 65,
